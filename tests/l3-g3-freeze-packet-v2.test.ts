...
const pairedArtifacts = [
  ...
  [
    ...
    "a02f7b0305f382ed0eb58d42a2bb4d77a883cffeefbea6b09e91dacde39053eb",
  ],
  [
...
describe("L3 G1/G3 freeze packet v2", () => {
  ...
  it("U-DESIGNCOV-016: binds every listed L3/L10 artifact candidate to its current digest", () => {
    ...
    const designCatalogDigest = "815b8a7f9f53a6d6b316a19fc8b16113290b28327f36cb74c7ecafb3ffead31f";
