...
describe("L3 G1/G3 freeze packet v2", () => {
  ...
  it("U-DESIGNCOV-016: binds every listed L3/L10 artifact candidate to its current digest", () => {
    ...
    const generatedRequirementViewDigest =
      "2229eaf7f608c13439b3a98532d8c005db68492bae23b188bd0f47d9da85bfcb";
    ...
    const designCatalogDigest = "98d4c1f36ea2bb140dedb936790a4aef8eb9e0a2c3206e8f9ab7a463ea7e5164";
  ...
  it("contains the five-question batch and unresolved issue dispositions", () => {
    ...
    // PLAN-L3-88とPLAN-L3-78のdigest drift反例を各1件含む。初期snapshotの100件は不変。
    expect(ownerRows.reduce((sum, row) => sum + row.expected_case_count, 0)).toBe(102);
