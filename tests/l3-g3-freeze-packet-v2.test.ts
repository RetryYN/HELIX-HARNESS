...
describe("L3 G1/G3 freeze packet v2", () => {
  ...
  it("U-DESIGNCOV-016: binds every listed L3/L10 artifact candidate to its current digest", () => {
    ...
    const generatedRequirementViewDigest =
      "dc8af9474043dac6a7619c016d94a92d568571aa808190f3ab03e40fbdbbbbb2";
    ...
    const designCatalogDigest = "0d8dcf2ed162bbf077f7ce4619719f96e1203a956ae96b76f619296d42faef5b";
