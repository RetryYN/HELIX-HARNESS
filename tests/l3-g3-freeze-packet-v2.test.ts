...
describe("L3 G1/G3 freeze packet v2", () => {
  ...
  it("U-DESIGNCOV-016: binds every listed L3/L10 artifact candidate to its current digest", () => {
    ...
    // PLAN-L4-59-atomic-slice-admission: L4/L9設計catalog admissionのcurrent pinを実行可能に固定する。
    // PLAN-L5-85-atomic-slice-admission: L5/L8設計catalog admissionのcurrent pinを実行可能に固定する。
    const designCatalogDigest = "5b9cd5a547c534c56ee9414fbede1f90dc5a512b31d31c3b85361dab45f754a7";
