...
describe("L3 G1/G3 freeze packet v2", () => {
  ...
  it("U-DESIGNCOV-016: binds every listed L3/L10 artifact candidate to its current digest", () => {
    ...
    const designCatalogDigest = "e4a63fb753cc5f46da36e1065b1149a141e81a5ab2fb534966d232eda1a9246a";
  ...
  it("contains the five-question batch and unresolved issue dispositions", () => {
    ...
    // PLAN-L3-88のdigest drift反例1件を含む。初期snapshotの100件を変更したものではない。
    expect(ownerRows.reduce((sum, row) => sum + row.expected_case_count, 0)).toBe(101);
