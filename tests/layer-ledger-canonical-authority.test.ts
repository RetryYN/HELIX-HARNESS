...
describe("layer ledger canonical L1-L12 authority (PLAN-L7-713)", () => {
  it("U-LLPG-AUTH-001: current設計・L8・fixtureを正規6 pairへ固定する", () => {
  ...
  it("U-LLPG-AUTH-002: L0を層外anchor inputへ隔離しlegacy greenで相殺しない", () => {
  ...
  it("U-LLPG-AUTH-003: canonical pair fixtureのreceipt/case digestをbytesから再計算する", () => {
