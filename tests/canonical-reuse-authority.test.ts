...
describe("downstream canonical reuse authority", () => {
  ...
  it("allows only dedicated authority deltas to rewrite their exact blocked compatibility artifacts", () => {
    for (const path of [
      "docs/plans/PLAN-REVERSE-564-vmodel-pair-exact-target.md",
