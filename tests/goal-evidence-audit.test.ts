...
describe("HELIX objective evidence audit", () => {
  it("tracks active objective requirements and keeps full completion blocked until readiness is true", () => {
    ...
    expect(text).toContain("c583953f5fda9c406ff180ae700deefa0d6206ae");
  ...
  it("fails when the external distribution reference repository marker is dropped", () => {
    const text = auditText()
      ...
      .replaceAll("c583953f5fda9c406ff180ae700deefa0d6206ae", "pack-head-missing")
    ...
    expect(result.violations).toEqual(
      expect.arrayContaining([
        ...
        "G-01: missing external source marker c583953f5fda9c406ff180ae700deefa0d6206ae",
        ...
        "G-01: 外部 source ledger distribution_pack_repo observed missing c583953f5fda9c406ff180ae700deefa0d6206ae",
  ...
  it("fails when external observed source values drift from the ledger", () => {
    ...
    expect(drifted.violations).toContain(
      "G-01: 外部 source ledger distribution_pack_repo observed drift expected=c583953f5fda9c406ff180ae700deefa0d6206ae actual=different-pack-head",
    );
  });
