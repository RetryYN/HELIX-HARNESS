...
describe("HELIX objective evidence audit", () => {
  it("tracks active objective requirements and keeps full completion blocked until readiness is true", () => {
    ...
    expect(text).toContain("21ddd4fed411c04cb19694356570b312c4f4eae6");
  ...
  it("fails when the external distribution reference repository marker is dropped", () => {
    const text = auditText()
      ...
      .replaceAll("21ddd4fed411c04cb19694356570b312c4f4eae6", "pack-head-missing")
    ...
    expect(result.violations).toEqual(
      expect.arrayContaining([
        ...
        "G-01: missing external source marker 21ddd4fed411c04cb19694356570b312c4f4eae6",
        ...
        "G-01: 外部 source ledger distribution_pack_repo observed missing 21ddd4fed411c04cb19694356570b312c4f4eae6",
  ...
  it("fails when external observed source values drift from the ledger", () => {
    ...
    const ok = analyzeObjectiveEvidenceAudit({
      ...
      externalObserved: {
        ...
        distribution_pack_repo: "21ddd4fed411c04cb19694356570b312c4f4eae6",
    ...
    expect(drifted.violations).toContain(
      "G-01: 外部 source ledger distribution_pack_repo observed drift expected=21ddd4fed411c04cb19694356570b312c4f4eae6 actual=different-pack-head",
    );
  });
