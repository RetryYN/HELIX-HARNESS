...
describe("HELIX objective evidence audit", () => {
  it("tracks active objective requirements and keeps full completion blocked until readiness is true", () => {
    ...
    expect(text).toContain("69c36cdff9491fba6e19279d8d545e7d37652f4e");
  ...
  it("fails when the external distribution reference repository marker is dropped", () => {
    const text = auditText()
      ...
      .replaceAll("69c36cdff9491fba6e19279d8d545e7d37652f4e", "pack-head-missing")
    ...
    expect(result.violations).toEqual(
      expect.arrayContaining([
        ...
        "G-01: missing external source marker 69c36cdff9491fba6e19279d8d545e7d37652f4e",
        ...
        "G-01: 外部 source ledger distribution_pack_repo observed missing 69c36cdff9491fba6e19279d8d545e7d37652f4e",
  ...
  it("fails when external observed source values drift from the ledger", () => {
    ...
    expect(drifted.violations).toContain(
      "G-01: 外部 source ledger distribution_pack_repo observed drift expected=69c36cdff9491fba6e19279d8d545e7d37652f4e actual=different-pack-head",
    );
  });
