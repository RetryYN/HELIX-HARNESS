...
describe("HELIX objective evidence audit", () => {
  it("tracks active objective requirements and keeps full completion blocked until readiness is true", () => {
    ...
    expect(text).toContain("714a94a2b5a70a5e21c22f8b9e59530aa587dff3");
  ...
  it("fails when the external distribution reference repository marker is dropped", () => {
    const text = auditText()
      ...
      .replaceAll("714a94a2b5a70a5e21c22f8b9e59530aa587dff3", "pack-head-missing")
    ...
    expect(result.violations).toEqual(
      expect.arrayContaining([
        ...
        "G-01: missing external source marker 714a94a2b5a70a5e21c22f8b9e59530aa587dff3",
        ...
        "G-01: 外部 source ledger distribution_pack_repo observed missing 714a94a2b5a70a5e21c22f8b9e59530aa587dff3",
  ...
  it("fails when external observed source values drift from the ledger", () => {
    ...
    const ok = analyzeObjectiveEvidenceAudit({
      ...
      externalObserved: {
        ...
        distribution_pack_repo: "714a94a2b5a70a5e21c22f8b9e59530aa587dff3",
    ...
    expect(drifted.violations).toContain(
      "G-01: 外部 source ledger distribution_pack_repo observed drift expected=714a94a2b5a70a5e21c22f8b9e59530aa587dff3 actual=different-pack-head",
    );
  });
