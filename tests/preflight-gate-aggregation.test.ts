...
describe("Preflight gate aggregation contract", () => {
  ...
  it("U-CI-PREFLIGHT-AGGREGATION-002: 無理由skipとunexpected_skipをfail-closeし、not_applicableと依存skipは許可する", () => {
  ...
  it("U-CI-PREFLIGHT-AGGREGATION-002: unauthorized skip enforcement欠落とapplies固定をmutationとして拒否する", () => {
