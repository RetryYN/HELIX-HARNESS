#!/usr/bin/env python3
"""PHCAP-15 Deploy final8 research premise; static checks only."""
...
BASE_COMMIT = "f369e2fd400a02104a67645dca681721989d63be"
...
SELECTED_IDS = ['LEGACY-ASSET-7642909D8AA62C75E88D',
 'LEGACY-ASSET-BFCA76AA319FBC61AF05',
 'LEGACY-ASSET-5FEB7612134679928006',
 'LEGACY-ASSET-48C1BA64B0D481CA806D',
 'LEGACY-ASSET-7CAE3DCABA0F5008EB63',
 'LEGACY-ASSET-4916736CCB699929CAC0',
 'LEGACY-ASSET-2FA49FB93A1EFF48115F',
 'LEGACY-ASSET-E0574CEA8F5B95E551C1']
REVIEWED = {'pr_2001': {'asset_ids': ['LEGACY-ASSET-042D2B732DC68AA7EE9A',
 ...
 'sixth12': {'binding_path': 'scaffold/bindings/SCF-B-0065.json',
             'asset_ids': ['LEGACY-ASSET-6929C09B95A444D95B49',
...
EXPECTED_KINDS = {'LEGACY-ASSET-7642909D8AA62C75E88D': 'L12 reviewed-safe disposition implementation source',
 'LEGACY-ASSET-BFCA76AA319FBC61AF05': 'proposal research adoption implementation source',
 'LEGACY-ASSET-5FEB7612134679928006': 'L0-L8 design consistency test source',
 'LEGACY-ASSET-48C1BA64B0D481CA806D': 'L12 hybrid recognition test source',
 'LEGACY-ASSET-7CAE3DCABA0F5008EB63': 'plan governance lint test source',
 'LEGACY-ASSET-4916736CCB699929CAC0': 'doctor slow test source',
 'LEGACY-ASSET-2FA49FB93A1EFF48115F': 'task classification test source',
 'LEGACY-ASSET-E0574CEA8F5B95E551C1': 'version-up readiness test source'}
EXPECTED_ANCHOR_COUNTS = {'LEGACY-ASSET-7642909D8AA62C75E88D': 2,
 'LEGACY-ASSET-BFCA76AA319FBC61AF05': 2,
 'LEGACY-ASSET-5FEB7612134679928006': 2,
 'LEGACY-ASSET-48C1BA64B0D481CA806D': 2,
 'LEGACY-ASSET-7CAE3DCABA0F5008EB63': 2,
 'LEGACY-ASSET-4916736CCB699929CAC0': 2,
 'LEGACY-ASSET-2FA49FB93A1EFF48115F': 2,
 'LEGACY-ASSET-E0574CEA8F5B95E551C1': 2}
EXPECTED_ANCHOR_MEANINGS = {'LEGACY-ASSET-7642909D8AA62C75E88D': ['reviewed-safe source records static false-positive dispositions and content digests',
                                       'toolchain oracle text rejects old runtime authority while preserving provenance and rollback '
                                       'checks'],
 'LEGACY-ASSET-BFCA76AA319FBC61AF05': ['research adoption table maps proposal patterns to sources and incorporation decisions',
                                       'shrink terms enumerate wording that must not reduce required coverage'],
 'LEGACY-ASSET-5FEB7612134679928006': ['test defines source paths for L0-L8 design consistency audit',
                                       'test keeps version-up parked and future labels while checking source text'],
 'LEGACY-ASSET-48C1BA64B0D481CA806D': ['test imports hybrid recognition scanning and reviewed-safe disposition surfaces',
                                       'test requires technology authority candidates to remain false positives with pinned digest'],
 'LEGACY-ASSET-7CAE3DCABA0F5008EB63': ['plan lint test imports governance and schedule lint surfaces with typed status contracts',
                                       'test checks active docs for forbidden stale trace and stub patterns'],
 'LEGACY-ASSET-4916736CCB699929CAC0': ['doctor test imports checker surfaces and filesystem evidence helpers',
                                       'test rejects hybrid self-evaluation provider mismatch'],
 'LEGACY-ASSET-2FA49FB93A1EFF48115F': ['task classification test covers proposal coverage and model-policy inputs',
                                       'test asserts disjoint worker ownership and no closing authority'],
 'LEGACY-ASSET-E0574CEA8F5B95E551C1': ['version-up readiness test imports activation and dry-run readiness surfaces',
                                       'test checks repeat dry-run output and blocked-reason state']}
EXPECTED_UNRESOLVED = ['semantic product split',
 ...
 'consumer closure',
 'successor/decision']
EXPECTED_CONSUMERS = {'LEGACY-ASSET-7642909D8AA62C75E88D': [],
 'LEGACY-ASSET-BFCA76AA319FBC61AF05': [],
 'LEGACY-ASSET-5FEB7612134679928006': [],
 'LEGACY-ASSET-48C1BA64B0D481CA806D': [],
 'LEGACY-ASSET-7CAE3DCABA0F5008EB63': [],
 ...
 'LEGACY-ASSET-2FA49FB93A1EFF48115F': [],
 'LEGACY-ASSET-E0574CEA8F5B95E551C1': []}
EXPECTED_DECISION_MATCHES = {'LEGACY-ASSET-7642909D8AA62C75E88D': 0,
 'LEGACY-ASSET-BFCA76AA319FBC61AF05': 0,
 'LEGACY-ASSET-5FEB7612134679928006': 0,
 'LEGACY-ASSET-48C1BA64B0D481CA806D': 0,
 'LEGACY-ASSET-7CAE3DCABA0F5008EB63': 0,
 'LEGACY-ASSET-4916736CCB699929CAC0': 0,
 'LEGACY-ASSET-2FA49FB93A1EFF48115F': 0,
 'LEGACY-ASSET-E0574CEA8F5B95E551C1': 0}
EXPECTED_COPY_READ_AFTER = {'LEGACY-ASSET-7642909D8AA62C75E88D': 0,
 'LEGACY-ASSET-BFCA76AA319FBC61AF05': 0,
 'LEGACY-ASSET-5FEB7612134679928006': 0,
 'LEGACY-ASSET-48C1BA64B0D481CA806D': 0,
 'LEGACY-ASSET-7CAE3DCABA0F5008EB63': 0,
...
NEGATIVE_CASES = [
    ...
    "overlap with #2001/#2004/SCF-B-0037/third12/next12/fifth12/sixth12",
...
def validate_keysets(data: dict[str, Any]) -> list[str]:
    expected = {
        ...
        "root.provenance.reviewed_sets.sixth12": {"binding_path", "asset_ids"},
        "root.denominator": {"pool_rows", "pool_unique_asset_ids", "pr_2001_selected_rows", "pr_2004_selected_rows", "scf_b0037_selected_rows", "third12_selected_rows", "next12_selected_rows", "fifth12_selected_rows", "sixth12_selected_rows", "already_reviewed_excluded_rows", "finalization_status", "followup_selected_rows", "reviewed_or_selected_total", "remaining_unreviewed_rows", "pool_coverage_statement"},
        ...
        "root.scope.excluded_scopes.sixth12": {"binding_path", "asset_ids"},
        "root.scope.overlap_checks": {"selected_vs_pr_2001", "selected_vs_pr_2004", "selected_vs_scf_b0037", "selected_vs_third12", "selected_vs_next12", "selected_vs_fifth12", "selected_vs_sixth12", "pool_duplicate_ids"},
...
def validate(data: dict[str, Any], check_files: bool = True) -> list[str]:
    ...
    def req(condition: bool, code: str) -> None:
        if not condition:
            errors.append(code)
    req(data.get("schema") == "phcap15-deploy-final8-research/v1", "SCHEMA")
    ...
    req(base.get("worktree") == "/home/tenni/.helix-worktrees/phcap15-deploy-final-audit" and base.get("captured_at") == "2026-09-22", "WORKTREE_CAPTURE")
    task=data.get("task",{})
    ...
    req(prov.get("phase_pool_basis") == "candidate_phase_targets contains PHCAP-15" and prov.get("existing_binding") == "scaffold/bindings/SCF-B-0065.json", "PROVENANCE")
    ...
    req(scope.get("selected_asset_ids") == SELECTED_IDS and len(set(SELECTED_IDS))==8, "SELECTED_SCOPE")
    req(scope.get("remaining_unreviewed_asset_ids") == remaining and len(remaining)==0, "REMAINING_SCOPE")
    req(scope.get("overlap_checks") == {"selected_vs_pr_2001":[],"selected_vs_pr_2004":[],"selected_vs_scf_b0037":[],"selected_vs_third12":[],"selected_vs_next12":[],"selected_vs_fifth12":[],"selected_vs_sixth12":[],"pool_duplicate_ids":[]}, "OVERLAP_CHECKS")
    denominator=data.get("denominator",{})
    expected_denominator={'pool_rows': 78, 'pool_unique_asset_ids': 78, 'pr_2001_selected_rows': 7, 'pr_2004_selected_rows': 12, 'scf_b0037_selected_rows': 3, 'third12_selected_rows': 12, 'next12_selected_rows': 12, 'fifth12_selected_rows': 12, 'sixth12_selected_rows': 12, 'already_reviewed_excluded_rows': 70, 'followup_selected_rows': 8, 'reviewed_or_selected_total': 78, 'remaining_unreviewed_rows': 0, 'finalization_status': 'prior_bundle_merged_final_candidate_pending_root_review', 'pool_coverage_statement': 'PHCAP-15 pool 78件について、第六束SCF-B-0065の#2013 merge後に既レビュー6束70件と最終候補8件を静的に照合した。pool全体を候補分類済みとして保持するが、正式な採否・authority・implementation・degradationはroot reviewへ保留する。'}
    ...
    req(aggregate == {'selected_asset_count': 8, 'selected_asset_decision_matches': 0, 'selected_asset_copy_read_after_matches': 0, 'selected_failure_execution_receipts': 0, 'selected_consumer_refs_nonempty': 0, 'selected_consumer_closure_pending': 8, 'selected_implementation_statuses': {'legacy_source_snapshot': 0, 'legacy_unknown': 8, 'current_unknown': 8, 'current_degradation_unknown': 8}, 'current_implementation_status': 'unknown', 'current_degradation_status': 'unknown', 'current_phase_admission': 'unresolved_candidate_only'}, "AGGREGATE")
    ...
    req(data.get("counts") == {'pool_rows': 78, 'selected_rows': 8, 'excluded_rows': 70, 'remaining_unreviewed_rows': 0, 'four_products': 4, 'selected_source_anchors': 16, 'selected_decision_matches': 0, 'selected_copy_read_after_matches': 0, 'selected_consumer_refs_nonempty': 0}, "COUNTS")
    return errors
...
if __name__ == "__main__":
    ...
    if problems:
        print("FAIL PHCAP15 final8")
        print("\n".join(problems))
        raise SystemExit(1)
    print("PASS PHCAP15 final8: pool=78 prior_reviewed=70 selected=8 remaining=0")
