#!/usr/bin/env python3
"""SCF-B-0131 deterministic negative checks."""
...
def run_taxonomy_body_regeneration_case() -> None:
    ...
    env = os.environ.copy()
    env.update({
        "GIT_AUTHOR_NAME": "SCF-B-0131 selfcheck",
        "GIT_AUTHOR_EMAIL": "scf-b-0119-selfcheck@example.invalid",
        "GIT_COMMITTER_NAME": "SCF-B-0131 selfcheck",
...
if __name__ == "__main__":
    ...
    cases = [
        ("schema", "E_SCHEMA", lambda inv, rows: inv.__setitem__("schema", "phase-direct-evidence-next5-0131/v0")),
    ...
    print(f"SCF-B-0131 selfcheck PASS ({len(cases) + 3} negative cases)")
