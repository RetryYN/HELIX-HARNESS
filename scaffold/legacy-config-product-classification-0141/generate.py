...
def build() -> None:
    ...
    inv = {
        ...
        "denominator_role": {"archive_population": 4020, "authoritative_current_main": 496, "authoritative_after_config": 537, "role": "research_candidate_evidence_only; no formal adoption or completion"},
