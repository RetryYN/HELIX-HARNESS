#!/usr/bin/env python3
"""Fail-closed static verifier for the Wave40 schema10 candidate."""
...
LEDGER = HERE / "legacy-requirement-direct-semantic-review-wave40.jsonl"
META = HERE / "legacy-requirement-direct-semantic-review-wave40.meta.json"
...
BATCH = "LEGACY-SEMANTIC-WAVE40-2026-09-22"
BASE = "f07602eef199048ba27200f81b78e838926cae8b"
MAIN_MERGE_PARENTS = [
    "98b5fb0f0743969835dcde7ebd00b476470a53a8",
    "70c0c6f8934e66a6d88c6066d7aa33ab2925574a",
]
...
SUPPLEMENTAL_ASSET_IDS = {"LEGACY-ASSET-50A93B0E753DC3840E03", "LEGACY-ASSET-F15959C1E9E9256ED64B", "LEGACY-ASSET-3A15E5645D2D2A59DFF5"}
UNITS = [
    "IRUNIT-HIL-BR-20-HELIX-HARNESS",
    "IRUNIT-HIL-FR-04-HELIX-OS",
    "IRUNIT-HIL-FR-33-HELIX-OS",
    "IRUNIT-HIL-NFR-03-HELIX-OS",
    "IRUNIT-HIL-NFR-05-HELIX-OS",
]
SELECTED = {
    "IRUNIT-HIL-BR-20-HELIX-HARNESS": {REQUIREMENT_ASSET, "LEGACY-ASSET-174B63F415197A4B09C5", "LEGACY-ASSET-112AF1725DFB5F16FB6A"},
    "IRUNIT-HIL-FR-04-HELIX-OS": {REQUIREMENT_ASSET, "LEGACY-ASSET-0449CFE6165EF25515B7", "LEGACY-ASSET-172EBB6DBA696EC454E9"},
    "IRUNIT-HIL-FR-33-HELIX-OS": {REQUIREMENT_ASSET},
    "IRUNIT-HIL-NFR-03-HELIX-OS": {REQUIREMENT_ASSET, "LEGACY-ASSET-09D2A49CAA02AAFAC195", "LEGACY-ASSET-0F66E2A823A36187D315"},
    "IRUNIT-HIL-NFR-05-HELIX-OS": {REQUIREMENT_ASSET},
}

QUERIES = {
    "IRUNIT-HIL-BR-20-HELIX-HARNESS": {"anchors": ["evidence", "CI", "quarantine"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-FR-04-HELIX-OS": {"anchors": ["review", "receipt", "process"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-FR-33-HELIX-OS": {"anchors": ["Bun", "Dependency", "active"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-03-HELIX-OS": {"anchors": ["memory", "slot", "handover"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-05-HELIX-OS": {"anchors": ["untrusted", "metadata", "evidence"], "match_mode": "archive_file_contains_any_utf8_anchor"},
}
...
def verify_role(row: dict) -> None:
    ...
    require(row["review_scope"].startswith("Wave40 schema10"), f"review scope {row['review_id']}")
...
def verify() -> None:
    ...
    require([row["review_id"] for row in rows] == [f"LSRW40-EDGE-{i:03d}" for i in range(1, 12)], "review order")
    ...
    require(meta["source_main_base_revision"] == BASE and meta["wave40_exact_head"] == BASE, "source base")
    ...
    require(meta["cumulative_reviewed_unit_count"] == 161 and meta["cumulative_reviewed_edge_count"] == 476 and meta["remaining_unit_count"] == 57, "cumulative counts")
    ...
    require(inspected == selected_assets | SUPPLEMENTAL_ASSET_IDS and len(inspected) == 10, "inspected asset denominator")
    ...
    require(len(prior_units | set(UNITS)) == 161 and len(prior_edges | current_edges) == 476, "cumulative union")

    by_unit = {unit: [row for row in rows if row["unit_candidate_id"] == unit] for unit in UNITS}
    expected_missing = {("design", "IRUNIT-HIL-FR-33-HELIX-OS"), ("implementation_source", "IRUNIT-HIL-FR-33-HELIX-OS"), ("design", "IRUNIT-HIL-NFR-05-HELIX-OS"), ("implementation_source", "IRUNIT-HIL-NFR-05-HELIX-OS")}
    ...
    print("Wave40 static schema10 verification: PASS (source chain, boundary, lineage and negative mutations)")
