...
1. `origin/main` を fetch して `f15c3ca2ed1dc865b242b0a21e1516fdeec6f9f6` を確認し、SCF-B-0087 の 57 件を既済集合として照合しました。残余 10 件から昇順の 028／039／040／042／044 を選び、ID と source path の exact overlap がないことを確認しました。
