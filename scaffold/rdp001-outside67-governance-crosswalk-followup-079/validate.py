...
SOURCE_PATHS={'OUTSIDE67-PATH-015': 'docs/governance/audits/l2-requirements/candidate-source-target-inventory.md', 'OUTSIDE67-PATH-018': 'docs/governance/audits/l2-requirements/concept-v4.1-human-decision-packet.md', 'OUTSIDE67-PATH-029': 'docs/governance/audits/l2-requirements/l2-source-adoption-sequence.md', 'OUTSIDE67-PATH-032': 'docs/governance/audits/l2-requirements/legacy-ci-ai-runtime-source-inventory.md', 'OUTSIDE67-PATH-067': 'docs/test-design/helix/L11-concept-v4-derived-requirements.md'}
COUNTERPARTS={'OUTSIDE67-PATH-015': 'docs/governance/audits/source-rebaseline/candidate-source-target-inventory.md', 'OUTSIDE67-PATH-018': 'docs/governance/audits/source-rebaseline/concept-v4.1-human-decision-packet.md', 'OUTSIDE67-PATH-029': 'docs/governance/audits/source-rebaseline/l2-source-adoption-sequence.md', 'OUTSIDE67-PATH-032': 'docs/governance/audits/source-rebaseline/legacy-ci-ai-runtime-source-inventory.md', 'OUTSIDE67-PATH-067': 'docs/governance/crosswalks/legacy-concept-derived-acceptance.md'}
COUNTERPART_MATCH={"OUTSIDE67-PATH-015":True,"OUTSIDE67-PATH-018":False,"OUTSIDE67-PATH-029":False,"OUTSIDE67-PATH-032":True,"OUTSIDE67-PATH-067":False}
CURRENT_COUNTERPART_HASH_EQUAL_ARCHIVE_IDS=['OUTSIDE67-PATH-015','OUTSIDE67-PATH-032']
CURRENT_COUNTERPART_CONTENT_DRIFT_IDS=['OUTSIDE67-PATH-018','OUTSIDE67-PATH-029','OUTSIDE67-PATH-067']
LINES={'OUTSIDE67-PATH-015': [(5, 5), (6, 6), (11, 11), (18, 18), (54, 54)], 'OUTSIDE67-PATH-018': [(5, 5), (9, 9), (15, 15), (19, 19), (44, 44)], 'OUTSIDE67-PATH-029': [(8, 8), (9, 9), (14, 14), (21, 21), (57, 57)], 'OUTSIDE67-PATH-032': [(7, 7), (25, 25), (30, 30), (54, 54), (56, 56)], 'OUTSIDE67-PATH-067': [(18, 18), (21, 21), (28, 28), (35, 35), (54, 54)]}
KINDS={'OUTSIDE67-PATH-015': ['source_catalog_authority_boundary', 'source_catalog_status_boundary', 'source_catalog_l2_connection', 'source_catalog_table_boundary', 'source_catalog_admission_boundary'], 'OUTSIDE67-PATH-018': ['decision_packet_status_boundary', 'decision_packet_revision_boundary', 'decision_packet_product_boundary', 'decision_packet_sha_boundary', 'decision_packet_nonclosure_boundary'], 'OUTSIDE67-PATH-029': ['adoption_sequence_purpose_boundary', 'adoption_sequence_input_boundary', 'adoption_sequence_decision_boundary', 'adoption_sequence_execution_boundary', 'adoption_sequence_completion_boundary'], 'OUTSIDE67-PATH-032': ['legacy_inventory_execution_boundary', 'legacy_inventory_workflow_boundary', 'legacy_inventory_consumer_boundary', 'legacy_inventory_evidence_boundary', 'legacy_inventory_archive_gate'], 'OUTSIDE67-PATH-067': ['l11_source_authority_boundary', 'l11_execution_status_boundary', 'l11_acceptance_atom_boundary', 'l11_target_split_boundary', 'l11_nonclosure_boundary']}
PHASE_CANDIDATES={'OUTSIDE67-PATH-015': 'upstream-governance-or-crosswalk', 'OUTSIDE67-PATH-018': 'upstream-governance-or-crosswalk', 'OUTSIDE67-PATH-029': 'upstream-governance-or-crosswalk', 'OUTSIDE67-PATH-032': 'upstream-governance-or-crosswalk', 'OUTSIDE67-PATH-067': 'L11-acceptance'}
...
SCOPE_CANONICAL={'base_origin_main': '8e4a737a919caf768c9e0b916c83a5428966e58f', 'base_origin_main_expected_before_fetch': 'ea771fb2c496d40fcc429877b0fcd8cff6999526', 'base_drift_observed': True, 'base_drift_from': 'ea771fb2c496d40fcc429877b0fcd8cff6999526', 'base_drift_to': '8e4a737a919caf768c9e0b916c83a5428966e58f', 'read_only': True, 'static_only': True, 'holding_registration_id': 'MPR-SH-OUTSIDE67-001', 'holding_path': 'docs/governance/legacy-migration/pre-isolation/pre-isolation-outside-holding-67-source-holding.jsonl', 'holding_path_revision_pair_denominator': 67, 'holding_record_count': 67, 'current_live_source_holding_count': 14, 'management_register_path': 'docs/governance/management-provisional-requirement-register.jsonl', 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066', 'OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060', 'OUTSIDE67-PATH-002', 'OUTSIDE67-PATH-005', 'OUTSIDE67-PATH-013', 'OUTSIDE67-PATH-031', 'OUTSIDE67-PATH-061', 'OUTSIDE67-PATH-003', 'OUTSIDE67-PATH-006', 'OUTSIDE67-PATH-009', 'OUTSIDE67-PATH-012', 'OUTSIDE67-PATH-014'], 'remaining_before_candidate_selection': 30, 'candidate_ids': ['OUTSIDE67-PATH-015', 'OUTSIDE67-PATH-018', 'OUTSIDE67-PATH-029', 'OUTSIDE67-PATH-032', 'OUTSIDE67-PATH-067'], 'candidate_count': 5, 'remaining_after_candidate_selection': 25, 'unexplored_scope': 'all outside67 path_revision_pair not in the existing 37 or this five-source research set; candidate accounting remains scaffold evidence until any later holding admission', 'accounting_status': 'provisional_42_of_67_research_no_formal_holding_admission', 'pre_isolation_commit': '2d4991042be55268bac30a8bbcdac45b3865030a', 'archive_commit': '064280b5c1c5c98f949e6e3be5ef87cbe4a4b658', 'historical_capture_commit': '3df81ad27157c471e004083783f37a5860eaa2ee', 'source_unit': 'path_revision_pair', 'requirement_atoms_are_not_path_pairs': True, 'batch_width_observed': 5, 'origin_main_rebaseline_required_after_2016_merge': False, 'binding_reservation': 'SCF-B-0079', 'binding_registration_status': 'registered'}
...
SOURCE_HOLDING_CANONICAL={'registration_id': 'MPR-SH-OUTSIDE67-001', 'selected_item_ids': ['OUTSIDE67-PATH-015', 'OUTSIDE67-PATH-018', 'OUTSIDE67-PATH-029', 'OUTSIDE67-PATH-032', 'OUTSIDE67-PATH-067'], 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066', 'OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060', 'OUTSIDE67-PATH-002', 'OUTSIDE67-PATH-005', 'OUTSIDE67-PATH-013', 'OUTSIDE67-PATH-031', 'OUTSIDE67-PATH-061', 'OUTSIDE67-PATH-003', 'OUTSIDE67-PATH-006', 'OUTSIDE67-PATH-009', 'OUTSIDE67-PATH-012', 'OUTSIDE67-PATH-014'], 'denominator': 67, 'candidate_count': 5, 'reviewed_count': 37, 'combined_reviewed_and_candidate_count': 42, 'remaining_after_research': 25, 'accounting_status': 'provisional_42_of_67_no_formal_holding_admission'}
SELECTION_KEYS={'candidate_ids','excluded_existing_ids','reason'}
SELECTION_CANONICAL={'candidate_ids': ['OUTSIDE67-PATH-015', 'OUTSIDE67-PATH-018', 'OUTSIDE67-PATH-029', 'OUTSIDE67-PATH-032', 'OUTSIDE67-PATH-067'], 'excluded_existing_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066', 'OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060', 'OUTSIDE67-PATH-002', 'OUTSIDE67-PATH-005', 'OUTSIDE67-PATH-013', 'OUTSIDE67-PATH-031', 'OUTSIDE67-PATH-061', 'OUTSIDE67-PATH-003', 'OUTSIDE67-PATH-006', 'OUTSIDE67-PATH-009', 'OUTSIDE67-PATH-012', 'OUTSIDE67-PATH-014'], 'reason': 'source/judgement-history/failure/consumer diversity across governance inventory, human decision packet, L2 adoption sequence, legacy CI/AI inventory, and L11 crosswalk; no exact source ID/path overlap with existing thirty-seven'}
...
EXPECTED_SOURCE_DIFF={'OUTSIDE67-PATH-015': 'same', 'OUTSIDE67-PATH-018': 'different', 'OUTSIDE67-PATH-029': 'same', 'OUTSIDE67-PATH-032': 'different', 'OUTSIDE67-PATH-067': 'same'}
...
def validate(root):
 root=Path(root).resolve(); out=root/'scaffold/rdp001-outside67-governance-crosswalk-followup-079'; e=[]
 inv=load(out/'inventory.json',e,'E_INV')
 if not isinstance(inv,dict):return e
 fail(e,'E_ROOT_KEYS',set(inv)!=ROOT_KEYS)
 fail(e,'E_ID_SCHEMA',inv.get('schema')!='rdp001-outside67-followup/v1' or inv.get('candidate_id')!='RDP-001-OUTSIDE67-GOVERNANCE-CROSSWALK-FOLLOWUP-015-018-029-032-067')
 ...
 fail(e,'E_WORKTREE',sc.get('worktree')!='/home/tenni/.helix-worktrees/outside67-next-079')
 fail(e,'E_SCOPE_REASON',sc.get('base_drift_reason')!='initial exact base ea771fb2 was superseded after #2027 advanced origin/main to 8e4a737a; worktree was fast-forwarded to latest main before final verification.')
 ...
 if isinstance(meta,dict):
  for k,v in {'schema':'rdp001-outside67-followup-meta/v1','bundle_id':'RDP-001-OUTSIDE67-GOVERNANCE-CROSSWALK-FOLLOWUP-015-018-029-032-067','binding_reservation':'SCF-B-0079','binding_registration_status':'registered','base_origin_main':HEAD,'base_origin_main_previous':PREVIOUS_HEAD,'candidate_ids':IDS,'existing_reviewed_count':37,'candidate_count':5,'combined_count':42,'denominator':67,'remaining_after_research':25,'anchor_count':25,'static_only':True,'old_runtime_test_ci_execution':False,'authority_effect':'none'}.items():fail(e,f'E_META:{k}',meta.get(k)!=v)
...
def main():
 ...
 print('PASS outside67 follow-up validator: 5 source pairs / 25 exact anchors / provisional 42-of-67 static-only'); return 0
