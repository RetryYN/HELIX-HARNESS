#!/usr/bin/env python3
"""SCF-B-0111 の HIL-FR-41〜69 静的証拠partitionを生成する。
...
def target_crosswalk() -> list[dict[str, Any]]:
    ...
    if len(rows) != 37 or any(not UNIT_PATTERN.fullmatch(row.get("unit_candidate_id", "")) for row in rows):
        raise ValueError("HIL-FR-41〜69の製品unit集合が37件のFR専用集合ではない")
...
if __name__ == "__main__":
    ...
    print("SCF-B-0111 bundle generated")
