#!/usr/bin/env python3
"""Negative checks for the PHCAP-15 Deploy next12 static research scaffold."""
...
def main() -> int:
    ...
    if validate(baseline):
        print("FAIL next12 selfcheck baseline")
        return 1
    cases = [
    ...
    if failed:
        return 1
    print(f"PASS next12 selfcheck: {len(cases)} negative cases rejected")
    return 0
