...
- `python3 scaffold/legacy-schema-product-classification-0120/selfcheck.py`（48負例、期待error code照合。generator category/products pin再生成、nested key閉包、型ガード、姉妹inventory blob driftを含む）
