...
- `selfcheck.py`: PASS（29 negative cases、taxonomy set/status/matrix join/authority boundaryを含む期待error code照合）
- `py_compile`: PASS
