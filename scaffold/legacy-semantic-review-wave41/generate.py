#!/usr/bin/env python3
"""Generate the Wave41 schema10 research-premise ledger.
...
UNIT_SPECS = [
    {
        "unit": "IRUNIT-HIL-NFR-06-HELIX-HARNESS",
        "query": {"anchors": ["evidence", "gate"], "match_mode": "archive_file_contains_all_utf8_anchors"},
        "design_asset": "LEGACY-ASSET-5429AA05B022E9F49B0A",
        "implementation_asset": None,
        "missing_roles": ["implementation_source"],
        "atom_prefix": "NFR06-HARNESS",
        "composite_unresolved_count": 1,
        "evidence": {
            "design": ("docs/design/harness/L1-requirements/nfr.md", 43, 55, []),
        },
    },
    {
        "unit": "IRUNIT-HIL-NFR-07-HELIX-HARNESS",
        "query": {"anchors": ["evidence", "gate"], "match_mode": "archive_file_contains_all_utf8_anchors"},
        "design_asset": "LEGACY-ASSET-5429AA05B022E9F49B0A",
        "implementation_asset": None,
        "missing_roles": ["implementation_source"],
        "atom_prefix": "NFR07-HARNESS",
        "composite_unresolved_count": 1,
        "shared_with": ["IRUNIT-HIL-NFR-07-HELIX-OS"],
        "shared_fragments": ["complexity、public surface、運用負債を測り", "拡張を拒否する"],
        "evidence": {
            "design": ("docs/design/harness/L1-requirements/nfr.md", 43, 55, []),
        },
    },
    {
        "unit": "IRUNIT-HIL-NFR-07-HELIX-OS",
        "query": {"anchors": ["evidence", "gate"], "match_mode": "archive_file_contains_all_utf8_anchors"},
        "design_asset": None,
        "implementation_asset": None,
        "missing_roles": ["design", "implementation_source"],
        "atom_prefix": "NFR07-OS",
        "composite_unresolved_count": 1,
        "shared_with": ["IRUNIT-HIL-NFR-07-HELIX-HARNESS"],
        "shared_fragments": ["complexity、public surface、運用負債を測り", "拡張を拒否する"],
        "evidence": {},
    },
    {
        "unit": "IRUNIT-HIL-NFR-08-HELIX-HARNESS",
        "query": {"anchors": ["evidence", "oracle"], "match_mode": "archive_file_contains_all_utf8_anchors"},
        "design_asset": "LEGACY-ASSET-EA8C51BDF69B34E896AA",
        "implementation_asset": None,
        "missing_roles": ["implementation_source"],
        "atom_prefix": "NFR08-HARNESS",
        "composite_unresolved_count": 1,
        "evidence": {
            "design": ("docs/design/helix/L12-acceptance/acceptance-evidence-index.md", 27, 32, []),
        },
    },
    {
        "unit": "IRUNIT-HIL-NFR-08-HELIX-OS",
        "query": {"anchors": ["evidence", "gate"], "match_mode": "archive_file_contains_all_utf8_anchors"},
        "design_asset": "LEGACY-ASSET-A4DD57E39031B1402494",
        "implementation_asset": "LEGACY-ASSET-B9FEE35D2F064EEA4784",
        "atom_prefix": "NFR08-OS",
        "composite_unresolved_count": 1,
        "evidence": {
            "design": ("docs/design/harness/L4-basic-design/data.md", 48, 58, []),
            "implementation_source": ("src/setup/index.ts", 1, 80, []),
        },
    },
]
...
REVIEW_SCOPE = "Wave41 schema10 research-premise candidate: exact requirement source / product boundary / phase candidate / catalog asset role"
...
def main() -> None:
    ...
    for spec in UNIT_SPECS:
        ...
        for role, asset in asset_by_role:
            ...
            if role == "requirement":
                req_ranges = {"HIL-NFR-06": (4640, 4648), "HIL-NFR-07": (4683, 4691), "HIL-NFR-08": (4726, 4734)}
            ...
            row = {
                ...
                "review_id": f"LSRW41-EDGE-{len(rows) + 1:03d}",
    ...
    ledger_path = OUT / "legacy-requirement-direct-semantic-review-wave41.jsonl"
    ...
    meta = {
        ...
        "consumer_closure_status": "pending",
        "cumulative_reviewed_edge_count": 486,
        "cumulative_reviewed_unit_count": 166,
        ...
        "wave41_candidate_parent": BASE,
        "wave41_candidate_ref": "research/legacy-semantic-review-wave41",
        "wave41_candidate_root": BASE,
        "wave41_exact_head": BASE,
    }
    ...
    meta_path = OUT / "legacy-requirement-direct-semantic-review-wave41.meta.json"
