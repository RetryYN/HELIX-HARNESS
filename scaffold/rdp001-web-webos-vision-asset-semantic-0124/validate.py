...
def validate(bundle,repo):
 ...
 if sha_file(bundle/"inputs/l1-anchor-0121/inventory.json")!="c71c07bed9e4ff75cd7031d5c0454963d56788735ce973e92dc308d6edc34267": fail("E_INPUT_DIGEST","#2073 inventory digest changed")
 if sha_file(bundle/"inputs/l1-anchor-0121/SCF-B-0121.json")!="7fe2df4d996a0d236d8a25026c2133d5864ed5410e103e62814aa841c8caadc1": fail("E_INPUT_DIGEST","#2073 binding digest changed")
 ...
 if inv.get("negative_case_codes")!=NEGATIVE_CODES or inv.get("negative_case_count")!=16: fail("E_INVENTORY_DECLARATION","negative case declaration changed")
