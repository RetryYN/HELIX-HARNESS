...
def main():
    ...
    write_json(HERE/"source-diff.json",{
      ...
      "l1_anchor_input":{"candidate_count":11,"commit":L1_COMMIT,"path":"scaffold/rdp001-outside67-web-webos-l1-anchor-0121/candidate-units.jsonl","blob_oid":L1_BLOB_OID,"sha256":sha(HERE/"inputs/l1-anchor-0121/candidate-units.jsonl"),"status":"candidate_only"},
    })
    inventory={
