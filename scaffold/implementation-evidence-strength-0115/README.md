...
- `selfcheck.py`: source／asset／anchor、edge／asset欠落・重複、ledger、代表asset、partition、current／未実装、strength assessment、inventory宣言、input digest、BASEを改竄する25負例を期待error code付きで検査する。
...
SCF-B-0115 selfcheck: PASS (25 negative cases; expected error codes matched)
