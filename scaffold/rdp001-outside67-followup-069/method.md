...
1. #2016 merge後のlatest `origin/main` `38d38f47794e70d621403ad8dbeac56518a76766`へfresh worktreeをrebaselineし、pre-isolation `2d4991042be55268bac30a8bbcdac45b3865030a`とarchive `064280b5c1c5c98f949e6e3be5ef87cbe4a4b658`の同一source pathを`git show`で静的取得した。直前基点 `dbcc0f332704302d2f8181479552e7198f102db7`からのdriftとrebaselineをscopeに記録した。
