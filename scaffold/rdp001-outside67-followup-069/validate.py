...
IDS=['OUTSIDE67-PATH-034','OUTSIDE67-PATH-036','OUTSIDE67-PATH-046','OUTSIDE67-PATH-052','OUTSIDE67-PATH-056']
EXISTING=['OUTSIDE67-PATH-008','OUTSIDE67-PATH-011','OUTSIDE67-PATH-030','OUTSIDE67-PATH-033','OUTSIDE67-PATH-043','OUTSIDE67-PATH-045','OUTSIDE67-PATH-055','OUTSIDE67-PATH-059','OUTSIDE67-PATH-063','OUTSIDE67-PATH-064','OUTSIDE67-PATH-065','OUTSIDE67-PATH-066']
PRE='2d4991042be55268bac30a8bbcdac45b3865030a'; ARCH='064280b5c1c5c98f949e6e3be5ef87cbe4a4b658'
HEAD='98b5fb0f0743969835dcde7ebd00b476470a53a8'; PREVIOUS_HEAD='38d38f47794e70d621403ad8dbeac56518a76766'
...
SOURCE_PATHS={'OUTSIDE67-PATH-034':'docs/governance/audits/l2-requirements/legacy-harness-requirements-source-crosswalk.md','OUTSIDE67-PATH-036':'docs/governance/audits/l2-requirements/new-generation-bounded-repair-source-crosswalk.md','OUTSIDE67-PATH-046':'docs/governance/audits/l2-requirements/new-generation-security-engagement-source-crosswalk.md','OUTSIDE67-PATH-052':'docs/governance/candidates/ai-readable-authority-requirements.md','OUTSIDE67-PATH-056':'docs/governance/candidates/next-generation-ci-requirements.md'}
COUNTERPARTS={'OUTSIDE67-PATH-034':'docs/governance/audits/source-rebaseline/legacy-harness-requirements-source-crosswalk.md','OUTSIDE67-PATH-036':'docs/governance/audits/source-rebaseline/new-generation-bounded-repair-source-crosswalk.md','OUTSIDE67-PATH-046':'docs/governance/audits/source-rebaseline/new-generation-security-engagement-source-crosswalk.md','OUTSIDE67-PATH-052':'docs/governance/candidates/ai-readable-authority-requirements.md','OUTSIDE67-PATH-056':'docs/governance/candidates/next-generation-ci-requirements.md'}
COUNTERPART_MATCH={'OUTSIDE67-PATH-034':False,'OUTSIDE67-PATH-036':True,'OUTSIDE67-PATH-046':True,'OUTSIDE67-PATH-052':False,'OUTSIDE67-PATH-056':False}
LINES={'OUTSIDE67-PATH-034':[(15,15),(16,16),(31,31),(44,44),(58,58)],'OUTSIDE67-PATH-036':[(18,18),(22,22),(30,30),(38,38),(39,39)],'OUTSIDE67-PATH-046':[(18,18),(20,20),(28,28),(34,34),(43,43)],'OUTSIDE67-PATH-052':[(24,24),(32,33),(40,41),(48,49),(55,56)],'OUTSIDE67-PATH-056':[(29,29),(38,38),(47,47),(50,50),(54,54)]}
KINDS={'OUTSIDE67-PATH-034':['crosswalk_boundary','worker_control_boundary','operational_state_boundary','quality_boundary','product_constraint_boundary'],'OUTSIDE67-PATH-036':['repair_trigger','repair_write_authority','approval_unknown_boundary','harness_validation_boundary','os_operation_authority'],'OUTSIDE67-PATH-046':['authorization_scope','finding_verification','security_execution_guard','revoke_propagation','security_acceptance_boundary'],'OUTSIDE67-PATH-052':['ai_source_boundary','product_responsibility_boundary','harness_authority_contract','session_context_boundary','consumer_relation'],'OUTSIDE67-PATH-056':['harness_oracle_boundary','verification_profile','ci_profile_input','failure_state_relation','ci_consumer_relation']}
...
SCOPE_CANONICAL={'base_origin_main':HEAD,'base_origin_main_expected_before_fetch':PREVIOUS_HEAD,'base_drift_observed':True,'base_drift_from':PREVIOUS_HEAD,'base_drift_to':HEAD,'read_only':True,'static_only':True,'holding_registration_id':'MPR-SH-OUTSIDE67-001','holding_path':HOLDING,'holding_path_revision_pair_denominator':67,'holding_record_count':67,'current_live_source_holding_count':14,'management_register_path':REGISTER,'existing_reviewed_ids':EXISTING,'remaining_before_candidate_selection':55,'candidate_ids':IDS,'candidate_count':5,'remaining_after_candidate_selection':50,'unexplored_scope':'all outside67 path_revision_pair not in the existing 12 or this five-source research set; candidate accounting remains scaffold evidence until any later holding admission','accounting_status':'provisional_17_of_67_research_no_formal_holding_admission','pre_isolation_commit':PRE,'archive_commit':ARCH,'historical_capture_commit':'3df81ad27157c471e004083783f37a5860eaa2ee','source_unit':'path_revision_pair','requirement_atoms_are_not_path_pairs':True,'batch_width_observed':5,'origin_main_rebaseline_required_after_2016_merge':False,'binding_reservation':'SCF-B-0069','binding_registration_status':'registered'}
...
SOURCE_HOLDING_CANONICAL={'registration_id':'MPR-SH-OUTSIDE67-001','selected_item_ids':IDS,'existing_reviewed_ids':EXISTING,'denominator':67,'candidate_count':5,'reviewed_count':12,'combined_reviewed_and_candidate_count':17,'remaining_after_research':50,'accounting_status':'provisional_17_of_67_no_formal_holding_admission'}
SELECTION_KEYS={'candidate_ids','excluded_existing_ids','reason'}
SELECTION_CANONICAL={'candidate_ids':IDS,'excluded_existing_ids':EXISTING,'reason':'source-chain diversity across harness crosswalk, bounded repair, security engagement, AI-readable authority, and next-generation CI; no exact source ID/path overlap with the existing twelve'}
...
EXPECTED_SOURCE_DIFF={'OUTSIDE67-PATH-034':'same','OUTSIDE67-PATH-036':'same','OUTSIDE67-PATH-046':'same','OUTSIDE67-PATH-052':'different','OUTSIDE67-PATH-056':'same'}
...
def validate(root):
 root=Path(root).resolve(); out=root/'scaffold/rdp001-outside67-followup-069'; e=[]
 inv=load(out/'inventory.json',e,'E_INV')
 if not isinstance(inv,dict):return e
 fail(e,'E_ROOT_KEYS',set(inv)!=ROOT_KEYS)
 fail(e,'E_ID_SCHEMA',inv.get('schema')!='rdp001-outside67-followup/v1' or inv.get('candidate_id')!='RDP-001-OUTSIDE67-FOLLOWUP-034-036-046-052-056')
 ...
 if isinstance(meta,dict):
  for k,v in {'schema':'rdp001-outside67-followup-meta/v1','bundle_id':'RDP-001-OUTSIDE67-FOLLOWUP-034-036-046-052-056','binding_reservation':'SCF-B-0069','binding_registration_status':'registered','base_origin_main':HEAD,'base_origin_main_previous':PREVIOUS_HEAD,'candidate_ids':IDS,'existing_reviewed_count':12,'candidate_count':5,'combined_count':17,'denominator':67,'remaining_after_research':50,'anchor_count':25,'static_only':True,'old_runtime_test_ci_execution':False,'authority_effect':'none'}.items():fail(e,f'E_META:{k}',meta.get(k)!=v)
...
def main():
 ...
 print('PASS outside67 follow-up validator: 5 source pairs / 25 exact anchors / provisional 17-of-67 static-only'); return 0
