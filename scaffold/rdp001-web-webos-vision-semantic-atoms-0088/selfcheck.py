...
cases = [
    ...
    ("prior_span_overlap", lambda i, a: i["scope"]["prior_selected_parent_span_ids"].__setitem__(0, "VISION-U17"), "E_PRIOR_SPAN_OVERLAP"),
    ("source_text", lambda i, a: a[0].__setitem__("exact_source_text", "tampered"), "E_ATOM_TEXT"),
    ("parent_containment", lambda i, a: (a[0].__setitem__("source_line_start", 100), a[0].__setitem__("source_line_end", 100)), "E_PARENT_CONTAINMENT"),
    ("prior_line_overlap", lambda i, a: (a[0].__setitem__("source_line_start", 539), a[0].__setitem__("source_line_end", 539)), "E_PRIOR_LINE_OVERLAP"),
    ("inventory_product_span_list", lambda i, a: i["candidate_products"][2]["candidate_parent_span_ids"].remove("VISION-U19"), "E_PRODUCT_DERIVATION"),
    ("atom_product_span_list", lambda i, a: a[2]["candidate_product_candidates"].remove("HELIX-Web"), "E_PRODUCT_DERIVATION"),
    ...
    ("related_decision_replacement", lambda i, a: a[0].__setitem__("related_open_decision_ids", ["VISION-O09"]), "E_ATOM_RELATION"),
    ("related_decision_empty", lambda i, a: a[1].__setitem__("related_open_decision_ids", []), "E_ATOM_RELATION"),
