...
基準は `origin/main` の `d340ea82723c01fece5610dceea8eff81e03b686`。SCF-B-0080 の Vision parent span と、SCF-B-0081／0084／0088 の候補を静的に再照合し、Web と Web-OS の候補境界を分離した接続行列を作成する bounded Scaffold です。
