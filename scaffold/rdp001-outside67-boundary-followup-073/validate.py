...
IDS=['OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060']
EXISTING=['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066']
PRE='2d4991042be55268bac30a8bbcdac45b3865030a'; ARCH='064280b5c1c5c98f949e6e3be5ef87cbe4a4b658'
HEAD='95ba7e1813116632fd68ab3dcfc3b52ef18712b1'; PREVIOUS_HEAD='cbee6b056c5132e178392b0a9a4e7a5ebcb9085a'
...
SOURCE_PATHS={'OUTSIDE67-PATH-001': 'docs/design/harness/L1-planning/product-intent.md', 'OUTSIDE67-PATH-004': 'docs/design/helix-os/L1-planning/system-intent.md', 'OUTSIDE67-PATH-007': 'docs/design/helix-web-os/L1-planning/system-intent.md', 'OUTSIDE67-PATH-010': 'docs/design/helix-web/L1-planning/product-intent.md', 'OUTSIDE67-PATH-060': 'docs/governance/upstream-authority-register-2026-09-14.md'}
COUNTERPARTS={'OUTSIDE67-PATH-001': 'docs/helix-harness/L1-planning/product-intent.md', 'OUTSIDE67-PATH-004': 'docs/helix-os/L1-planning/system-intent.md', 'OUTSIDE67-PATH-007': 'helix-web/docs/helix-web-os/L1-planning/system-intent.md', 'OUTSIDE67-PATH-010': 'helix-web/docs/helix-web/L1-planning/product-intent.md', 'OUTSIDE67-PATH-060': 'docs/governance/upstream-authority-register-2026-09-14.md'}
COUNTERPART_MATCH={'OUTSIDE67-PATH-001': False, 'OUTSIDE67-PATH-004': False, 'OUTSIDE67-PATH-007': False, 'OUTSIDE67-PATH-010': False, 'OUTSIDE67-PATH-060': False}
LINES={'OUTSIDE67-PATH-001': [(18, 18), (22, 22), (28, 28), (32, 32), (55, 55)], 'OUTSIDE67-PATH-004': [(18, 18), (22, 22), (30, 30), (35, 35), (42, 42)], 'OUTSIDE67-PATH-007': [(15, 15), (20, 20), (22, 22), (40, 40), (48, 48)], 'OUTSIDE67-PATH-010': [(20, 20), (25, 25), (30, 30), (35, 35), (48, 48)], 'OUTSIDE67-PATH-060': [(8, 8), (9, 9), (20, 21), (28, 29), (63, 64)]}
KINDS={'OUTSIDE67-PATH-001': ['harness_boundary', 'harness_value_contract', 'harness_requirement_candidate', 'internal_dependency_boundary', 'product_exclusion_boundary'], 'OUTSIDE67-PATH-004': ['os_authority_boundary', 'os_project_control_scope', 'os_observation_candidate', 'release_deployment_boundary', 'derivation_boundary'], 'OUTSIDE67-PATH-007': ['web_os_runtime_boundary', 'connector_job_operation', 'web_observation_boundary', 'cross_product_nonduplication', 'acceptance_boundary'], 'OUTSIDE67-PATH-010': ['web_approval_boundary', 'web_user_value', 'connector_scope', 'deployment_gate', 'webos_ownership_boundary'], 'OUTSIDE67-PATH-060': ['register_observation_boundary', 'count_noncompletion_boundary', 'product_l1_register', 'ci_candidate_register', 'unresolved_source_boundary']}
...
SCOPE_CANONICAL={'base_origin_main': '95ba7e1813116632fd68ab3dcfc3b52ef18712b1', 'base_origin_main_expected_before_fetch': 'cbee6b056c5132e178392b0a9a4e7a5ebcb9085a', 'base_drift_observed': True, 'base_drift_from': 'cbee6b056c5132e178392b0a9a4e7a5ebcb9085a', 'base_drift_to': '95ba7e1813116632fd68ab3dcfc3b52ef18712b1', 'read_only': True, 'static_only': True, 'holding_registration_id': 'MPR-SH-OUTSIDE67-001', 'holding_path': 'docs/governance/legacy-migration/pre-isolation/pre-isolation-outside-holding-67-source-holding.jsonl', 'holding_path_revision_pair_denominator': 67, 'holding_record_count': 67, 'current_live_source_holding_count': 14, 'management_register_path': 'docs/governance/management-provisional-requirement-register.jsonl', 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066'], 'remaining_before_candidate_selection': 45, 'candidate_ids': ['OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060'], 'candidate_count': 5, 'remaining_after_candidate_selection': 40, 'unexplored_scope': 'all outside67 path_revision_pair not in the existing 22 or this five-source research set; candidate accounting remains scaffold evidence until any later holding admission', 'accounting_status': 'provisional_27_of_67_research_no_formal_holding_admission', 'pre_isolation_commit': '2d4991042be55268bac30a8bbcdac45b3865030a', 'archive_commit': '064280b5c1c5c98f949e6e3be5ef87cbe4a4b658', 'historical_capture_commit': '3df81ad27157c471e004083783f37a5860eaa2ee', 'source_unit': 'path_revision_pair', 'requirement_atoms_are_not_path_pairs': True, 'batch_width_observed': 5, 'origin_main_rebaseline_required_after_2016_merge': False, 'binding_reservation': 'SCF-B-0073', 'binding_registration_status': 'registered'}
...
SOURCE_HOLDING_CANONICAL={'registration_id': 'MPR-SH-OUTSIDE67-001', 'selected_item_ids': ['OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060'], 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066'], 'denominator': 67, 'candidate_count': 5, 'reviewed_count': 22, 'combined_reviewed_and_candidate_count': 27, 'remaining_after_research': 40, 'accounting_status': 'provisional_27_of_67_no_formal_holding_admission'}
SELECTION_KEYS={'candidate_ids','excluded_existing_ids','reason'}
SELECTION_CANONICAL={'candidate_ids':IDS,'excluded_existing_ids':EXISTING,'reason':'four-product L1 boundary diversity across HARNESS, HELIX-OS, HELIX-Web-OS, HELIX-Web, plus the cross-product upstream authority register; no exact source ID/path overlap with the existing twenty-two'}
...
EXPECTED_SOURCE_DIFF={'OUTSIDE67-PATH-001': 'same', 'OUTSIDE67-PATH-004': 'same', 'OUTSIDE67-PATH-007': 'same', 'OUTSIDE67-PATH-010': 'same', 'OUTSIDE67-PATH-060': 'different'}
...
def validate(root):
 root=Path(root).resolve(); out=root/'scaffold/rdp001-outside67-boundary-followup-073'; e=[]
 inv=load(out/'inventory.json',e,'E_INV')
 if not isinstance(inv,dict):return e
 fail(e,'E_ROOT_KEYS',set(inv)!=ROOT_KEYS)
 fail(e,'E_ID_SCHEMA',inv.get('schema')!='rdp001-outside67-followup/v1' or inv.get('candidate_id')!='RDP-001-OUTSIDE67-BOUNDARY-FOLLOWUP-001-004-007-010-060')
 ...
 fail(e,'E_WORKTREE',sc.get('worktree')!='/home/tenni/.helix-worktrees/outside67-boundary-073')
 fail(e,'E_SCOPE_REASON',sc.get('base_drift_reason')!='#2020 merged after the prior cbee6b0 baseline; rebaseline performed at latest origin/main 95ba7e1 before this bundle.')
 ...
 fail(e,'E_CANONICAL_TEXT',inv.get('prohibited_inference')!=['pre/archive/current hash or path observations are not semantic equivalence, authority, successor, implementation, degradation, failure, consumer closure, or decision','product-specific L1 document path is not current authority or implementation acceptance','authority register entries are not approval or completion evidence','old ledger exact hit zero is not proof of absence, completion, or approval','candidate line is not a fully decomposed requirement atom when multiple duties remain'])
 ...
 if isinstance(meta,dict):
  for k,v in {'schema':'rdp001-outside67-followup-meta/v1','bundle_id':'RDP-001-OUTSIDE67-BOUNDARY-FOLLOWUP-001-004-007-010-060','binding_reservation':'SCF-B-0073','binding_registration_status':'registered','base_origin_main':HEAD,'base_origin_main_previous':PREVIOUS_HEAD,'candidate_ids':IDS,'existing_reviewed_count':22,'candidate_count':5,'combined_count':27,'denominator':67,'remaining_after_research':40,'anchor_count':25,'static_only':True,'old_runtime_test_ci_execution':False,'authority_effect':'none'}.items():fail(e,f'E_META:{k}',meta.get(k)!=v)
...
def main():
 ...
 print('PASS outside67 follow-up validator: 5 source pairs / 25 exact anchors / provisional 27-of-67 static-only'); return 0
