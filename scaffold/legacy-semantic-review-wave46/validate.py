#!/usr/bin/env python3
"""Fail-closed static verifier for the Wave46 schema10 candidate."""
...
LEDGER = HERE / "legacy-requirement-direct-semantic-review-wave46.jsonl"
META = HERE / "legacy-requirement-direct-semantic-review-wave46.meta.json"
...
UNITS = [
    "IRUNIT-HIL-NFR-27-HELIX-HARNESS", "IRUNIT-HIL-NFR-27-HELIX-OS",
    "IRUNIT-HIL-NFR-28-HELIX-HARNESS", "IRUNIT-HIL-NFR-28-HELIX-OS",
    "IRUNIT-HIL-NFR-30-HELIX-HARNESS", "IRUNIT-HIL-NFR-30-HELIX-OS",
]

SELECTED = {
    "IRUNIT-HIL-NFR-27-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-A6F899B80CE9AEA61B82"},
    "IRUNIT-HIL-NFR-27-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-D11F51092619506417E4", "LEGACY-ASSET-93D79C2EF43DB865BF66"},
    "IRUNIT-HIL-NFR-28-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-E9CE4A7754A195D6186E"},
    "IRUNIT-HIL-NFR-28-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-664EDC7E6280C3DD1691"},
    "IRUNIT-HIL-NFR-30-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-5412A166E9D88C3C2436"},
    "IRUNIT-HIL-NFR-30-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9"},
}

QUERIES = {
    "IRUNIT-HIL-NFR-27-HELIX-HARNESS": {"anchors": ["translator", "ambiguity", "template", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-27-HELIX-OS": {"anchors": ["template", "active", "authority", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-28-HELIX-HARNESS": {"anchors": ["requirement", "coverage", "oracle", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-28-HELIX-OS": {"anchors": ["oracle", "receipt", "stale", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-30-HELIX-HARNESS": {"anchors": ["authoring", "authority", "scope", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-30-HELIX-OS": {"anchors": ["canonical", "automation", "authority", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
}
...
MISSING_ROLES = {
    ...
    "IRUNIT-HIL-NFR-28-HELIX-HARNESS": {"implementation_source"},
    "IRUNIT-HIL-NFR-28-HELIX-OS": {"implementation_source"},
    "IRUNIT-HIL-NFR-30-HELIX-HARNESS": {"implementation_source"},
    "IRUNIT-HIL-NFR-30-HELIX-OS": {"design", "implementation_source"},
}
...
def verify_role(row: dict) -> None:
    ...
    require(row["review_scope"].startswith("Wave46 schema10"), f"review scope {row['review_id']}")
    ...
    # Wave46 selected no cross-unit source or asset relation; any such relation is
...
def verify() -> None:
    ...
    # shared source needs an explicit typed relation and is absent in Wave46.
    source_keys = {}
    for row in rows:
        if row["role_kind"] != "requirement":
            continue
    ...
    print("Wave46 static schema10 verification: PASS (source chain, boundary, lineage and negative mutations)")
