...
MANUAL_REVIEWS = {
    "g1-trace": {"product": "HELIX-HARNESS", "start": 24, "end": 28, "l1": ("HELIX-HARNESS", 22, 24), "interpretation": "The source declares the required L3 plan set and checks business/screen/P0 trace closure, directly matching HARNESS V-model trace obligations.", "counter": (59, 61)},
    ...
    "plan-specific-vpair-binding": {"product": "HELIX-HARNESS", "start": 15, "end": 24, "l1": ("HELIX-HARNESS", 22, 24), "interpretation": "The source defines plan-specific V-pair binding authority and digests, directly governing HARNESS verification pairing.", "counter": (59, 61)},
