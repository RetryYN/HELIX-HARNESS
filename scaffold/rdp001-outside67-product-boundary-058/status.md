...
product unit 26件は固定keysetと4意味recordを持ち、inventoryのF/Q/P catalogは7／7／7件で固定しました。validatorは記録base `294bfd90bf58390798733a1437f1c91b8dc7fce8`からexact HEADへのancestorだけを確認し、live origin/mainの同値を要求しません。検証時live origin/mainは`562e176c36844474b63424ec06beefe2f7722d18`へ進んでいましたが、記録baseを再baselineせず静的再照合しました。今回検証幅は5 source／26 unitであり、安全なbatch拡大上限は断定しません。
