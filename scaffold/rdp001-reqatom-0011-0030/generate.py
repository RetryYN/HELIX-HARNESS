#!/usr/bin/env python3
"""REQATOM A1 0011--0030 の source-linked proposal generator。"""
...
ACTOR_OVERRIDES = {
    "REQSRC-LINE-00039": ["AI guard owner candidate", "AI execution agent"],
    "REQSRC-LINE-00044": ["AI implementation agent", "HELIX-OS control candidate"],
    "REQSRC-LINE-00048": ["HELIX operator", "state/drift consumer candidate"],
    "REQSRC-LINE-00076": ["PO/human residue", "AI agent roster", "worker", "verifier"],
    "REQSRC-LINE-00077": ["AI agent roster", "AI verifier"],
    "REQSRC-LINE-00078": ["PO/human residue", "AI agent"],
    "REQSRC-LINE-00079": ["human residue", "screen consumer"],
    "REQSRC-LINE-00080": ["human operator", "AI agent"],
    "REQSRC-LINE-00081": ["Claude Code/Codex", "HARNESS CLI consumer"],
    "REQSRC-LINE-00084": ["PO", "AI roster", "AI verifier"],
}
...
def candidate_atom(atom_id: str, line: dict, spec: dict) -> dict:
    ...
    inference = (
        ["current four-product boundary comparison is a routing candidate only; it is not source meaning."]
...
def main() -> int:
    ...
    print(f"generated REQATOM A1 0011--0030: units={len(proposals)} lines={inventory['input_line_count']} atoms={inventory['candidate_atom_count']} composite_unresolved={composite_unresolved_count}")
    return 0
