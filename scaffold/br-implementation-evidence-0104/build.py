#!/usr/bin/env python3
"""SCF-B-0104の静的evidence bundleを決定的に組み立てる。
...
def main() -> None:
    ...
    for source in crosswalk:
        ...
        evidence_rows.append({
            "schema": "br-implementation-evidence-0104/unit/v1",
    ...
    inventory = {
        "schema": "br-implementation-evidence-0104/v1",
        ...
        "scope": {
            "source_requirement_ids": [f"HIL-BR-{i:02d}" for i in range(6, 21)],
            "unit_ids": UNIT_IDS,
            "wave_range": "1-50",
        ...
        "bundle": {"evidence_path": "scaffold/br-implementation-evidence-0104/evidence.jsonl"},
        "unresolved": [
            "legacy_unit_implementation_unknown", "legacy_failure_observation_unknown",
            "legacy_degradation_unit_status_unknown", "consumer_closure_pending",
            "current_implementation_evidence_missing", "current_acceptance_evidence_missing",
