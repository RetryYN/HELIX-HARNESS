...
- selfcheck.py: blob、current span、edge set、unit別asset集合、inventory宣言、current／old status、旧実装edge別寄与、failure／degradation span・ledger、ledger／consumer、代表候補record、counter-evidence、unresolved、input digest、anchor policy／resolutionを壊す22負例と期待error codeを照合する。
