#!/usr/bin/env python3
"""Fail-closed static verifier for the Wave48 schema10 candidate."""
...
LEDGER = HERE / "legacy-requirement-direct-semantic-review-wave48.jsonl"
META = HERE / "legacy-requirement-direct-semantic-review-wave48.meta.json"
...
UNITS = [
    "IRUNIT-HIL-NFR-29-HELIX-HARNESS", "IRUNIT-HIL-NFR-29-HELIX-OS",
    "IRUNIT-HIL-NFR-32-HELIX-HARNESS", "IRUNIT-HIL-NFR-32-HELIX-OS",
    "IRUNIT-HIL-NFR-33-HELIX-HARNESS",
]

SELECTED = {
    "IRUNIT-HIL-NFR-29-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-5EBF86A0C7D3F666D94C"},
    "IRUNIT-HIL-NFR-29-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9"},
    "IRUNIT-HIL-NFR-32-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-2A8F5E02AEFFB6C8F1B0"},
    "IRUNIT-HIL-NFR-32-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9"},
    "IRUNIT-HIL-NFR-33-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-A440E0F5465A4EBF9855"},
}

QUERIES = {
    "IRUNIT-HIL-NFR-29-HELIX-HARNESS": {"anchors": ["pair", "edge", "obligation", "oracle"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-29-HELIX-OS": {"anchors": ["revision", "snapshot", "stale", "green"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-32-HELIX-HARNESS": {"anchors": ["authority", "impact", "pair", "rollback"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-32-HELIX-OS": {"anchors": ["impact", "rollback", "canonical", "stale"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-33-HELIX-HARNESS": {"anchors": ["obligation", "validation", "branch", "oracle"], "match_mode": "archive_file_contains_any_utf8_anchor"},
}
...
MISSING_ROLES = {
    "IRUNIT-HIL-NFR-29-HELIX-HARNESS": {"implementation_source"},
    "IRUNIT-HIL-NFR-29-HELIX-OS": {"design", "implementation_source"},
    "IRUNIT-HIL-NFR-32-HELIX-HARNESS": {"implementation_source"},
    "IRUNIT-HIL-NFR-32-HELIX-OS": {"design", "implementation_source"},
    "IRUNIT-HIL-NFR-33-HELIX-HARNESS": {"implementation_source"},
}
...
def verify_role(row: dict) -> None:
    ...
    require(row["review_scope"].startswith("Wave48 schema10"), f"review scope {row['review_id']}")
    ...
    # Wave48 selected no cross-unit source or asset relation; any such relation is
...
def verify() -> None:
    ...
    require([row["review_id"] for row in rows] == [f"LSRW48-EDGE-{i:03d}" for i in range(1, expected_current_edge_count + 1)], "review order")
    ...
    require(meta["source_main_base_revision"] == BASE and meta["wave47_exact_head"] == "d5dff5ef176e144c4a45b39a4e18a7e427c4ad17", "source base")
    ...
    # shared source needs an explicit typed relation and is absent in Wave48.
    source_keys = {}
    for row in rows:
        if row["role_kind"] != "requirement":
            continue
    ...
    print("Wave48 static schema10 verification: PASS (source chain, boundary, lineage and negative mutations)")
