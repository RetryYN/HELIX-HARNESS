...
must_fail("contradiction empty fields", lambda x:x["contradictions_preserved"][0].update(left="", right=""))
must_fail("unresolved empty text", lambda x:x["unresolved"].__setitem__(0, ""))
...
print("PASS PHCAP-17 selfcheck: 16 negative cases")
