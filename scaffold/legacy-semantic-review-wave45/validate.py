#!/usr/bin/env python3
"""Fail-closed static verifier for the Wave45 schema10 candidate."""
...
LEDGER = HERE / "legacy-requirement-direct-semantic-review-wave45.jsonl"
META = HERE / "legacy-requirement-direct-semantic-review-wave45.meta.json"
...
UNITS = [
    "IRUNIT-HIL-NFR-20-HELIX-HARNESS", "IRUNIT-HIL-NFR-22-HELIX-HARNESS",
    "IRUNIT-HIL-NFR-25-HELIX-HARNESS", "IRUNIT-HIL-NFR-31-HELIX-OS",
    "IRUNIT-HIL-NFR-39-HELIX-OS", "IRUNIT-HIL-TR-06-HELIX-HARNESS",
    "IRUNIT-HIL-TR-11-HELIX-HARNESS",
]

SELECTED = {
    "IRUNIT-HIL-NFR-20-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-C67D3019CB8F51EEF09F"},
    "IRUNIT-HIL-NFR-22-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-97638738D0C48E1FE897"},
    "IRUNIT-HIL-NFR-25-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-809B35B3C91567A97AF5"},
    "IRUNIT-HIL-NFR-31-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9"},
    "IRUNIT-HIL-NFR-39-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9"},
    "IRUNIT-HIL-TR-06-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-AA1944E57B2FEAE69873", "LEGACY-ASSET-8DDE1228F91519E011E8"},
    "IRUNIT-HIL-TR-11-HELIX-HARNESS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-9FD4DE252D3C27F88915", "LEGACY-ASSET-88F29580A6D436F27DC4"},
}

QUERIES = {
    "IRUNIT-HIL-NFR-20-HELIX-HARNESS": {"anchors": ["reverse", "artifact", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-22-HELIX-HARNESS": {"anchors": ["coverage", "receipt", "stale", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-25-HELIX-HARNESS": {"anchors": ["domain", "identity", "invariant", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-31-HELIX-OS": {"anchors": ["all-or-nothing", "fault injection", "partial", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-39-HELIX-OS": {"anchors": ["privacy", "security", "sandbox", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-TR-06-HELIX-HARNESS": {"anchors": ["dependency", "runtime", "offline", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-TR-11-HELIX-HARNESS": {"anchors": ["Bun", "Node", "distribution", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
}
...
MISSING_ROLES = {
    "IRUNIT-HIL-NFR-20-HELIX-HARNESS": {"implementation_source"},
    "IRUNIT-HIL-NFR-22-HELIX-HARNESS": {"implementation_source"},
    "IRUNIT-HIL-NFR-25-HELIX-HARNESS": {"implementation_source"},
    "IRUNIT-HIL-NFR-31-HELIX-OS": {"design", "implementation_source"},
    "IRUNIT-HIL-NFR-39-HELIX-OS": {"design", "implementation_source"},
    "IRUNIT-HIL-TR-06-HELIX-HARNESS": set(),
    "IRUNIT-HIL-TR-11-HELIX-HARNESS": set(),
}
...
def verify_role(row: dict) -> None:
    ...
    # Wave45 selected no cross-unit source or asset relation; any such relation is
...
def verify() -> None:
    ...
    # shared source needs an explicit typed relation and is absent in Wave45.
    source_keys = {}
    for row in rows:
        if row["role_kind"] != "requirement":
            continue
    ...
    print("Wave45 static schema10 verification: PASS (source chain, boundary, lineage and negative mutations)")
