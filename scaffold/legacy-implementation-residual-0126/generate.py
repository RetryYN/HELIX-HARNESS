...
def build() -> None:
    ...
    inventory = {
        ...
        "negative_cases": ["target_set_missing_or_duplicate", "source_blob_tamper", "source_line_anchor_tamper", "classification_category_tamper", "classification_product_tamper", "wave_edge_injection", "phase_status_tamper", "asset_ledger_tamper", "history_tamper", "boundary_blob_tamper", "authority_promotion", "input_digest_missing_or_duplicate", "inventory_scope_tamper", "fixed_base_pin_tamper", "output_digest_tamper"],
    }
