...
def main() -> int:
    ...
    expected_pr1949 = {"request_ids": ["PR-1949", "SCF-B-0015"], "integration_ref": "PR-1949", "candidate_ref": "9d12b1371282fe66237aa855fab5acf1576d6391", "status": "unmerged_candidate_selected_scope", "source_revision_item_ids": PR1949_IDS, "source_paths": [PR1949_PATHS[i] for i in PR1949_IDS], "file_count": 40, "hunk_count": 40}
    ...
    print("integrated prior=24 files / 91 hunks; PR1946 selected=20 files / 21 hunks; PR1949 unmerged candidate=40 files / 40 hunks; before current selected=84 files / 152 hunks")
