...
trial("overlap_tamper", inventory(lambda value: value["overlap_status"].__setitem__("all_zero", False)), "E_OVERLAP")
...
direct_trial("archive_manifest_mismatch", lambda: setattr(validator, "manifest_sha", lambda path: "sha256:" + "0" * 64), "E_ARCHIVE_STATIC")
