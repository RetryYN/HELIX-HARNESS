...
- `selfcheck.py`: PASS（28 negative cases、taxonomyの欠落／余分／status／authority boundary／required_ancestor到達性を含む期待error code照合）
- `py_compile`: PASS
