...
def main() -> None:
    ...
    boundary={"product_boundary":{**receipt(BOUNDARY,"## 対象別の正規入口"),"interpretation":"candidate boundary reference only; no permanent authority"},"l1":{product:{**receipt(path,L1_MARKERS[product]),"interpretation":"draft L1 candidate; awaiting parent approval"} for product,path in L1.items()}}
