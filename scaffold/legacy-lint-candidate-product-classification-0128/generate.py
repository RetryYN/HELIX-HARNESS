...
def main() -> None:
    ...
    for phase in targets:
        ...
        source_path=ARCHIVE_PREFIX+path; source=git_bytes(source_path); source_semantic=anchor(path,prof["marker"])
