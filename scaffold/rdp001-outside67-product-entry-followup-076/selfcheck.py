...
def main():
 cases=[]
 with tempfile.TemporaryDirectory(prefix='outside67-followup-074-selfcheck-') as td:
  ...
  case('duplicate_anchor',lambda c:mutatel(c/(REL+'product-units.jsonl'),1,lambda d:d['source_anchor']['pre_isolation'].__setitem__('line',3)),'E_DUP_ANCHOR')
