...
SOURCE_PATHS={'OUTSIDE67-PATH-003': 'docs/design/harness/README.md', 'OUTSIDE67-PATH-006': 'docs/design/helix-os/README.md', 'OUTSIDE67-PATH-009': 'docs/design/helix-web-os/README.md', 'OUTSIDE67-PATH-012': 'docs/design/helix-web/README.md', 'OUTSIDE67-PATH-014': 'docs/design/helix/L2-requirements/concept-v4-derived-requirements.md'}
COUNTERPARTS={'OUTSIDE67-PATH-003': 'docs/helix-harness/README.md', 'OUTSIDE67-PATH-006': 'docs/helix-os/README.md', 'OUTSIDE67-PATH-009': 'helix-web/docs/helix-web-os/README.md', 'OUTSIDE67-PATH-012': 'helix-web/docs/helix-web/README.md', 'OUTSIDE67-PATH-014': 'docs/governance/crosswalks/legacy-concept-derived-requirements.md'}
COUNTERPART_MATCH={sid:False for sid in IDS}
LINES={'OUTSIDE67-PATH-003': [(3, 3), (5, 5), (11, 11), (12, 12), (16, 16)], 'OUTSIDE67-PATH-006': [(3, 3), (5, 5), (9, 9), (18, 18), (23, 23)], 'OUTSIDE67-PATH-009': [(3, 3), (4, 4), (5, 5), (6, 6), (13, 13)], 'OUTSIDE67-PATH-012': [(3, 3), (5, 5), (9, 9), (12, 12), (17, 17)], 'OUTSIDE67-PATH-014': [(2, 2), (21, 21), (25, 25), (40, 40), (68, 68)]}
KINDS={'OUTSIDE67-PATH-003': ['harness_entry_boundary', 'harness_product_scope', 'harness_l1_entry', 'harness_l2_entry', 'harness_legacy_boundary'], 'OUTSIDE67-PATH-006': ['os_entry_boundary', 'os_control_scope', 'os_harness_dependency', 'os_l1_entry', 'os_state_boundary'], 'OUTSIDE67-PATH-009': ['webos_entry_boundary', 'webos_control_boundary', 'webos_runtime_boundary', 'webos_observation_contract', 'webos_cross_product_boundary'], 'OUTSIDE67-PATH-012': ['web_entry_boundary', 'web_product_scope', 'web_responsibility_table', 'web_l2_entry', 'web_vision_crosswalk'], 'OUTSIDE67-PATH-014': ['crosswalk_metadata_boundary', 'crosswalk_owner_boundary', 'crosswalk_migration_scope', 'crosswalk_split_table', 'crosswalk_product_boundary']}
PHASE_CANDIDATES={'OUTSIDE67-PATH-003': 'L1-L2-entry', 'OUTSIDE67-PATH-006': 'L1-L2-entry', 'OUTSIDE67-PATH-009': 'L1-L2-entry', 'OUTSIDE67-PATH-012': 'L1-L2-entry', 'OUTSIDE67-PATH-014': 'L2-crosswalk'}
...
SCOPE_CANONICAL={'base_origin_main': '6396443e150d285b0b08edd43ea52a26f85dd434', 'base_origin_main_expected_before_fetch': '74f724b4699feca7f9f2e87e939fe6578f75669e', 'base_drift_observed': True, 'base_drift_from': '74f724b4699feca7f9f2e87e939fe6578f75669e', 'base_drift_to': '6396443e150d285b0b08edd43ea52a26f85dd434', 'read_only': True, 'static_only': True, 'holding_registration_id': 'MPR-SH-OUTSIDE67-001', 'holding_path': 'docs/governance/legacy-migration/pre-isolation/pre-isolation-outside-holding-67-source-holding.jsonl', 'holding_path_revision_pair_denominator': 67, 'holding_record_count': 67, 'current_live_source_holding_count': 14, 'management_register_path': 'docs/governance/management-provisional-requirement-register.jsonl', 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066', 'OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060', 'OUTSIDE67-PATH-002', 'OUTSIDE67-PATH-005', 'OUTSIDE67-PATH-013', 'OUTSIDE67-PATH-031', 'OUTSIDE67-PATH-061'], 'remaining_before_candidate_selection': 35, 'candidate_ids': ['OUTSIDE67-PATH-003', 'OUTSIDE67-PATH-006', 'OUTSIDE67-PATH-009', 'OUTSIDE67-PATH-012', 'OUTSIDE67-PATH-014'], 'candidate_count': 5, 'remaining_after_candidate_selection': 30, 'unexplored_scope': 'all outside67 path_revision_pair not in the existing 32 or this five-source research set; candidate accounting remains scaffold evidence until any later holding admission', 'accounting_status': 'provisional_37_of_67_research_no_formal_holding_admission', 'pre_isolation_commit': '2d4991042be55268bac30a8bbcdac45b3865030a', 'archive_commit': '064280b5c1c5c98f949e6e3be5ef87cbe4a4b658', 'historical_capture_commit': '3df81ad27157c471e004083783f37a5860eaa2ee', 'source_unit': 'path_revision_pair', 'requirement_atoms_are_not_path_pairs': True, 'batch_width_observed': 5, 'origin_main_rebaseline_required_after_2016_merge': False, 'binding_reservation': 'SCF-B-0076', 'binding_registration_status': 'registered'}
...
SOURCE_HOLDING_CANONICAL={'registration_id': 'MPR-SH-OUTSIDE67-001', 'selected_item_ids': ['OUTSIDE67-PATH-003', 'OUTSIDE67-PATH-006', 'OUTSIDE67-PATH-009', 'OUTSIDE67-PATH-012', 'OUTSIDE67-PATH-014'], 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066', 'OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060', 'OUTSIDE67-PATH-002', 'OUTSIDE67-PATH-005', 'OUTSIDE67-PATH-013', 'OUTSIDE67-PATH-031', 'OUTSIDE67-PATH-061'], 'denominator': 67, 'candidate_count': 5, 'reviewed_count': 32, 'combined_reviewed_and_candidate_count': 37, 'remaining_after_research': 30, 'accounting_status': 'provisional_37_of_67_no_formal_holding_admission'}
SELECTION_KEYS={'candidate_ids','excluded_existing_ids','reason'}
SELECTION_CANONICAL={'candidate_ids': ['OUTSIDE67-PATH-003', 'OUTSIDE67-PATH-006', 'OUTSIDE67-PATH-009', 'OUTSIDE67-PATH-012', 'OUTSIDE67-PATH-014'], 'excluded_existing_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-057', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066', 'OUTSIDE67-PATH-001', 'OUTSIDE67-PATH-004', 'OUTSIDE67-PATH-007', 'OUTSIDE67-PATH-010', 'OUTSIDE67-PATH-060', 'OUTSIDE67-PATH-002', 'OUTSIDE67-PATH-005', 'OUTSIDE67-PATH-013', 'OUTSIDE67-PATH-031', 'OUTSIDE67-PATH-061'], 'reason': 'four-product entry diversity across HARNESS, HELIX-OS, HELIX-Web-OS, and HELIX-Web, plus shared Concept-derived L2 crosswalk; no exact source ID/path overlap with the existing thirty-two'}
...
UNIT_SELECTION_REASON='四製品の責務境界とL1/L2/L11 source chainに関係する旧入口・crosswalk lineを候補unitとして静的保持する。fragment外のactor/action/condition/guard/sequence、旧実装・劣化・failure・consumer・decisionのclosureを生成しない。'
EXPECTED_SOURCE_DIFF={'OUTSIDE67-PATH-003':'same','OUTSIDE67-PATH-006':'same','OUTSIDE67-PATH-009':'same','OUTSIDE67-PATH-012':'different','OUTSIDE67-PATH-014':'different'}
...
def validate(root):
 root=Path(root).resolve(); out=root/'scaffold/rdp001-outside67-product-entry-followup-076'; e=[]
 inv=load(out/'inventory.json',e,'E_INV')
 if not isinstance(inv,dict):return e
 fail(e,'E_ROOT_KEYS',set(inv)!=ROOT_KEYS)
 fail(e,'E_ID_SCHEMA',inv.get('schema')!='rdp001-outside67-followup/v1' or inv.get('candidate_id')!='RDP-001-OUTSIDE67-PRODUCT-ENTRY-FOLLOWUP-003-006-009-012-014')
 ...
 fail(e,'E_WORKTREE',sc.get('worktree')!='/home/tenni/.helix-worktrees/outside67-next-076')
 fail(e,'E_SCOPE_REASON',sc.get('base_drift_reason')!='initial requested exact base 74f724b4 was superseded by parent-directed rebaseline after origin/main advanced to 6396443e; fresh isolated worktree was reset to the latest origin/main.')
 ...
 if isinstance(meta,dict):
  for k,v in {'schema':'rdp001-outside67-followup-meta/v1','bundle_id':'RDP-001-OUTSIDE67-PRODUCT-ENTRY-FOLLOWUP-003-006-009-012-014','binding_reservation':'SCF-B-0076','binding_registration_status':'registered','base_origin_main':HEAD,'base_origin_main_previous':PREVIOUS_HEAD,'candidate_ids':IDS,'existing_reviewed_count':32,'candidate_count':5,'combined_count':37,'denominator':67,'remaining_after_research':30,'anchor_count':25,'static_only':True,'old_runtime_test_ci_execution':False,'authority_effect':'none'}.items():fail(e,f'E_META:{k}',meta.get(k)!=v)
...
def main():
 ...
 print('PASS outside67 follow-up validator: 5 source pairs / 25 exact anchors / provisional 37-of-67 static-only'); return 0
