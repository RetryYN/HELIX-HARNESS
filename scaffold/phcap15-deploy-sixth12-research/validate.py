#!/usr/bin/env python3
"""PHCAP-15 Deploy sixth12 research premise; static checks only."""
...
BASE_COMMIT = "4a2b46f38fb07d473f0799cb58fb1cf1d023b02f"
...
SELECTED_IDS = ['LEGACY-ASSET-6929C09B95A444D95B49',
 'LEGACY-ASSET-7A4ACACE4FCC342FEB03',
 'LEGACY-ASSET-35E8708A100679F1E4E6',
 'LEGACY-ASSET-98DD78AA6C120986F753',
 'LEGACY-ASSET-45EBBAE400D6A7382026',
 'LEGACY-ASSET-719F06F33C59C70EEE6A',
 'LEGACY-ASSET-41F36667354D71D9E014',
 'LEGACY-ASSET-8D8E740D55956A2A91E0',
 'LEGACY-ASSET-F3000D26921558AA2E0C',
 'LEGACY-ASSET-8B786D9FDDF61B2D569E',
 'LEGACY-ASSET-4A7A45BC495D1B2677A2',
 'LEGACY-ASSET-4357DACF4BA46C0B044F']
REVIEWED = {'pr_2001': {'asset_ids': ['LEGACY-ASSET-042D2B732DC68AA7EE9A',
 ...
 'pr_2004': {'asset_ids': ['LEGACY-ASSET-7D081AD1F95E968FA77C',
 ...
 'scf_b0037': {'asset_ids': ['LEGACY-ASSET-54330A68064B58B22259', 'LEGACY-ASSET-1251704E0BE627232E00', 'LEGACY-ASSET-189702B332643A3BFDAF'],
               'binding_path': 'scaffold/bindings/SCF-B-0037.json'},
 'third12': {'asset_ids': ['LEGACY-ASSET-A297D67A1D8AD6EE6D6B',
 ...
 'fifth12': {'binding_path': 'scaffold/bindings/SCF-B-0063.json',
             'asset_ids': ['LEGACY-ASSET-D5630716F221DA23DB09',
...
EXPECTED_KINDS = {'LEGACY-ASSET-6929C09B95A444D95B49': 'improvement backlog',
 'LEGACY-ASSET-7A4ACACE4FCC342FEB03': 'memory injection rollout plan',
 'LEGACY-ASSET-35E8708A100679F1E4E6': 'CI governance self-heal plan',
 'LEGACY-ASSET-98DD78AA6C120986F753': 'DevOS distribution runtime identity plan',
 'LEGACY-ASSET-45EBBAE400D6A7382026': 'identifier rename migration plan',
 'LEGACY-ASSET-719F06F33C59C70EEE6A': 'spawn bundle recovery plan',
 'LEGACY-ASSET-41F36667354D71D9E014': 'reverse process documentation plan',
 'LEGACY-ASSET-8D8E740D55956A2A91E0': 'current runtime guidance reverse plan',
 'LEGACY-ASSET-F3000D26921558AA2E0C': 'deployment checklist note',
 'LEGACY-ASSET-8B786D9FDDF61B2D569E': 'proposal coverage test design',
 'LEGACY-ASSET-4A7A45BC495D1B2677A2': 'requirement refinement source snapshot',
 'LEGACY-ASSET-4357DACF4BA46C0B044F': 'canonical reuse consumer baseline source'}
EXPECTED_ANCHOR_COUNTS = {'LEGACY-ASSET-6929C09B95A444D95B49': 2,
 'LEGACY-ASSET-7A4ACACE4FCC342FEB03': 2,
 'LEGACY-ASSET-35E8708A100679F1E4E6': 2,
 'LEGACY-ASSET-98DD78AA6C120986F753': 2,
 'LEGACY-ASSET-45EBBAE400D6A7382026': 2,
 'LEGACY-ASSET-719F06F33C59C70EEE6A': 2,
 'LEGACY-ASSET-41F36667354D71D9E014': 2,
 'LEGACY-ASSET-8D8E740D55956A2A91E0': 2,
 'LEGACY-ASSET-F3000D26921558AA2E0C': 2,
 'LEGACY-ASSET-8B786D9FDDF61B2D569E': 2,
 'LEGACY-ASSET-4A7A45BC495D1B2677A2': 2,
 'LEGACY-ASSET-4357DACF4BA46C0B044F': 2}
EXPECTED_ANCHOR_MEANINGS = {'LEGACY-ASSET-6929C09B95A444D95B49': ['backlog status pipeline records observation-to-verification states',
                                       'historical backlog entries can describe gaps without current implementation receipt'],
 'LEGACY-ASSET-7A4ACACE4FCC342FEB03': ['plan records staged memory recall injection surface and generated artifacts',
                                       'confirmed plan text does not prove current operation or deployment'],
 'LEGACY-ASSET-35E8708A100679F1E4E6': ['plan binds CI hard-gate self-heal to design and test oracles',
                                       'verification bindings in source are not current execution receipts'],
 'LEGACY-ASSET-98DD78AA6C120986F753': ['plan defines distribution runtime identity and consumer migration preconditions',
                                       'completion_claim_allowed false and no-mutation invariant preserve an unresolved transition'],
 'LEGACY-ASSET-45EBBAE400D6A7382026': ['draft plan records atomic rename blast radius and cutover trigger',
                                       'blocked_pending_cutover_approval and plan-only text do not establish applied rename'],
 'LEGACY-ASSET-719F06F33C59C70EEE6A': ['recovery plan specifies bundle equivalence contracts and failure conditions',
                                       'historical mutation-oracle text is source evidence, not a current test receipt'],
 'LEGACY-ASSET-41F36667354D71D9E014': ['reverse plan reconstructs process and routes gaps to forward work',
                                       'reverse/design source does not establish current deployment or consumer closure'],
 'LEGACY-ASSET-8D8E740D55956A2A91E0': ['reverse plan records Node/npm guidance normalization and consumer migration',
                                       'completion_claim_allowed false keeps runtime transition unclosed'],
 'LEGACY-ASSET-F3000D26921558AA2E0C': ['fixture note states a staging deployment schedule',
                                       'fixture note requires smoke and health conditions but supplies no receipt'],
 'LEGACY-ASSET-8B786D9FDDF61B2D569E': ['draft test design maps proposal coverage tiers to verification artifacts',
                                       'source explicitly requires runtime provenance for fired/works/shipped claims'],
 'LEGACY-ASSET-4A7A45BC495D1B2677A2': ['requirement IR records source and acceptance links with refinement contracts',
                                       'preserved source snapshot is non-executable and must not become current authority'],
 'LEGACY-ASSET-4357DACF4BA46C0B044F': ['source lists canonical reuse consumer pairs and migration inputs',
                                       'comments state blocked artifacts are migration outputs, not current input authority']}
EXPECTED_UNRESOLVED = ['semantic product split',
 'phase admission',
 'product owner',
 ...
 'consumer closure',
 'successor/decision']
EXPECTED_CONSUMERS = {'LEGACY-ASSET-6929C09B95A444D95B49': [],
 'LEGACY-ASSET-7A4ACACE4FCC342FEB03': [],
 'LEGACY-ASSET-35E8708A100679F1E4E6': [],
 'LEGACY-ASSET-98DD78AA6C120986F753': [],
 'LEGACY-ASSET-45EBBAE400D6A7382026': [],
 ...
 'LEGACY-ASSET-F3000D26921558AA2E0C': [],
 'LEGACY-ASSET-8B786D9FDDF61B2D569E': [],
 'LEGACY-ASSET-4A7A45BC495D1B2677A2': ['requirement-carry-forward-ledgers', 'requirement-atomization-review'],
 'LEGACY-ASSET-4357DACF4BA46C0B044F': []}
EXPECTED_DECISION_MATCHES = {'LEGACY-ASSET-6929C09B95A444D95B49': 0,
 'LEGACY-ASSET-7A4ACACE4FCC342FEB03': 0,
 'LEGACY-ASSET-35E8708A100679F1E4E6': 0,
 'LEGACY-ASSET-98DD78AA6C120986F753': 0,
 'LEGACY-ASSET-45EBBAE400D6A7382026': 0,
 'LEGACY-ASSET-719F06F33C59C70EEE6A': 0,
 'LEGACY-ASSET-41F36667354D71D9E014': 0,
 'LEGACY-ASSET-8D8E740D55956A2A91E0': 0,
 'LEGACY-ASSET-F3000D26921558AA2E0C': 0,
 'LEGACY-ASSET-8B786D9FDDF61B2D569E': 0,
 'LEGACY-ASSET-4A7A45BC495D1B2677A2': 2,
 'LEGACY-ASSET-4357DACF4BA46C0B044F': 0}
EXPECTED_COPY_READ_AFTER = {'LEGACY-ASSET-6929C09B95A444D95B49': 0,
 'LEGACY-ASSET-7A4ACACE4FCC342FEB03': 0,
 'LEGACY-ASSET-35E8708A100679F1E4E6': 0,
 'LEGACY-ASSET-98DD78AA6C120986F753': 0,
 'LEGACY-ASSET-45EBBAE400D6A7382026': 0,
 ...
 'LEGACY-ASSET-F3000D26921558AA2E0C': 0,
 'LEGACY-ASSET-8B786D9FDDF61B2D569E': 0,
 'LEGACY-ASSET-4A7A45BC495D1B2677A2': 1,
 'LEGACY-ASSET-4357DACF4BA46C0B044F': 0}
...
NEGATIVE_CASES = [
    ...
    "overlap with #2001/#2004/SCF-B-0037/third12/next12/fifth12",
...
def validate_keysets(data: dict[str, Any]) -> list[str]:
    expected = {
        ...
        "root.provenance.reviewed_sets.fifth12": {"binding_path", "asset_ids"},
        "root.denominator": {"pool_rows", "pool_unique_asset_ids", "pr_2001_selected_rows", "pr_2004_selected_rows", "scf_b0037_selected_rows", "third12_selected_rows", "next12_selected_rows", "fifth12_selected_rows", "already_reviewed_excluded_rows", "followup_selected_rows", "reviewed_or_selected_total", "remaining_unreviewed_rows", "pool_coverage_statement"},
        ...
        "root.scope.excluded_scopes.fifth12": {"binding_path", "asset_ids"},
        "root.scope.overlap_checks": {"selected_vs_pr_2001", "selected_vs_pr_2004", "selected_vs_scf_b0037", "selected_vs_third12", "selected_vs_next12", "selected_vs_fifth12", "pool_duplicate_ids"},
...
def validate(data: dict[str, Any], check_files: bool = True) -> list[str]:
    ...
    def req(condition: bool, code: str) -> None:
        if not condition:
            errors.append(code)
    req(data.get("schema") == "phcap15-deploy-sixth12-research/v1", "SCHEMA")
    ...
    req(base.get("worktree") == "/home/tenni/.helix-worktrees/phcap15-deploy-sixth-audit" and base.get("captured_at") == "2026-09-22", "WORKTREE_CAPTURE")
    task=data.get("task",{})
    ...
    req(prov.get("phase_pool_basis") == "candidate_phase_targets contains PHCAP-15" and prov.get("existing_binding") == "scaffold/bindings/SCF-B-0063.json", "PROVENANCE")
    ...
    req(scope.get("remaining_unreviewed_asset_ids") == remaining and len(remaining)==8, "REMAINING_SCOPE")
    req(scope.get("overlap_checks") == {"selected_vs_pr_2001":[],"selected_vs_pr_2004":[],"selected_vs_scf_b0037":[],"selected_vs_third12":[],"selected_vs_next12":[],"selected_vs_fifth12":[],"pool_duplicate_ids":[]}, "OVERLAP_CHECKS")
    denominator=data.get("denominator",{})
    expected_denominator={'pool_rows': 78, 'pool_unique_asset_ids': 78, 'pr_2001_selected_rows': 7, 'pr_2004_selected_rows': 12, 'scf_b0037_selected_rows': 3, 'third12_selected_rows': 12, 'next12_selected_rows': 12, 'fifth12_selected_rows': 12, 'already_reviewed_excluded_rows': 58, 'followup_selected_rows': 12, 'reviewed_or_selected_total': 70, 'remaining_unreviewed_rows': 8, 'pool_coverage_statement': 'PHCAP-15 pool 78件から既レビュー6束58件を除外した残分母20件から第六12件を選択。既レビュー6束と本束を合わせた70件をレビュー済み／選択済み範囲として固定し、残る8件は未レビュー分母として保持する。'}
    ...
    req(data.get("counts") == {'pool_rows': 78, 'selected_rows': 12, 'excluded_rows': 58, 'remaining_unreviewed_rows': 8, 'four_products': 4, 'selected_source_anchors': 24, 'selected_decision_matches': 2, 'selected_copy_read_after_matches': 1, 'selected_consumer_refs_nonempty': 1}, "COUNTS")
    return errors
...
if __name__ == "__main__":
    ...
    if problems:
        print("FAIL PHCAP15 sixth12")
        print("\n".join(problems))
        raise SystemExit(1)
    print("PASS PHCAP15 sixth12: pool=78 prior_reviewed=58 selected=12 remaining=8")
