...
EXPECTED_REF_SHAPES = {
    ...
    "CUR-WEB-L2": ("HELIX-Web", "L2_current_ref", "helix-web/docs/helix-web/L2-requirements/product-requirements.md", 1, 25),
    "CUR-WEBOS-L2": ("HELIX-Web-OS", "L2_current_ref", "helix-web/docs/helix-web-os/L2-requirements/service-governance-requirements.md", 1, 38),
    ...
    "CUR-WEB-L11": ("HELIX-Web", "L11_current_ref", "helix-web/docs/helix-web/L11-acceptance/product-acceptance.md", 1, 33),
    "CUR-WEBOS-L11": ("HELIX-Web-OS", "L11_current_ref", "helix-web/docs/helix-web-os/L11-acceptance/service-acceptance.md", 1, 26),
}
EXPECTED_GAPS = [
