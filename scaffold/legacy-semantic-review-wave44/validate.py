#!/usr/bin/env python3
"""Fail-closed static verifier for the Wave44 schema10 candidate."""
...
LEDGER = HERE / "legacy-requirement-direct-semantic-review-wave44.jsonl"
META = HERE / "legacy-requirement-direct-semantic-review-wave44.meta.json"
...
UNITS = [
    "IRUNIT-HIL-NFR-34-HELIX-OS", "IRUNIT-HIL-NFR-35-HELIX-OS", "IRUNIT-HIL-NFR-36-HELIX-OS",
    "IRUNIT-HIL-NFR-37-HELIX-OS", "IRUNIT-HIL-NFR-38-HELIX-OS", "IRUNIT-HIL-NFR-40-HELIX-OS",
    "IRUNIT-HIL-TR-02-HELIX-OS", "IRUNIT-HIL-TR-03-HELIX-OS", "IRUNIT-HIL-TR-09-HELIX-OS", "IRUNIT-HIL-TR-10-HELIX-OS",
]

SELECTED = {
    "IRUNIT-HIL-NFR-34-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-504B2BF06DD84DBD7D97", "LEGACY-ASSET-27C28531046E4B2CF535"},
    "IRUNIT-HIL-NFR-35-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-E357058A7A8CEE36DD94", "LEGACY-ASSET-51FFB9B717FAB30445BF"},
    "IRUNIT-HIL-NFR-36-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-C7C0A502D2DA1B30CE0A", "LEGACY-ASSET-7339DBE16914B6461DBC"},
    "IRUNIT-HIL-NFR-37-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-8D9CC020932FDCDB7ACA", "LEGACY-ASSET-977081C63ADB4B6DA66C"},
    "IRUNIT-HIL-NFR-38-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-A3A83F1432DF43D564F0", "LEGACY-ASSET-E2613D679D1889C98E6A"},
    "IRUNIT-HIL-NFR-40-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-3B97572C12E528ACA4D8", "LEGACY-ASSET-B60D38CF260DE6CDC35F"},
    "IRUNIT-HIL-TR-02-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-A4EAB5E3345E3C125C77", "LEGACY-ASSET-AABA69A4BF867F47579C"},
    "IRUNIT-HIL-TR-03-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-A8FC47B7735B51A186A3", "LEGACY-ASSET-BCBDD9458145232E78D5"},
    "IRUNIT-HIL-TR-09-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-43228B3381B7441D9DF5", "LEGACY-ASSET-B9F026AE27DC9D6CC18C"},
    "IRUNIT-HIL-TR-10-HELIX-OS": {"LEGACY-ASSET-A60CF91DD2AF6693E6F9", "LEGACY-ASSET-9F5B7A285FB301CD667C"},
}

QUERIES = {
    "IRUNIT-HIL-NFR-34-HELIX-OS": {"anchors": ["judgment", "stale", "fail-close", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-35-HELIX-OS": {"anchors": ["blind", "fixture", "retry", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-36-HELIX-OS": {"anchors": ["effort", "cost", "retry", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-37-HELIX-OS": {"anchors": ["secret", "allowlist", "PII", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-38-HELIX-OS": {"anchors": ["bypass", "allowlist", "deny", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-NFR-40-HELIX-OS": {"anchors": ["quota", "rate", "routing", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-TR-02-HELIX-OS": {"anchors": ["Python", "Node", "schema", "event", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-TR-03-HELIX-OS": {"anchors": ["Python", "digest", "provenance", "DB", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-TR-09-HELIX-OS": {"anchors": ["Python", "harness.db", "transactional", "snapshot", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
    "IRUNIT-HIL-TR-10-HELIX-OS": {"anchors": ["harness.db", "engine", "lifecycle", "source"], "match_mode": "archive_file_contains_any_utf8_anchor"},
}
...
def verify_role(row: dict) -> None:
    ...
    require(row["review_scope"].startswith("Wave44 schema10"), f"review scope {row['review_id']}")
    ...
    # Wave44 selected no cross-unit source or asset relation; any such relation is
...
def verify() -> None:
    ...
    require([row["review_id"] for row in rows] == [f"LSRW44-EDGE-{i:03d}" for i in range(1, expected_current_edge_count + 1)], "review order")
    ...
    require(meta["source_main_base_revision"] == BASE and meta["wave43_exact_head"] == "e6653813102951d11cd7f69eda3fa2ffad12cf3a", "source base")
    ...
    # shared source needs an explicit typed relation and is absent in Wave44.
    source_keys = {}
    for row in rows:
        if row["role_kind"] != "requirement":
            continue
    ...
    expected_missing = {("implementation_source", "IRUNIT-HIL-TR-10-HELIX-OS")}
    ...
    print("Wave44 static schema10 verification: PASS (source chain, boundary, lineage and negative mutations)")
