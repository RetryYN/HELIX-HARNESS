...
cases = [
    ...
    ("parent-base change", lambda x: x["scope"].update(parent_commit="4919cfd245ee128fee71c713c8d2d0a8cd5fcd11")),
    ...
    ("semantic inclusion resolution", lambda x: x["rows"][0].update(semantic_inclusion_status="semantically_excluded")),
