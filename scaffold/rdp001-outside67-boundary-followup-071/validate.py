...
IDS=['OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-057']
EXISTING=['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066']
PRE='2d4991042be55268bac30a8bbcdac45b3865030a'; ARCH='064280b5c1c5c98f949e6e3be5ef87cbe4a4b658'
HEAD='f07602eef199048ba27200f81b78e838926cae8b'; PREVIOUS_HEAD='98b5fb0f0743969835dcde7ebd00b476470a53a8'
...
SOURCE_PATHS={'OUTSIDE67-PATH-035': 'docs/governance/audits/l2-requirements/new-generation-authority-asset-governance-crosswalk.md', 'OUTSIDE67-PATH-037': 'docs/governance/audits/l2-requirements/new-generation-ci-ai-source-crosswalk.md', 'OUTSIDE67-PATH-047': 'docs/governance/audits/l2-requirements/new-generation-worker-capacity-source-crosswalk.md', 'OUTSIDE67-PATH-054': 'docs/governance/candidates/helix-os-organization-intake-2026-09-14.md', 'OUTSIDE67-PATH-057': 'docs/governance/intake/helix-os-foundation-directive-2026-09-14.md'}
COUNTERPARTS={'OUTSIDE67-PATH-035': 'docs/governance/audits/source-rebaseline/new-generation-authority-asset-governance-crosswalk.md', 'OUTSIDE67-PATH-037': 'docs/governance/audits/source-rebaseline/new-generation-ci-ai-source-crosswalk.md', 'OUTSIDE67-PATH-047': 'docs/governance/audits/source-rebaseline/new-generation-worker-capacity-source-crosswalk.md', 'OUTSIDE67-PATH-054': 'docs/governance/candidates/helix-os-organization-intake-2026-09-14.md', 'OUTSIDE67-PATH-057': 'docs/governance/intake/helix-os-foundation-directive-2026-09-14.md'}
COUNTERPART_MATCH={'OUTSIDE67-PATH-035': True, 'OUTSIDE67-PATH-037': True, 'OUTSIDE67-PATH-047': True, 'OUTSIDE67-PATH-054': True, 'OUTSIDE67-PATH-057': True}
LINES={'OUTSIDE67-PATH-035': [(18, 18), (20, 20), (21, 21), (36, 36), (63, 63)], 'OUTSIDE67-PATH-037': [(20, 20), (23, 23), (39, 39), (43, 43), (63, 63)], 'OUTSIDE67-PATH-047': [(15, 15), (18, 18), (21, 21), (22, 22), (23, 23)], 'OUTSIDE67-PATH-054': [(19, 19), (24, 24), (35, 35), (47, 47), (48, 48)], 'OUTSIDE67-PATH-057': [(5, 5), (11, 11), (24, 24), (25, 25), (27, 27)]}
KINDS={'OUTSIDE67-PATH-035': ['authority_projection', 'source_projection_consumer', 'authority_distinction', 'bidirectional_inventory', 'implementation_evidence_boundary'], 'OUTSIDE67-PATH-037': ['run_identity_boundary', 'terminal_state_boundary', 'responsibility_boundary', 'stop_on_observation_failure', 'acceptance_boundary'], 'OUTSIDE67-PATH-047': ['capacity_partition', 'backpressure_derivation', 'stale_evidence_boundary', 'capacity_rejection_boundary', 'capacity_observation'], 'OUTSIDE67-PATH-054': ['management_coordination_boundary', 'patchbot_authority_boundary', 'acceptance_replan_boundary', 'semantic_ci_contract', 'crawler_observation_boundary'], 'OUTSIDE67-PATH-057': ['intake_authority_boundary', 'management_acceptance_boundary', 'bounded_repair_boundary', 'crawler_observation_boundary', 'semantic_ci_obligation']}
...
SCOPE_CANONICAL={'base_origin_main': 'f07602eef199048ba27200f81b78e838926cae8b', 'base_origin_main_expected_before_fetch': '98b5fb0f0743969835dcde7ebd00b476470a53a8', 'base_drift_observed': True, 'base_drift_from': '98b5fb0f0743969835dcde7ebd00b476470a53a8', 'base_drift_to': 'f07602eef199048ba27200f81b78e838926cae8b', 'read_only': True, 'static_only': True, 'holding_registration_id': 'MPR-SH-OUTSIDE67-001', 'holding_path': 'docs/governance/legacy-migration/pre-isolation/pre-isolation-outside-holding-67-source-holding.jsonl', 'holding_path_revision_pair_denominator': 67, 'holding_record_count': 67, 'current_live_source_holding_count': 14, 'management_register_path': 'docs/governance/management-provisional-requirement-register.jsonl', 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066'], 'remaining_before_candidate_selection': 50, 'candidate_ids': ['OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-057'], 'candidate_count': 5, 'remaining_after_candidate_selection': 45, 'unexplored_scope': 'all outside67 path_revision_pair not in the existing 17 or this five-source research set; candidate accounting remains scaffold evidence until any later holding admission', 'accounting_status': 'provisional_22_of_67_research_no_formal_holding_admission', 'pre_isolation_commit': '2d4991042be55268bac30a8bbcdac45b3865030a', 'archive_commit': '064280b5c1c5c98f949e6e3be5ef87cbe4a4b658', 'historical_capture_commit': '3df81ad27157c471e004083783f37a5860eaa2ee', 'source_unit': 'path_revision_pair', 'requirement_atoms_are_not_path_pairs': True, 'batch_width_observed': 5, 'origin_main_rebaseline_required_after_2016_merge': False, 'binding_reservation': 'SCF-B-0071', 'binding_registration_status': 'registered'}
...
SOURCE_HOLDING_CANONICAL={'registration_id': 'MPR-SH-OUTSIDE67-001', 'selected_item_ids': ['OUTSIDE67-PATH-035', 'OUTSIDE67-PATH-037', 'OUTSIDE67-PATH-047', 'OUTSIDE67-PATH-054', 'OUTSIDE67-PATH-057'], 'existing_reviewed_ids': ['OUTSIDE67-PATH-008', 'OUTSIDE67-PATH-011', 'OUTSIDE67-PATH-030', 'OUTSIDE67-PATH-033', 'OUTSIDE67-PATH-034', 'OUTSIDE67-PATH-036', 'OUTSIDE67-PATH-043', 'OUTSIDE67-PATH-045', 'OUTSIDE67-PATH-046', 'OUTSIDE67-PATH-052', 'OUTSIDE67-PATH-055', 'OUTSIDE67-PATH-056', 'OUTSIDE67-PATH-059', 'OUTSIDE67-PATH-063', 'OUTSIDE67-PATH-064', 'OUTSIDE67-PATH-065', 'OUTSIDE67-PATH-066'], 'denominator': 67, 'candidate_count': 5, 'reviewed_count': 17, 'combined_reviewed_and_candidate_count': 22, 'remaining_after_research': 45, 'accounting_status': 'provisional_22_of_67_no_formal_holding_admission'}
SELECTION_KEYS={'candidate_ids','excluded_existing_ids','reason'}
SELECTION_CANONICAL={'candidate_ids':IDS,'excluded_existing_ids':EXISTING,'reason':'source-chain diversity across authority governance, CI source boundaries, worker capacity, organization intake, and foundation directive; no exact source ID/path overlap with the existing seventeen'}
...
UNIT_SELECTION_REASON='四製品境界に関係するsource lineを候補unitとして静的保持する。fragment外のactor/action/condition/guard/sequence、旧実装・劣化・failure・consumer・decisionのclosureを生成しない。'
EXPECTED_SOURCE_DIFF={'OUTSIDE67-PATH-035': 'same', 'OUTSIDE67-PATH-037': 'same', 'OUTSIDE67-PATH-047': 'same', 'OUTSIDE67-PATH-054': 'same', 'OUTSIDE67-PATH-057': 'same'}
...
def validate(root):
 root=Path(root).resolve(); out=root/'scaffold/rdp001-outside67-boundary-followup-071'; e=[]
 inv=load(out/'inventory.json',e,'E_INV')
 if not isinstance(inv,dict):return e
 fail(e,'E_ROOT_KEYS',set(inv)!=ROOT_KEYS)
 fail(e,'E_ID_SCHEMA',inv.get('schema')!='rdp001-outside67-followup/v1' or inv.get('candidate_id')!='RDP-001-OUTSIDE67-BOUNDARY-FOLLOWUP-035-037-047-054-057')
 ...
 fail(e,'E_WORKTREE',sc.get('worktree')!='/home/tenni/.helix-worktrees/outside67-next-071')
 fail(e,'E_SCOPE_REASON',sc.get('base_drift_reason')!='#2018 merged after the prior 98b5fb0 baseline; rebaseline performed at latest origin/main f07602e before this bundle.')
 ...
 for u in units:
  ...
  fail(e,f'E_UNIT_BOUNDARY:{uid}',sid not in IDS or u.get('source_path')!=SOURCE_PATHS.get(sid) or u.get('candidate_product')!='shared-cross-product' or u.get('phase_candidate')!='upstream-governance-or-crosswalk' or u.get('product_candidates')!=FOUR or u.get('source_support')!='exact_line_anchor_only' or u.get('inference_status')!='none')
 ...
 fail(e,'E_CANONICAL_TEXT',inv.get('prohibited_inference')!=['pre/archive/current hash equality is not semantic equivalence, authority, successor, implementation, degradation, failure, consumer closure, or decision','path relocation is not a product assignment or source adoption','explicit HELIX-OS or HARNESS references are not current ownership or phase admission','old ledger exact hit zero is not proof of absence, completion, or approval','candidate line is not a fully decomposed requirement atom when multiple duties remain'])
 ...
 if isinstance(meta,dict):
  for k,v in {'schema':'rdp001-outside67-followup-meta/v1','bundle_id':'RDP-001-OUTSIDE67-BOUNDARY-FOLLOWUP-035-037-047-054-057','binding_reservation':'SCF-B-0071','binding_registration_status':'registered','base_origin_main':HEAD,'base_origin_main_previous':PREVIOUS_HEAD,'candidate_ids':IDS,'existing_reviewed_count':17,'candidate_count':5,'combined_count':22,'denominator':67,'remaining_after_research':45,'anchor_count':25,'static_only':True,'old_runtime_test_ci_execution':False,'authority_effect':'none'}.items():fail(e,f'E_META:{k}',meta.get(k)!=v)
...
def main():
 ...
 print('PASS outside67 follow-up validator: 5 source pairs / 25 exact anchors / provisional 22-of-67 static-only'); return 0
