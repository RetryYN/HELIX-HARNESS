...
def holding_rows() -> dict[str, dict]:
    rows = [json.loads(line) for line in relocated(HOLDING).read_text(encoding="utf-8").splitlines() if line.strip()]
