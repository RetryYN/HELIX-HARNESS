...
expect_failure("historical reference digest tamper", lambda x: x["current_evidence"]["refs"][0].update(sha256="0" * 64), "E_HISTORICAL_REF_META_CUR-CONCEPT")
expect_failure("historical reference span tamper", lambda x: x["current_evidence"]["refs"][0].update(span_sha256="0" * 64), "E_HISTORICAL_REF_META_CUR-CONCEPT")
