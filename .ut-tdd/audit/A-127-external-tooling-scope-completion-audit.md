...
最新のユーザー correction を authoritative とする。必要な document conversion は generic review report export ではない。concept/planning、requirements、detailed design、PLAN、ADR、test-design などの canonical UT-TDD documents を、人間 review 用の spreadsheet / Excel / PPTX derived artifacts へ変換することである。
