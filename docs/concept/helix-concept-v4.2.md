---
document_id: HELIX-CONCEPT-V4.2
concept_version: "4.2-candidate"
...
source_concept_sha256: 181b0c555f4e27f83a1f92d315aee0e66a9f3f645e3cebe0a1b8d487878efaad
...
supersedes_after_approval: docs/concept/helix-concept-v4.1.md
canonical_promotion: pending
approval_scope: exact_body_revision_pending
approved_body_sha256: pending_human_decision
behavior_contract_id: HELIX-CONCEPT-V4.2
---

# HELIX Concept v4.2候補

承認済みv4.1の製品境界とsystem invariantを保持し、[承認済みの5大目標](../governance/decisions/helix-five-goals-approval-2026-09-24.md)を
製品責務へ降ろす改訂候補である。本revision自体と下流L1は未承認であり、現行authorityはv4.1のままとする。
...
| 目標 | HARNESSが定める契約 | HELIX-OSが担う運転 | 個別製品・運転基盤の境界 |
|---|---|---|---|
...
本候補への接続は、v4.2 Concept、七大原則、対象別L1のauthority昇格を成立させない。
...
| HELIX-HARNESS | 外部へ提供する製品 | V-model、L1–L12、正規pair、要求エンジン、Design Template、工程、要求・設計・検証契約、進行・完了条件、consumer package |
| HELIX-OS | HELIX内部の管理・統制機構 | authority、要求エンジン出力と企画との差、template版・適用・改善の登録・管理、Worker、assignment、state、log、CI、review、learning、improvement、distribution operation |
