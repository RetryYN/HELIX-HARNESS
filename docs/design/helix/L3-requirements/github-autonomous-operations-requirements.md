...
| GH-AC-014 | CIがgreenでも、別runtime/providerの文脈レビューがL0/L2/L3/L4、Issue/PLAN、diff、trace、consumer、security・blast radiusを読んだcurrent HEAD束縛receiptを持たなければmergeをblockする |
