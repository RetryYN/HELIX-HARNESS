...
source_upstream_repo: unison-ai-product/HELIX-HARNESS
source_upstream_commit: 7f83ca8
source_upstream_commit_full: 7f83ca811353ed90b3e981178a1b0c9977dd5863
source_upstream_artifact: .helix/audit/A-146-substance-gap-consolidated-remediation.md
---

# HELIX L3 要件補完 — upstream A-146 substance-gap 採用

先行 `unison-ai-product/HELIX-HARNESS` の `7f83ca8`
(`7f83ca811353ed90b3e981178a1b0c9977dd5863`) に含まれる
`.helix/audit/A-146-substance-gap-consolidated-remediation.md` を、HELIX 側へ採用するための
...
| HU-FR-02 | A146-2 | adapter hook / template が `helix` を呼ぶ場合、consumer install 後に PATH 上で解決できること、または wrapper / absolute resolver / preflight が解決不能を fail-close することを要求する | HU-AC-02a / HU-AC-02b |
...
| HU-AC-02a | consumer repo で hook が `helix` を呼ぶ | install preflight を実行 | PATH 解決可、wrapper 解決可、または fail-close のいずれかを evidence に残す |
