...
依存正本として推測せず、このblockを採用したIssueから段階的に強制する。
...
| GOP-AC-04a | GOP-FR-05a | open依存を残したclosed Issue、およびPLAN↔Issue参照不一致のfixtureがstable findingでfail-closeする | U-IHIER-002, U-IHIER-003 |
