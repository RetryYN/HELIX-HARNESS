...
7. requirementsのverification集合とtraceability edge集合を一致させ、orphan AC=0、dangling edge=0、ADR-010 edgeあり、canonical L1–L12とS0–S4のroute binding、層外L0 charter anchorありとする。
