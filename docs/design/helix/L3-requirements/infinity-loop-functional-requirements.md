...
| HR-FR-HIL-09 | HIL-BR-14, HIL-FR-15, HIL-FR-16, HIL-FR-21, HIL-FR-22, HIL-FR-37, HIL-TR-03, HIL-NFR-08, HIL-NFR-12, HIL-NFR-22 | ZIP、前身全ref、現行全treeをsnapshot化しatomic behaviorへ分解して採否→requirement→design→test→gateをjoinする | source/ref/entryとextractor versionあり → atom分母、disposition、trace、pending/orphan 0 | aggregate-only、未分類/重複、stale、prose-only、Python write / manifest、atom、decision、edge、stale receipt | HAC-HIL-09a, HAC-HIL-09b, HAC-HIL-09c |
...
| HR-FR-HIL-09 | HAC-HIL-09a: 全sourceからatomic分母とtrace生成 | HAC-HIL-09b: parent-only/child欠落/overlapでfreeze拒否 | HAC-HIL-09c: source/extractor変更で旧receipt stale |
