...
- input: development source HEAD、requirements digest、package version、include／exclude policy、consumer profile。
- output: immutable artifact、manifest、consumer smoke evidence、promotion／rollback plan、approval-bound remote action。
...
| requirement | system obligation | L10 oracle |
|---|---|---|
...
| `HR-AC-HYB-008-05` | clean Linux consumer full smoke | `ST-DIST-005` |
