...
| L1-L2 elicitation cycle | PO 対話 / PLAN-DISCOVERY-11 | S1 draft / active draft | 画面 mock で要求を洗い出す greenfield 前段サイクルは S1 設計中。S3/S4 へ進むまでは A-40 G1-trace 再検証フック、L1/L2 consistency lint、gap-check read-only 結線を current completion に混ぜない |
