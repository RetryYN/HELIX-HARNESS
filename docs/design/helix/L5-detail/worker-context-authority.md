...
```json
{
  ...
  "assets": [
    ...
    { "asset_id": "context-broker-consumer", "classification": "existing_runtime", "artifact_path": "src/runtime/worker-isolation-broker.ts", "resource_kind": "typescript_export", "resource_name": "prepareWorkerIsolationLaunch", "source_digest": "sha256:6824a33770f1a46ae92ab8debc13f92b0a6692f74468a2b441a2925e29122772", "current_authority": true }
  ],
