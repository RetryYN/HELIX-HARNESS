...
```json
{
  ...
  "assets": [
    ...
    { "asset_id": "context-broker-consumer", "classification": "existing_runtime", "artifact_path": "src/runtime/worker-isolation-broker.ts", "resource_kind": "typescript_export", "resource_name": "prepareWorkerIsolationLaunch", "source_digest": "sha256:e1bd923f50327c72026d44e089bab1e104bb2e2cdc8bd41a546ef2f22ebbd6c4", "current_authority": true }
  ],
