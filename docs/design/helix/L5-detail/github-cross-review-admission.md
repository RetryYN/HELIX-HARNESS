...
```json
{
  ...
  "assets": [
    ...
    { "asset_id": "github-reviewed-merge-receipt-persistence", "classification": "existing_runtime", "artifact_path": "src/runtime/github-cross-review-admission.ts", "resource_kind": "typescript_export", "resource_name": "persistReviewedMergeReadAfterReceipt", "source_digest": "sha256:a78207d9744400bf5945fb0a6ab601ee3c55f994deed3f02a4e23b53b54e93b4", "current_authority": true }
  ],
