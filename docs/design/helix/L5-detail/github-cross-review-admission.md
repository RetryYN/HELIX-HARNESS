...
```json
{
  ...
  "assets": [
    ...
    { "asset_id": "github-reviewed-merge-receipt-persistence", "classification": "existing_runtime", "artifact_path": "src/runtime/github-cross-review-admission.ts", "resource_kind": "typescript_export", "resource_name": "persistReviewedMergeReadAfterReceipt", "source_digest": "sha256:adba9906ba00ca7ecbfc196477603cdae8bbd429359005c43ae6f719fbf7c5c2", "current_authority": true }
  ],
