...
```json
{
  ...
  "assets": [
    ...
    { "asset_id": "github-reviewed-merge-receipt-persistence", "classification": "existing_runtime", "artifact_path": "src/runtime/github-cross-review-admission.ts", "resource_kind": "typescript_export", "resource_name": "persistReviewedMergeReadAfterReceipt", "source_digest": "sha256:8ec12679e3e921e3e2bc5ce33197c3a8471fd04b00ebf6083abd195d3129cf51", "current_authority": true }
  ],
