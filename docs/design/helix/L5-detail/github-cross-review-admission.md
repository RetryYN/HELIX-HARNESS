...
明示merge後はPR APIが返すmerge commitをread-afterし、reviewed candidate HEADがそのparentであり、candidate
commit treeとmerge commit treeが同一である場合だけmerge操作を成功扱いにする。状態またはcommit取得不能、別parent、
別treeはfail-closeし、`helix-reviewed-merge-read-after-receipt.v1` digestをmerge結果へ記録する。
...
```json
{
  ...
  "declared_failure_codes": ["pr_not_open", "current_head_review_receipt_missing", "review_receipt_invalid_or_stale", "review_receipt_conflict", "merge_not_observed", "merge_commit_mismatch", "reviewed_head_not_merge_parent", "reviewed_tree_not_merged_tree"],
  "assets": [
    { "asset_id": "github-cross-review-admission", "classification": "existing_runtime", "artifact_path": "src/runtime/github-cross-review-admission.ts", "resource_kind": "typescript_export", "resource_name": "evaluateGitHubCrossReviewAdmission", "source_digest": "sha256:04b066927520dff75e772a97886668b2ab13790b919a6ea15926402cfd084560", "current_authority": true },
