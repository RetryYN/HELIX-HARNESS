...
## §1 L5 contract matrix 対応表

| L3 ID | L5 contract | 必須 input | contract output | fail-close |
|-------|-------------|----------------|-----------------|------------|
...
`U-HLX-*` oracle を必要とし、§1 の anti-corruption boundary を維持しなければならない。
