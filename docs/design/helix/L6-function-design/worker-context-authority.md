...
```json
{
  ...
  "assets": [
    ...
    { "asset_id": "worker-context-broker", "classification": "existing_runtime", "artifact_path": "src/runtime/worker-isolation-broker.ts", "resource_kind": "typescript_export", "resource_name": "prepareWorkerIsolationLaunch", "source_digest": "sha256:64d898954a0200d686182b9c8903d658586911d5479df9b0fe59bc438d7556ee", "current_authority": true }
  ],
