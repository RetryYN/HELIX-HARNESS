...
| **canonical L4 基本設計 → L5 詳細設計 → L6 実装 → L7 TDD closure → L8 単体 → L9 結合 → L10 総合 → L11 受入 → release milestone → L12 運用テスト ＋ GitHub PR/CI/マージ/タグ** | **AI が完全自動**（人手介入なし。ただし不可逆操作のみ人へ escalate → §4 P8） |
