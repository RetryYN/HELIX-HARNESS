...
| `LayerAwareAuditPlanner` | Node | changed Lから上下影響、対応Vペア、必須検査を導出し、監査AI修正を別family HELIX subagentへクロスレビュー委譲 | audit plan/receipt eventのみ | L影響閉包欠落、自己承認、同family review、修正後HEAD drift |
