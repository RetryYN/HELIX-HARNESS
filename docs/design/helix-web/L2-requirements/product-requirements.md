...
|---|---|---|---|
| HELIXWEB-L2-001 | 初期Connector構想 | §6.1、U08／09 | 利用者がWebから自分の許可された開発環境を選び、対象プロジェクトの操作と進行を確認できる。全コード・計算資源をSaaSへ移すことを必須にしない |
...
後二者の詳細仕様・納品契約は原文§5・O10から別途具体化が必要であり、本書の8件で全Visionを網羅したとは扱わない。
