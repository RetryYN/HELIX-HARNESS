...
related_requirements: docs/governance/helix-agent-harness-requirements_v1.2.md
...
- `docs/governance/helix-agent-harness-concept_v3.1.md` (L0 構想、§2.3 V-model)
- 要件正本: `docs/governance/helix-agent-harness-requirements_v1.2.md` (§1.4 layers / §1.10.G.12 backlog→ledger / §2.2 gate)
