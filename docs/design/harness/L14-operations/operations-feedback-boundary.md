...
| status / objective progress | `./scripts/ut-tdd status` |
| completion decision | `./scripts/ut-tdd completion decision-packet --json` |
| handover outstanding | `.ut-tdd/handover/CURRENT.json` |
| rename cutover | `./scripts/ut-tdd rename plan --json` |
...
| `irreversible_migration_pending` | `.ut-tdd` 系 identifier rename cutover |
