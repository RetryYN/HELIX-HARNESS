...
### §1.3 HELIX pillar block overlay (PLAN-L4-51)
...
| version-up | partial | `version_target` / release trigger / parked activation evidence gap | activation packet + parked review + approval/snapshot binding + Forward/Add-feature route |
...
| FR-L1-36 / FR-L1-38 / FR-L1-43 | BR-21 / business-detail evaluation projections carried through workflow/evaluation blocks |
