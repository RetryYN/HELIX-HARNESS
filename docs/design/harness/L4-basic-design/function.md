...
|---|---|---|
| **HB-P0 forward-convergence** | C5 workflow / C11 Recovery / doctor | forward convergence、runaway guard、L1-L3-L4-L5-L6-L7 の reopen 判定を、mode routing と handover evidence で閉じる |
| **HB-P1 continuous-autonomy** | C5 workflow / C10 文脈注入 / setup | continuous-run、version-up、Scrum refinement、L2 skip template workflow、context injection budget、anchored handover を PLAN/gate surface に載せる |
