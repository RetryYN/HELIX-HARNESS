...
- L0 概念層 (§2.4 セキュリティ / §10 用語集 / §11 参考文献): `docs/governance/helix-agent-harness-concept_v3.1.md`
...
- ADR-001: `docs/adr/ADR-001-helix-harness-redesign-and-language.md`
