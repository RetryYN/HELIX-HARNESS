...
| **D-09** | handover 引継ぎ成功率 | next_action 実行成功件数 / handover 総件数 × 100 | ≥ 95 % | `.helix/handover/` / `helix handover log` |
...
| カテゴリ | 性質 | 主ペルソナ | データ源 |
|---------|------|----------|---------|
| **PM** (Project Management) | 動的 (案件遂行) | PO | `.helix/` runtime state (plan/gate/phase/handover/trace) |
