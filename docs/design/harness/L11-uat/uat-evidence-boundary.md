...
| completion packet 証跡 | `./scripts/ut-tdd completion decision-packet --json` |
| review bundle 証跡 | `./scripts/ut-tdd completion review-bundle --json` |
| handover outstanding 証跡 | `.ut-tdd/handover/CURRENT.json` |
