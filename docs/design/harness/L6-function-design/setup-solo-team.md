...
> `ut-tdd completion review-bundle --json` / `ut-tdd version-up dry-run --current v0.1.0 --target v0.1.3 --json` / `ut-tdd doctor --profile consumer` /
...
> `bun run ut-tdd completion decision-packet --json`、`bun run ut-tdd completion review-bundle --json`、`bun run ut-tdd version-up dry-run --current v0.1.0 --target v0.1.3 --json`、
...
> `ut-tdd status` / `ut-tdd completion decision-packet --json` / `ut-tdd completion review-bundle --json` / `ut-tdd version-up dry-run --current v0.1.0 --target v0.1.3 --json` /
