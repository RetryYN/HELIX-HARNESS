...
| `runProbe(intent: ProbeIntent, port: ProbePort) => ProbeReceipt` | typed intent + explicit argv port | bounded receipt | shell/cwd/envをintentから受け取らず、timeout/nonzeroをsuccess化しない | U-SBOUND-006 |
