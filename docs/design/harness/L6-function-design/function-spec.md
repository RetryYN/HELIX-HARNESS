...
| `loadL1L2GapCheckPacket` | loadL1L2GapCheckPacket(repoRoot?: string) => L1L2GapCheckPacket | repo root 配下の L1/L2 docs を読む。 | live repo の gap-check packet を生成する。 | loader は read-only。永続 state、handover、projection を書かない。 | U-L1L2-009 |
