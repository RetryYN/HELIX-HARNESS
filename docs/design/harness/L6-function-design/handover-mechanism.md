...
| ③ 次アクション (Next Action) | `workflowNextActionsForOutstanding` から PLAN ID / required action / route / packet commands / `packet要約` を seed。表示は既知 machine phrase を日本語へ変換 | PO/S4 などの実判断結果を補足 | md + doctor marker |
