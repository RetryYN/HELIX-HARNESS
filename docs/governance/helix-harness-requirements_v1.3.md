...
| `HR-FR-HYB-010` | GitHub自走要件`GH-FR-001..018`を正本とし、各FRをIssue/PR/CI/merge CLI、hook、DB table、acceptanceへtraceする | `HR-AC-HYB-010`: trace edge欠落、main直push、required check bypass、文脈レビューまたはDB追従receipt欠落、release境界越えを拒否する |
