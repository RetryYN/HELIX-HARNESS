...
| `HR-FR-HYB-010` | GitHub自走要件`GH-FR-001..017`、merge admission拡張`GH-FR-018..020`、CI性能・監査拡張`GH-NFR-009..012`を正本とし、Issue/PR/CI/merge CLI、hook、DB table、acceptanceへtraceする | `HR-AC-HYB-010`: trace edge欠落、main直push、required check bypass、L3ユーザー承認、文脈レビュー、DB追従、監査修正クロスレビュー、性能計測・Recovery receipt欠落、検査縮退、不完全なmain Recovery解除、release境界越えを拒否する |
