...
| Scrum Reverseを、どの方式に適用するか | 単体（HARNESSの工程規則） | 旧Scrum Reverseは、Production Scrumと旧ハイブリッドのsliceに適用していた（HARNESS L2の工程規則表）。スクラムには引き続き適用する | 新しいハイブリッドとリリースカンバンに適用するか。HARNESSの工程規則を詰めるときに決める |
