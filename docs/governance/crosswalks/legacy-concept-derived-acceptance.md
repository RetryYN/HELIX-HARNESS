...
created: 2026-09-14
updated: 2026-09-14
pair_artifact: docs/governance/crosswalks/legacy-concept-derived-requirements.md
---
...
対象別の受入先は[HARNESS L11](../../helix-harness/L11-acceptance/product-acceptance.md)と
[HELIX-OS L11](../../helix-os/L11-acceptance/governance-acceptance.md)。
[L2移管対応](legacy-concept-derived-requirements.md)に従って具体条件・反例を分離する。
...
HMC-BR-001..006の条件と反例は[HELIX-OS L11](../../helix-os/L11-acceptance/governance-acceptance.md)の
「memory責務変更の受入条件」へ移管した。移管先も未実行であり、文書移管を受入成功として数えない。

## 提供・再編要求の受入先

構成管理・配布運用の反例は[HELIX-OS L11](../../helix-os/L11-acceptance/governance-acceptance.md)、
外部提供物の成立条件は[HARNESS L11](../../helix-harness/L11-acceptance/product-acceptance.md)へ分離した。いずれも未実行。

## 要求形成・人間反応の受入先

判断記録・反復管理の反例は[HELIX-OS L11](../../helix-os/L11-acceptance/governance-acceptance.md)、
工程の合意・影響限定・検証条件は[HARNESS L11](../../helix-harness/L11-acceptance/product-acceptance.md)へ分離した。いずれも未実行。

## 監査・学習・成果の出所に関する受入先

AAFD4件・RCLS6件・PPS4件の反例は[HELIX-OS L11](../../helix-os/L11-acceptance/governance-acceptance.md)へ移管した。
