...
decision_table_sha256: f65dc8a20348c9a963f35ae7b3bf528dbc3b8ddae54a3ecc83e8ccb90960c751
...
# HELIX L1-L12 authoring authority receipt （日本語の契約見出し）
...
### §0.1 canonical decision artifact binding （日本語の契約見出し）

| artifact | SHA-256 |
|---|---|
| `vmodel-canonical-authority-cutover.md` | `6d2d7b37248c5da566d95c01ce84d68dc58ec69c332bc70c2a4e9a285d32a832` |
| `ADR-009-node-python-linux-runtime.md` | `b35b527b14b8152faefb6f22b47ba5c908b827a1fc9c8881ccafd55c35a0db0c` |
| `infinity-loop-platform-requirements.md` | `80ddea8a5ca10efcd8298bc70760d4e7f267f5bab9e686bbadbce88274ecba22` |
...
| §1 decision table（§1 headingから§1.1直前まで、UTF-8 raw bytes） | `f65dc8a20348c9a963f35ae7b3bf528dbc3b8ddae54a3ecc83e8ccb90960c751` |

上記artifactのいずれかが変われば本bindingをstaleとし、digest更新だけでapprovalを継承しない。

## §1 authority decision （日本語の契約見出し）
...
### §1.1 machine decision packet （日本語の契約見出し）

全chat決定とL0/L1/L3/L4の照合正本は
`docs/governance/generated/vmodel-authority-decision-packet-v1.json`（SHA-256
`7414dcea476d743bb3b966f81d5e2f4aea8911c05dca4b8829fceb28830f9931`）である。
...
Production Scrum/TDD order revision、decision table digest mismatch。 （日本語の機械契約記述）
...
## §3 VMAUTH activation event contract （日本語の契約見出し）
