...
# Universal Workflow Requirements source manifest
...
| source ID | entry | size | SHA-256 | class | disposition |
|---|---|---:|---|---|---|
| UWR-E-001 | `README.md` | 1799 | `d7d0c862c8442a1bc567656640dd272dd28e8315ec93339c82978718ba57aec4` | guide | pending:atomization |
| UWR-E-002 | `SKILL.md` | 4011 | `8404f7926814171ffbdaa30927cb5291c81a17e73a2a91beda5d3268eaf9cd75` | skill-policy | harden |
...
| UWR-E-005 | `catalogs/conditional-question-catalog.yaml` | 2372 | `568129425a016144d028bddda523a42030ed82860712bb7925419f5ae26b1cec` | question-catalog | pending:atomization |
| UWR-E-006 | `catalogs/base-question-catalog.md` | 1208 | `e3792cb1d62db0ea23097bced7e985351e2257a04ef7359b75284453c0f9375b` | question-catalog | pending:atomization |
| UWR-E-007 | `catalogs/runtime-orchestration-question-catalog.md` | 1633 | `c8176370f425b9409e5137c6fa88642cb719b008d34a308ceca309981fa3efc0` | question-catalog | harden |
...
| UWR-E-012 | `contracts/derived-mapping.md` | 1194 | `d2aa3864f6b4a632200f8dcce4b753de73b4a837f77f915018589445bf8f5894` | mapping | pending:atomization |
...
## §2 Hardening obligations

| finding ID | source | blocking defect | required disposition |
|---|---|---|---|
...
## §3 Provisional requirement authority groups

| aggregate group | entries | requirements | authority state |
|---|---|---|---|
| UWR-A-000 package custody | UWR-E-001..014 | HIL-FR-51 | provisional / atomic behavior pending |
| UWR-A-001 workflow-first modeling | UWR-E-003, UWR-E-014 | HIL-BR-26, HIL-FR-53, HIL-NFR-30 | sealed-source / hardening-pending |
| UWR-A-002 interview disposition | UWR-E-005, UWR-E-006, UWR-E-007 | HIL-BR-27, HIL-FR-52, HIL-NFR-32 | sealed-source / hardening-pending |
| UWR-A-003 completeness and derivation | UWR-E-003, UWR-E-004, UWR-E-010, UWR-E-012 | HIL-BR-28, HIL-FR-54, HIL-FR-55, HIL-NFR-31 | sealed-source / hardening-pending |
| UWR-A-004 runtime orchestration | UWR-E-007, UWR-E-009, UWR-E-013 | HIL-BR-29, HIL-FR-56, HIL-NFR-33 | sealed-source / hardening-pending |
| UWR-A-005 strict adapter authority | UWR-E-002, UWR-E-003, UWR-E-004, UWR-E-010, UWR-E-011, UWR-E-013, UWR-E-014 | HIL-TR-12, HIL-NFR-34 | provisional / HELIX-policy-required |

## §4 Closure

- archive identity: 1/1 observed、branch-local retrieval receipt 0/1
- entry inventory/digest: 14/14 observed、canonicalization receipt 0/1
- primary mechanical anchor: 328/328 inventory、exact disposition 0/328
...
- atomic entry disposition: 0/14、final behavior atom denominator unknown
- hardening findings: 0/6 resolved
- provisional aggregate groups: 6/6 registered
- provisional requirement edges: 16/16 registered、current authority 0/16
- active package: 0/1
