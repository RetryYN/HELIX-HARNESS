...
> **正本接続**: ゲート/駆動の関係は [gate-design.md](./gate-design.md) §1.1、recovery kind PLAN の必須構造は [requirements §5.1](./helix-agent-harness-requirements_v1.2.md)、メタモデルは concept §2.5。本 doc は Recovery の **step 手順**を定義する。
