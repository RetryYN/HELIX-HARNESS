...
| surface | atom | candidate disposition | terminal cutover blocker | （日本語の機械契約記述）
|---|---:|---|---|
...
| other surface | 180 | manual adjudication | yes | （日本語の機械契約記述）
...
### §3.1 candidate disposition edge （日本語の契約見出し）
...
- cutover normative contract 72、Bun negative fixture 10、manual semantic review 0。 （日本語の機械契約記述）
...
#### §3.1.1 adversarial review （日本語の契約見出し）
...
#### §3.1.2 non-PLAN historical command adjudication （日本語の契約見出し）
...
#### §3.1.3 corrected projection contract （日本語の契約見出し）
...
#### §3.1.4 PLAN historical command semantic adjudication （日本語の契約見出し）
...
## §4 OS portability surface （日本語の契約見出し）
