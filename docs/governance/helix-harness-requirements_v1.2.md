...
| **G4** 基本設計凍結 | L4 ① アーキ/ADR ⇔ system verification boundary (旧 L9-system shim は段階移行) | 片方欠落 → fail |
...
| 総合テスト (E2E) | qa / aim | system verification boundary | 旧 L9-system shim は段階移行し、L9 結合と混同しない |
