#!/usr/bin/env python3
"""Wave32 schema10 research-premise verifier.
...
LEDGER = ROOT / "docs/governance/legacy-requirement-direct-semantic-review-wave32.jsonl"
META = ROOT / "docs/governance/legacy-requirement-direct-semantic-review-wave32.meta.json"
...
PARENT = "e44a8f0cca1f1147e79753ec91cb404fe37cb772"
...
UNITS = ['IRUNIT-HIL-FR-30-HELIX-HARNESS', 'IRUNIT-HIL-FR-30-HELIX-OS', 'IRUNIT-HIL-FR-31-HELIX-HARNESS', 'IRUNIT-HIL-FR-31-HELIX-OS', 'IRUNIT-HIL-FR-34-HELIX-OS', 'IRUNIT-HIL-FR-35-HELIX-HARNESS', 'IRUNIT-HIL-FR-35-HELIX-OS', 'IRUNIT-HIL-FR-36-HELIX-OS']

SELECTED = {'IRUNIT-HIL-FR-30-HELIX-HARNESS': {'LEGACY-ASSET-A60CF91DD2AF6693E6F9', 'LEGACY-ASSET-0116DF099CCD34612738', 'LEGACY-ASSET-9C61492DBFD9ED23564C'}, 'IRUNIT-HIL-FR-30-HELIX-OS': {'LEGACY-ASSET-2224C11CCDA22CAAFF23', 'LEGACY-ASSET-A60CF91DD2AF6693E6F9', 'LEGACY-ASSET-B8E26435839A72B1A0D9'}, 'IRUNIT-HIL-FR-31-HELIX-HARNESS': {'LEGACY-ASSET-987EAA91F9655757E875', 'LEGACY-ASSET-873BE1F8C64356A2FA0F', 'LEGACY-ASSET-A60CF91DD2AF6693E6F9'}, 'IRUNIT-HIL-FR-31-HELIX-OS': {'LEGACY-ASSET-59D53F43643631D13E64', 'LEGACY-ASSET-1D6DB6DC80D2AC0703DF', 'LEGACY-ASSET-A60CF91DD2AF6693E6F9'}, 'IRUNIT-HIL-FR-34-HELIX-OS': {'LEGACY-ASSET-A43E4EED237DC0BB123A', 'LEGACY-ASSET-A60CF91DD2AF6693E6F9', 'LEGACY-ASSET-3EA58A84F0A944151B36'}, 'IRUNIT-HIL-FR-35-HELIX-HARNESS': {'LEGACY-ASSET-CFC6E5B9D9CC5CF38804', 'LEGACY-ASSET-A60CF91DD2AF6693E6F9', 'LEGACY-ASSET-E6B0919504EF52342FCB'}, 'IRUNIT-HIL-FR-35-HELIX-OS': {'LEGACY-ASSET-C6570CC25A043BB2B417', 'LEGACY-ASSET-A60CF91DD2AF6693E6F9', 'LEGACY-ASSET-9C5E1F6BB2F573DA524F'}, 'IRUNIT-HIL-FR-36-HELIX-OS': {'LEGACY-ASSET-A9F790CCC45B69B0D0F6', 'LEGACY-ASSET-A60CF91DD2AF6693E6F9', 'LEGACY-ASSET-D5CA34B460B6B01E0913'}}

REQ_DIGESTS = {
    "HIL-FR-30": "sha256:d4fa1ac2785a9989d6e783094a89324f908a0eb20ab53d3138f51677e4e2cd7c",
    "HIL-FR-31": "sha256:9982b94a7b289c1f852d5777f0cd06ee05058d272ef97d06bbc6c3acc720723d",
    "HIL-FR-34": "sha256:427b87551182dc6c28a31d4f9617b0625120b63e983b25663da667e3a404676a",
    "HIL-FR-35": "sha256:bafd3fc712208ecdea2816ae95128150f13f1b918197c309dcb3acae78b013cd",
    "HIL-FR-36": "sha256:5a16d19ff108c767c18eac0db68f6af2c3f5400cf751e8e5b9d920cb33a67435",
...
def verify_prior_lineage(meta: dict) -> None:
    require(len(meta["prior_review_batches"]) == 31, "prior batch count")
...
def verify() -> None:
    ...
    require([r["review_id"] for r in rows] == [f"LSRW32-EDGE-{i:03d}" for i in range(1, 25)], "review order")
    ...
    require(len(prior_units | set(UNITS)) == 111, "cumulative units")
    require(len(prior_edges | current_edges) == 330, "cumulative edges")
    require(meta["cumulative_reviewed_unit_count"] == 111 and meta["cumulative_reviewed_edge_count"] == 330 and meta["remaining_unit_count"] == 107, "cumulative receipt")
    ...
    outside = "LEGACY-ASSET-WAVE32-OUTSIDE-CANDIDATE"
    ...
    print("Wave32 static schema10 verification: PASS")
