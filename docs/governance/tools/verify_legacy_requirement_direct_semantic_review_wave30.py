#!/usr/bin/env python3
"""Wave30 schema10 research-premise verifier.
...
LEDGER = ROOT / "docs/governance/legacy-requirement-direct-semantic-review-wave30.jsonl"
META = ROOT / "docs/governance/legacy-requirement-direct-semantic-review-wave30.meta.json"
...
PARENT = "a75a36b548af46d916234d8d894f07840f76cfd0"
...
REQ_STATEMENT_DIGESTS = {
    "HIL-FR-21": "sha256:f25bd0492adc5256b7159de126ae2e70568b08d4bd420d640fa5bd804eddcb3c",
    "HIL-FR-22": "sha256:9d401a7bd016ded7263eeb3c0546e1bcd15a7fb8acca13fd78bfabd2a80021ac",
    "HIL-FR-23": "sha256:641f78a72962e9343b37991cb298f1e64e0630659c312dc62c5515db81f5f5eb",
}
...
def verify_prior_lineage(meta: dict) -> None:
    require(len(meta["prior_review_batches"]) == 29, "prior batch count")
...
def verify() -> None:
    ...
    require([r["review_id"] for r in rows] == [f"LSRW30-EDGE-{i:03d}" for i in range(1, 13)], "review order")
    ...
    require(len(prior_units | set(UNITS)) == 99, "cumulative units")
    require(len(prior_edges | current_edges) == 294, "cumulative edges")
    require(meta["cumulative_reviewed_unit_count"] == 99 and meta["cumulative_reviewed_edge_count"] == 294 and meta["remaining_unit_count"] == 119, "cumulative receipt")
    ...
    print("Wave30 static schema10 verification: PASS")
