#!/usr/bin/env python3
"""Wave29 schema10 research-premise verifier.
...
LEDGER = ROOT / "docs/governance/legacy-requirement-direct-semantic-review-wave29.jsonl"
META = ROOT / "docs/governance/legacy-requirement-direct-semantic-review-wave29.meta.json"
...
PARENT = "a05b9f5444ba11626823683cc486db95c9d1f3a3"
...
UNITS = ["IRUNIT-HIL-FR-18-HELIX-HARNESS", "IRUNIT-HIL-FR-18-HELIX-OS", "IRUNIT-HIL-FR-19-HELIX-HARNESS", "IRUNIT-HIL-FR-19-HELIX-OS", "IRUNIT-HIL-FR-20-HELIX-HARNESS", "IRUNIT-HIL-FR-20-HELIX-OS"]

SELECTED = {
    UNITS[0]: set(["LEGACY-ASSET-335176749F6322C3CD8D", "LEGACY-ASSET-59E0D99F388128AEE177", "LEGACY-ASSET-A60CF91DD2AF6693E6F9"]),
    UNITS[1]: set(["LEGACY-ASSET-335176749F6322C3CD8D", "LEGACY-ASSET-59E0D99F388128AEE177", "LEGACY-ASSET-A60CF91DD2AF6693E6F9"]),
    UNITS[2]: set(["LEGACY-ASSET-03B06987CECB57AC4AE2", "LEGACY-ASSET-F6E9EA3422A0EF1DF090", "LEGACY-ASSET-A60CF91DD2AF6693E6F9"]),
    UNITS[3]: set(["LEGACY-ASSET-03B06987CECB57AC4AE2", "LEGACY-ASSET-F6E9EA3422A0EF1DF090", "LEGACY-ASSET-A60CF91DD2AF6693E6F9"]),
    UNITS[4]: set(["LEGACY-ASSET-535EBA960C372C61F999", "LEGACY-ASSET-A85EC3703B6A61D3A7F1", "LEGACY-ASSET-A60CF91DD2AF6693E6F9"]),
...
def verify_prior_lineage(meta: dict) -> None:
    require(len(meta["prior_review_batches"]) == 28, "prior batch count")
...
def verify() -> None:
    ...
    require([r["review_id"] for r in rows] == [f"LSRW29-EDGE-{i:03d}" for i in range(1, 19)], "review order")
    ...
    require(len(prior_units | set(UNITS)) == 95, "cumulative units")
    require(len(prior_edges | current_edges) == 282, "cumulative edges")
    require(meta["cumulative_reviewed_unit_count"] == 95 and meta["cumulative_reviewed_edge_count"] == 282 and meta["remaining_unit_count"] == 123, "cumulative receipt")
    ...
    print("Wave29 static schema10 verification: PASS")
