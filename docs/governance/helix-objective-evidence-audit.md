...
|---|---|---|---|---|---|---|---|
| development_repo | `git ls-remote https://github.com/unison-ai-product/UT-TDD_AGENT-HARNESS.git refs/heads/main` | `refs/heads/main` | `7f83ca811353ed90b3e981178a1b0c9977dd5863` | main branch reachable（main branch 到達確認済み） | none（差分なし） | meaning-only adoption; no bulk import（意味のみ採用、一括 import なし） | none（影響なし） |
