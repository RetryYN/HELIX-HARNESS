...
### §1.0 Universal Workflow Requirements ZIP
...
- Python tool adoption ledger: `docs/governance/hybrid-python-engine-adoption-ledger.md`（29/29 inventory、active 0/29）
...
### §1.2 HELIX Hybrid Core Rebaseline v0.4.0 ZIP
...
- entry count: **184**、safety violation 0、JSON/YAML parse 77/77、SQLite create smoke 20 tables
