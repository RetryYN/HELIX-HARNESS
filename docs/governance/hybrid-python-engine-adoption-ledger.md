...
| tool | bytes | SHA-256（join key） | static surface | provisional runtime reuse disposition | （日本語の機械契約記述）
|---|---:|---|---|---|
| `activation.py` | 5238 | `4f3551d20de322f3eb33d434bd7a246091090b62fbfd074aa7cb1cf4a4f9b815` | filesystem、YAML、`build.py` import、CLI | reuse-with-adapter | （日本語の機械契約記述）
| `agent_docs.py` | 5682 | `502e9e294296515e9cd93beb3c43d7df832263fb773bc4ccccf3d38ab5f4f963` | file write | reuse-with-adapter | （日本語の機械契約記述）
| `agent_meta.py` | 6655 | `1e8c0cc9094a5eaa6cff3e269578445c7b37c479f554f674597bdf7f079da0ad` | file write、CLI | reuse-with-adapter | （日本語の機械契約記述）
| `assign.py` | 15738 | `7f1d282479ecead55c0f46913930492ea926fba7acc2a3ff358fd99b60fa731b` | file write、CLI | reuse-with-adapter | （日本語の機械契約記述）
| `build.py` | 43897 | `80bb586b05d85f04761270ed4a6668a7da316ba9511d46ac053f59ad1ab58c9c` | file write、subprocess、CLI | reuse-with-adapter | （日本語の機械契約記述）
...
| `derive_traces.py` | 13745 | `4604d0f0a0036323bd8290e902f02b065571cce97b88f13482f55fae7a1341dc` | file write、CLI | reuse-with-adapter | （日本語の機械契約記述）
| `diagram_dsl.py` | 11141 | `f58d114e3fd1140d34a24dd745e78fd1b18d85cd649c248f9368c93ab82a2834` | file write/render | reuse-with-adapter | （日本語の機械契約記述）
| `diff_report.py` | 8381 | `8053167575ef261be528e4070d52990d5f15fbe30b0d411769d1993a981f2820` | file write、subprocess、CLI | reuse-with-adapter | （日本語の機械契約記述）
...
| `fix_names.py` | 2528 | `12cfb88c84140d4172784c20553ba5f300564748b080ed24b146ae9eacaa731b` | filesystem rename、CLI | reuse-with-adapter | （日本語の機械契約記述）
...
| `impact.py` | 7266 | `76dc282fbcbb454f6a535fd91c07b83aa1ceacd503a775cc561d493d726e8203` | read/analysis、CLI | reuse-as-is-candidate | （日本語の機械契約記述）
| `md_export.py` | 3773 | `5b18a47d5fdcac8165454d82b603a6ec4c0f09f03508ddabdcb5a6fd52020fec` | file write | reuse-with-adapter | （日本語の機械契約記述）
| `package.py` | 1619 | `e810ef575cdef648058d3c01062fd7466b8a75d8c450a74a96cc51892c1f6fd6` | ZIP/file write、CLI | reuse-with-adapter | （日本語の機械契約記述）
...
| `schedule.py` | 24232 | `6dc3b51ddab01d93c9e1b8a3ebc5faea725a95698d049245bf1410ee06730c8c` | file write、CLI | reuse-with-adapter | （日本語の機械契約記述）
| `schema_check.py` | 3064 | `b8c6a5aa5740999f545a4d34ce17238af632b2d05bb7504e7741f7b4aa35d4b2` | CLI | reuse-as-is-candidate |
| `scope.py` | 8277 | `3311ca1f2f881afae6a6369bd826bdcebc5babcd19de4165d52739083c5d97c3` | file write、CLI | reuse-with-adapter | （日本語の機械契約記述）
| `selftest.py` | 7723 | `7cd8629a873c6fe61c53066c6d095920159b4f45fbd2fa5e2e08659b9c24ab27` | file write | reuse-with-adapter | （日本語の機械契約記述）
| `spec_check.py` | 14390 | `6d11080883b27803a4a5c2ebbfdd8b62e8cbcd77cd31a01b1b48c4e58e6e9ebe` | file write、CLI | reuse-with-adapter | （日本語の機械契約記述）
...
| `util.py` | 2056 | `5c5c74450213ac97cc04114c3343502523a65c836124ff9daee42a3a9f932a59` | subprocess | reuse-with-adapter | （日本語の機械契約記述）
...
|---|---:|---|
| Python tool inventory | 29/29 | PASS | （日本語の機械契約記述）
...
| provisional reuse-with-adapter | 18/29 | adapter/fixture pending | （日本語の機械契約記述）
