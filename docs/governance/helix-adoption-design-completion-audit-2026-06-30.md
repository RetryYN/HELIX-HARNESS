...
| G-IMPLEMENTATION-CLAIM | partial | L7.5 RUN & Debug, adapter/config/template changes, upstream A-146 pure decision contracts, and old HELIX pure decision contracts have implementation. Public distribution/runtime wiring and full legacy runtime/CLI parity are not fully implemented. |
