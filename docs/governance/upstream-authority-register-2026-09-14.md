...
| HELIX原理原則候補 | 1文書、12原則 | [原理原則候補](../concept/helix-principles.md)、[人間判断packet](audits/source-rebaseline/helix-principles-human-decision-packet.md) | Concept・製品責務境界・上流統制・authority状態から抽出した`draft_candidate`。exact SHAへの人間decision待ち、authority effectなし | 親sourceとの無矛盾をreviewし、人間承認後に対象別L1以下の共通判断基準として使う。個別要求の採否は別decisionにする |
