...
| 旧要求文書の現行保持 | 22文書 | [保持領域](requirements-source/README.md)、[文書台帳](legacy-requirement-document-carry-forward.jsonl) | 旧HARNESS要求5、旧画面要求7、旧HELIX要求9、画面境界1を元authority状態のまま同一byteで現行保持 | 原要求ID単位で対象・successor・未被覆atomを追加し、意味変更・retireは人間判断に限定する |
