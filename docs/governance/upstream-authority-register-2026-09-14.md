...
Conceptと5大目標の行は2026-09-24の人間判断に合わせて更新した。他の行の観測時点は個別の記録を優先する。
...
|---|---:|---|---|---|
| 最新責務境界 | 1 | [HARNESS・HELIX-OS・個別製品の責務記録](../concept/product-boundary.md)、[承認decision record](decisions/concept-v4.1-and-four-l1-approval-2026-09-17.md) | 旧本文SHA `097f27311060c56e387cf49fe6ec75731e5fd9dc04ac1a4be987d285e02ee038`のみ承認済み。現行本文のOS／LABO／Intelligence責務とPO条件は未承認候補 | [PO判断パッケージ](crosswalks/concept-requirement-po-decision-packet.md)で旧revisionとの差分を判断する。現行Conceptを親境界とし、旧承認を現行L2/L11へ継承しない |
...
| 対象別L1 | 4文書、32企画要求 | HARNESS／HELIX-OS／HELIX-Web／HELIX-Web-OSの各`L1-planning/`、[承認decision record](decisions/concept-v4.1-and-four-l1-approval-2026-09-17.md) | HARNESS 9、HELIX-OS 12、HELIX-Web 6、HELIX-Web-OS 5の**旧exact revision**のみ承認済み。現行本文はConcept親への付替えと意味差分を含む未承認候補 | 旧承認revisionの責務境界を履歴根拠として保持し、現行差分は[PO判断パッケージ](crosswalks/concept-requirement-po-decision-packet.md)へ送る。現行本文をL2／L11の承認済み親にしない |
