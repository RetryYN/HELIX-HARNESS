...
| 新世代Concept | 現行v4.1、本文承認済みv4.2 | [現行Concept v4.1](../concept/helix-concept-v4.1.md)、[v4.1承認decision](decisions/concept-v4.1-and-four-l1-approval-2026-09-17.md)。[v4.2本文](../concept/helix-concept-v4.2.md)と[承認decision](decisions/concept-v4.2-goal-owners-approval-2026-09-24.md)は適用待ち | v4.2本文SHA-256 `b395a54c42782d93651f2a5660736b0330f013ccfd10af925c61c53ec355eebf`をPO承認。v4.1を現行のまま維持し、L1影響・参照更新・read-after後に別の適用記録で切り替える。4対象L1の親はv4.1のまま、七大原則は候補のまま | 4目標の不足を対象別L1改訂候補へ分解し、L2／L11 draftの親revision影響を確認する |
...
| 最新Concept | HARNESS自己改善を含む最新責務、新世代境界、authority、上流順序、5大目標、七大原則、Version 1の複数プロダクト・自己適用検証とWeb展開依存が一つのrevisionへ束縛される | 現行[Concept v4.1](../concept/helix-concept-v4.1.md)。最新の本文承認は[Concept v4.2](../concept/helix-concept-v4.2.md)（SHA-256 `b395a54c42782d93651f2a5660736b0330f013ccfd10af925c61c53ec355eebf`）と[承認decision record](decisions/concept-v4.2-goal-owners-approval-2026-09-24.md) | v4.2のexact本文をPO承認、現行適用は未実施。5大目標も別recordで承認済み。七大原則は候補のまま。対象別L1の親revisionはv4.1で、4領域の被覆は`partial`のまま | 4目標の不足だけL1改訂候補へ降ろし、各本文を別の人間判断へ戻す |
