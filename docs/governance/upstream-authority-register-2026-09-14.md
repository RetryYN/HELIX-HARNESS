...
| 要求整理Issue projection | open 3件（#1813..#1815） | [投影記録](audits/source-rebaseline/github-requirement-review-program-projection-2026-09-15.md) | RDP-001の要否・再配置、RDP-002の責務・機能重複、RDP-003の技術代替可能性をlocal sourceから投影しread-after済み。#1813は2026-09-19にmain `3469266e`のRDP-001へ再投影した（`RDPPROJ-1813-20260919-005`）。この再投影は操作authorityが未成立であり、追認かrollbackかが人間判断待ちである | 親子Issueを進行共有だけに使い、closeやcheckboxから個別要求の採否・統合・技術選定を生成しない |
