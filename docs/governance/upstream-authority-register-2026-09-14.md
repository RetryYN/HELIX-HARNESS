...
| HELIX自体の5大目標 | 1文書、5目標 | [5大目標本文](../concept/helix-five-goals.md)、[承認decision record](decisions/helix-five-goals-approval-2026-09-24.md) | 本文SHA-256 `cfade733b9023bcc3329916206a911794e13f2b4f4f1e198d6c57618049771ca`をHELIX全体の到達目標として承認済み。対象別L1・個別要求・実装・達成は未承認 | v4.2 Conceptの責務境界から対象別L1へ分解する |
...
| 対象別L1 | 4文書、32企画要求 | HARNESS／HELIX-OS／HELIX-Web／HELIX-Web-OSの各`L1-planning/`、[承認decision record](decisions/concept-v4.1-and-four-l1-approval-2026-09-17.md) | HARNESS 9、HELIX-OS 12、HELIX-Web 6、HELIX-Web-OS 5のexact revisionを個別Decision IDで承認済み | 4対象の責務境界を第1層product routingへ使い、L2／L11を一要求identityずつ採否する |
