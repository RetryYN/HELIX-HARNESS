...
| 新世代Concept | 1文書（その場改訂、現行v4.3） | [HELIX Concept](../concept/helix-concept.md)。履歴として[v4.1](../concept/helix-concept-v4.1.md)（[承認decision](decisions/concept-v4.1-and-four-l1-approval-2026-09-17.md)）、[v4.2](../concept/helix-concept-v4.2.md)（[承認decision](decisions/concept-v4.2-goal-owners-approval-2026-09-24.md)）を凍結 | 1ファイルをその場で改訂する。人の指示をAIが反映し、改訂履歴へ記録する。版ごとのファイルと改訂ごとの承認記録は置かない | v4.3改訂に紐づく4対象L1、5大目標、七大原則、製品責務境界の親付替えと内容差分を見直す |
