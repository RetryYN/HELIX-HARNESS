...
| 新世代Concept | 1文書（その場改訂） | [HELIX Concept](../concept/helix-concept.md)。旧来の[v4.1](../concept/helix-concept-v4.1.md)（[承認decision](decisions/concept-v4.1-and-four-l1-approval-2026-09-17.md)）、[v4.2](../concept/helix-concept-v4.2.md)（[承認decision](decisions/concept-v4.2-goal-owners-approval-2026-09-24.md)）は、下位文書の親付替えと同時に削除する | 1ファイルをその場で改訂する。人の指示をAIが反映し、変更の履歴はgitに残す。版ごとのファイルと改訂ごとの承認記録は置かない | v4.3改訂に紐づく4対象L1、5大目標、七大原則、製品責務境界の親付替えと内容差分を見直し、同時にv4.1／v4.2のファイルを削除する |
...
| 最新Concept | HARNESS自己改善を含む最新責務、新世代境界、authority、上流順序、5大目標、七大原則、Version 1の複数プロダクト・自己適用検証とWeb展開依存が一つのrevisionへ束縛される | 現行は[HELIX Concept](../concept/helix-concept.md)（1ファイルをその場で改訂）。4対象L1、5大目標、七大原則、製品責務境界は、まだ旧来の[v4.1](../concept/helix-concept-v4.1.md)を親として記載している（L1の承認は[2026-09-17 decision record](decisions/concept-v4.1-and-four-l1-approval-2026-09-17.md)、v4.2本文の承認は[2026-09-24 decision record](decisions/concept-v4.2-goal-owners-approval-2026-09-24.md)） | 現行Conceptは機構再編後の本文。下位文書は未追従 | 下位文書の親をHELIX Conceptへ付け替えて内容差分を反映し、同時にv4.1／v4.2のファイルを削除する |
