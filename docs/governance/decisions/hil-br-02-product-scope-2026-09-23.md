...
| [製品責務境界の判断時revision](https://github.com/RetryYN/HELIX-HARNESS/blob/11a22679dc2bfce57d3294759531282445625001/docs/concept/product-boundary.md) | `097f27311060c56e387cf49fe6ec75731e5fd9dc04ac1a4be987d285e02ee038` | OSは実行・管理・統制、HARNESSは工程・契約。現行本文の承認には流用しない |
