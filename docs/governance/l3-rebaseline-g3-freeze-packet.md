...
- design catalog digest候補: `sha256:b48f3d38793f5bd7fdf8c5ad9245746e8884373cf9469b93b0896483a5e37a71`
- この候補は、current-mainで更新されたcatalog bytesから再計測した値であり、旧 `a006…` の履歴値をcurrent証拠へ再利用しない。
