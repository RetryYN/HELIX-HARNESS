...
> **ADR-001 boundary**: implementation は HELIX-owned TypeScript/Bun とする。Migration docs と source snapshots は porting audit と regression idea のための reference-only material であり、現行正本でも execution route でもない。
