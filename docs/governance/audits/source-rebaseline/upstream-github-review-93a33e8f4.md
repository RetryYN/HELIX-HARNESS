...
| ID | severity | 所見 | 処置 |
|---|---|---|---|
| M12 | major | Issue closeでProject #1の166 itemが組込みautomationにより`Done`へ変更された作用が未記録 | actor、件数、時刻帯、変更前Status不明、reopen非復元、非完了証拠をIssue退役記録へ追加。Project全210 itemを明細化してProjectをclose |
