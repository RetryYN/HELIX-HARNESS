# 旧要件v1.3 sourceの対象別責務対応

確認日: 2026-09-14

`archive/legacy-generation-2026-09-14/root/docs/governance/helix-harness-requirements_v1.3.md`は旧世代でCore Readだったhistorical sourceであり、HARNESSが提供する工程規則と、
...
v1.3本文は本表の追加だけで対象別に分割済みとは扱わない。新世代への個別採否では次を同じ意味単位で行う。
