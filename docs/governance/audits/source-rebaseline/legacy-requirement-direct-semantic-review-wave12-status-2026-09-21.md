...
- batch edges: confirmed 4 / rejected 3 / unresolved 2
...
| unit | atoms | contract | design partial | design rejected assets | design pending-kind atoms | implementation confirmed | implementation unresolved | implementation rejected assets | implementation uncovered | no evidence |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IRUNIT-HIL-BR-07-HELIX-HARNESS | 3 | 3 | 0 | 1 | 0 | 0 | 0 | 1 | 3 | 3 |
| IRUNIT-HIL-BR-21-HELIX-HARNESS | 3 | 3 | 2 | 0 | 0 | 0 | 0 | 1 | 3 | 1 |
| IRUNIT-HIL-FR-45-HELIX-HARNESS | 6 | 6 | 0 | 0 | 0 | 0 | 1 | 0 | 5 | 5 |
