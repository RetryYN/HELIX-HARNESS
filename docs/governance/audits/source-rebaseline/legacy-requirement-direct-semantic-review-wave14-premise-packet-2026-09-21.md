...
| IRUNIT-HIL-BR-06-HELIX-HARNESS | HELIX-HARNESS | PHCAP-04／07／13 | 2 | requirement confirmed、plan unresolved（1/2、A01のみpartial coverage）、implementation unresolved（2/2、product conflict） |
