...
BR-05とBR-17の共有spanは対応するHELIX-OS unitとの境界判断をpendingに保つ。BR-22はHARNESS exclusive候補である。
...
現行crosswalkの正規unitはHELIX-HARNESS 85、HELIX-OS 132、connection 1で、HELIX-Web／Web-OSは0件である。
