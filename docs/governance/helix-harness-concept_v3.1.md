...
ForwardはL0層外charterをanchorとして、**L1→L6/L7→L12**をV-model（下降=企画・要求・要件・設計・実装、上昇=テスト）で進む中核経路。他の全modeは本経路へ合流する。正規pairはL1↔L12 / L2↔L11 / L3↔L10 / L4↔L9 / L5↔L8 / L6↔L7である。
