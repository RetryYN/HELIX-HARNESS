...
|---|---|---|
| **ユビキタス言語 SSoT** | L0 企画書 §Glossary (UT-TDD では `docs/governance/helix-harness-concept_v3.1.md §10 用語集`) | L1 sub-doc は L0 用語を **parent_doc reference** とし、独自定義禁止 (anti-corruption layer) |
