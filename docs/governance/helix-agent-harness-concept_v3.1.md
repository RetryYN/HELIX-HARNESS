...
**本書は HELIX-HARNESS の概念定義書である。受入条件・enum 詳細・Phase 0 (初期フェーズ) 受入条件は `helix-agent-harness-requirements_v1.2.md` を参照。実装詳細 (validator / workflow YAML / hook script) は将来の個別 PLAN-XXX で詳細設計する。**
