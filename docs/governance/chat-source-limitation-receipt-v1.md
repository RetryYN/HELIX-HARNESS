...
# HELIX chat source limitation receipt
...
| visible occurrence rows | CHAT-U-001..044 = 44 |
| raw export available | false |
| stable platform message ID available | false |
| stable source timestamp available | false |
| source-provided digest available | false |
| omitted-turn denominator | unknown |
| semantic dedup completeness | unproven |
...
## §3 limitation acceptance contract
...
|---|---:|---|
| visible semantic capture | 61 | OBSERVED |
| visible occurrence capture | 44 | OBSERVED |
| mandatory semantic edge validation | 61/61 | PASS |
| independent re-read | 1/1 | PASS |
| raw transcript closure | unknown | UNPROVEN |
