...
- PR #99: merge 済み（`state=MERGED`, `mergedAt=2026-07-23T03:04:56Z`, HEAD `1e7a560903e812231e748caa8046af89f762a733`）
...
（正本 = `docs/governance/generated/harness-memory-retirement-authority.json`、2026-07-19 reconciliation の
39 件固定）に従う。正本ファイルは変更せず、本バッチの authority receipt は
`docs/governance/generated/harness-memory-retirement-authority-2026-07-24-merged-pr-reviews.json`
へ分離して記録する。
