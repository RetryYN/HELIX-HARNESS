...
Markdown / stable asset ID / revision / semantic digest / authoring event / trace edge / impact record /
stale record / HELIX DB projection / Canonicalization Receipt。
...
**HIL-FR-51（Authoring Admission Engine）**
...
**HIL-FR-52（Atomic Canonicalization Transaction）**
...
**HIL-FR-53（Semantic Revision and Asset Identity）**
...
1. Authoring asset＋revision schema
2. semantic diff 分類
3. Admission decision pure core
