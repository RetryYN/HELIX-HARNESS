...
|---|---:|---|---|---|---|---|
| UT | 30 | merged | failure | `f384062df5eca3af20bd5e3d0401a3eda637c0d0` | `add3742ceba7e3ab7956205824e4e733fa0f701a` | historical merge。CI failure disposition pending |
| UT | 42 | merged | failure | `f7ba1c6d07024f48aa6b1e5c10b3e9c4c16144eb` | `639fd28983a95c7dfcf1c64631f7defffe1aa33c` | historical merge。CI failure disposition pending |
...
| pull-head count join | UT 64/64、legacy 7/7 | PASS |
...
| candidate disposition | 71/71 | PASS（adopt 5 / harden 51 / redesign 8 / reject 1 / defer 6） |
| activated / verified behavior decision | 0/71 | FAIL |

## §5 PR 71 exact candidate join
...
| current check | success 60 / failure 10 / none 1 |
...
| HIL mapping non-empty | 71/71 |
| HR mapping non-empty | 71/71 |
| disposition | adopt 5 / harden 51 / redesign 8 / reject 1 / defer 6 |
| activated / verified / coverage credit | 0 / 0 / 0 |
...
| HIL set conflict | 71 |
| HR set conflict | 70 |
| reason conflict / any conflict | 71 / 71 |
| final disposition | adopt 4 / harden 42 / redesign 19 / reject 4 / defer 2 |
| verified / coverage credit | 0 / 0 |
