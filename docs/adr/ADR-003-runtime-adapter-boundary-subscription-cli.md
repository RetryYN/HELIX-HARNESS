...
- **関連**: `docs/design/harness/L4-basic-design/external-if.md` §6 / `docs/design/harness/L5-detailed-design/if-detail.md` §1・§7 / `docs/adr/ADR-001-helix-harness-redesign-and-language.md` / `../../CLAUDE.md` (契約プラン方針) / improvement-backlog IMP-030・IMP-031
