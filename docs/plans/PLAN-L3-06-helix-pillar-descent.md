  ...
  - reviewer: PO
    ...
    green_commands:
      ...
      - kind: smoke
        ...
        output_digest: "sha256:929640e5daddda2f3ccde9788c354e1b9f0527c9e23af0e451862837b401843c"
---
...
|----------------|-------------|---------------------|------|
| L3 設計をすべて精読し、L1 要求との差異を埋める | `L3 精読 audit`、`pillar-functional-requirements.md` §0/§3、既存 back-fill 3 本、Route-B back-fill 8 件の acceptance 接続 | `U-VPAIR-005b` / `U-VPAIR-005g` / `U-VPAIR-005j` | ready |
...
| completeness | pillar 43 L3 要件 / 86 HAC / 43 HAT と、Route-B back-fill 8 L3 要件 / 8 HAT が孤児 0 で接続されている | `U-VPAIR-005c` / `U-VPAIR-005j` |
