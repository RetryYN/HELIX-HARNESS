...
- `npm test tests/artifact-convergence-analyzer.test.ts --timeout 180000`
- `npm run typecheck`
- `npx --no-install tsx src/cli.ts plan lint docs/plans/PLAN-L7-376-artifact-convergence-analyzer.md`
