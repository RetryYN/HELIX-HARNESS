...
- `npm test tests/extension-preset-bundle-registry.test.ts --timeout 180000`
- `npm run typecheck`
- `npx --no-install tsx src/cli.ts plan lint docs/plans/PLAN-L7-379-extension-preset-bundle-registry.md`
