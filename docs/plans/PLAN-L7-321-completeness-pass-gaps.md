...
review_evidence:
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      - kind: unit_test
        command: "npm test tests/session-log.test.ts tests/projection-writer.test.ts tests/relation-graph-loader.test.ts tests/relation-graph.test.ts --timeout 180000"
        runner: node
        scope: targeted
        exit_code: 0
