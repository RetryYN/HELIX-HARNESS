...
review_evidence:
  - reviewer: "Codex TL independent cross-runtime reviewer"
    ...
    tests_green_at: "2026-08-11T04:28:10Z"
    verdict: approve
    ...
    green_commands:
      - { kind: unit_test, command: "npx --no-install vitest run tests/ddd-tdd-rules.test.ts --reporter=json", runner: node, scope: targeted, exit_code: 0, completed_at: "2026-08-11T04:28:10Z", evidence_path: tests/ddd-tdd-rules.test.ts, output_digest: "sha256:67eeeb08b76ea4be1d9c2eacc8a79d0296cb6586941557fed46f909c7ce35da1", result: "Vitest JSON reporter 実出力の SHA-256。21 passed / 0 failed（U-EDISC-005 の 4 分岐と real repo guard を含む）。Codex reviewer も同 suite の 21/21 を独立に確認済み" }
      - { kind: typecheck, command: "npx --no-install tsc --noEmit", runner: node, scope: full, exit_code: 0, completed_at: "2026-08-11T04:28:10Z", evidence_path: src/lint/ddd-tdd-rules.ts, output_digest: "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", result: "exit 0（出力 0 byte = 空出力の SHA-256）。CI run 31457300846 の typecheck step も通過" }
---
