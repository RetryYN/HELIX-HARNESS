...
- `npm test tests/doctor.test.ts tests/cli-surface.test.ts --timeout 300000`
- `npm run typecheck`
- `npx --no-install biome check src/doctor src/cli.ts tests/doctor.test.ts tests/cli-surface.test.ts`
- `npx --no-install tsx src/cli.ts doctor --timing --json`
- `npx --no-install tsx src/cli.ts plan lint docs/plans/PLAN-L7-359-doctor-check-registry-extraction.md`
...
- `npm test tests/doctor.test.ts tests/cli-surface.test.ts --timeout 300000` -> 99 pass / 0 fail
- `npm run typecheck` -> exit 0
- `npx --no-install biome check src/doctor/index.ts src/doctor/check-registry.ts src/doctor/result.ts src/cli.ts tests/doctor.test.ts tests/cli-surface.test.ts` -> exit 0
- `npx --no-install tsx src/cli.ts doctor --scope toolchain --timing --json` -> exit 0; `timings[0].id=toolchain-pin`
