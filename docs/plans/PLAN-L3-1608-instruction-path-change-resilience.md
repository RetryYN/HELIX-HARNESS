...
contract_postconditions: "IPC-R01..10とIPC-AC01..10を独立候補へ束縛する"
...
runtime実装、consumer移行、旧経路退役として扱わない。IPC-R01..10とIPC-AC01..10の1対1追跡を維持する。
IPC-R09は安定入口と動的正本参照を所有し、後続#1610の会話寿命・再構成そのものは所有しない。
