...
generates:
  ...
  - { artifact_path: docs/design/helix/L3-requirements/pending-reverse-pairing-readiness.md, artifact_type: requirements_doc }
modifies:
...
| 3 | doctor／全回帰／独立review | #1139を正規に解放できる |
