...
1. **View 別要件**: DISCOVERY-10 候補 View 5 種（Layer progress / Design-test pair /
   Relation-dependency / Runtime evidence / Skill-agent telemetry）を Tree View と
...
- `bun run src/cli.ts plan lint docs/plans/PLAN-L3-12-visualization-requirements.md` green。
