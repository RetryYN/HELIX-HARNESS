...
## 0. 目的 (Objective、PO 指示「データベースもよく見るように」「2 は完遂させる」2026-06-22)
...
- **schema 定義** (`src/schema/harness-db.ts`): `screens` (screen_id/name/category/url/l1_ref/status/implemented/indexed_at)
...
- [x] レビュー承認: intra_runtime_subagent (pmo-sonnet) review approve + doctor green。
