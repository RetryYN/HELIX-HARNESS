...
review_evidence:
  - reviewer: claude-code-opus
    ...
    reviewed_at: "2026-08-15T21:53:20Z"
    tests_green_at: "2026-08-15T21:48:00Z"
    verdict: approve
    worker_model: codex-gpt-5
    reviewer_model: claude-opus-5
    scope: "PR #732 exact HEAD 0d21f851840822648e985c708e193ef6340e93fcをClaude Opusがblocker 0でapproveし、CI run 31909668570 success、DB projection／replayおよびcheckpoint／replay convergenceをreceipt化した。PR #734でadmission consumerもcanonical mergeされ、Issue #731／#733 terminal commentとpost-main run 31930292602 successを本ReverseのR0〜R4で再照合した。review source: https://github.com/RetryYN/HELIX-HARNESS/pull/732#issuecomment-5304405472"
    green_commands:
      - kind: integration_test
        command: "npx --no-install vitest run --project fast tests/github-workflow-identity-contract.test.ts tests/l3-g3-freeze-packet-v2.test.ts tests/design-coverage.test.ts (GitHub Actions harness-check run 31909668570)"
        runner: ci
        scope: targeted
        exit_code: 0
        completed_at: "2026-08-15T21:48:00Z"
        ...
        result: "strict ingest、12 failure reason、Issue／PR mismatch、G3 digest propagationを含む43 testsとterminal CIがgreen。"
generates:
