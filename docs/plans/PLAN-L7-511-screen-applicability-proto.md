...
pair_artifact: docs/test-design/helix/L8-screen-applicability-proto-unit-test-design.md
...
generates:
  ...
  - { artifact_path: docs/test-design/helix/L8-screen-applicability-proto-unit-test-design.md, artifact_type: test_design }
