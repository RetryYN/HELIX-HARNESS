...
review_evidence:
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/summary-surface-audit.test.ts tests/design-declarations.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-11T02:00:00+09:00"
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/cli-surface.test.ts -t \"skill binding|exposes Project view current-location\""
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-11T02:00:00+09:00"
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts current-location --summary-json | skill/drift/approval smoke"
        runner: node
        scope: gate
        exit_code: 0
        completed_at: "2026-07-11T02:00:00+09:00"
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts vmodel fit --summary-json | scrum/skill/drift smoke"
        runner: node
        scope: gate
        exit_code: 0
        completed_at: "2026-07-11T02:00:00+09:00"
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts closure review-bundle --action close_ready --limit 1 --summary-json | approval checklist smoke"
        runner: node
        scope: gate
        exit_code: 0
        completed_at: "2026-07-11T02:00:00+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/cli-surface.test.ts -t \"exposes Project view current-location\""
        runner: node
        scope: targeted
        exit_code: 0
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-treeview.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-10T00:59:04+09:00"
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/db-projection-ingestion.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/summary-surface-audit.test.ts tests/goal-evidence-audit.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts current-location --summary-json | operation_scope.items smoke"
        runner: node
        scope: gate
        exit_code: 0
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts vmodel fit --summary-json | operation_scope.items smoke"
        runner: node
        scope: gate
        exit_code: 0
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts progress frontier --summary-json | operation_scope.items smoke"
        runner: node
        scope: gate
        exit_code: 0
        completed_at: "2026-07-10T01:01:11+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-treeview.test.ts -t current-location"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-10T00:48:43+09:00"
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/slow/doctor.test.ts -t \"surfaces Project current-location as an advisory doctor check\""
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-10T00:49:04+09:00"
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts current-location --summary-json"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-10T00:49:04+09:00"
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts progress frontier --summary-json"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-10T00:49:04+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: doctor
        command: "npx --no-install tsx src/cli.ts doctor (expected exit 1) + rg \"project-current-location - frontier\""
        runner: bash
        scope: targeted
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts -t \"L14到達済みclaim\""
        runner: node
        scope: targeted
        exit_code: 0
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts vmodel fit --summary-json"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-10T00:09:06+09:00"
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts drive model --summary-json"
        runner: node
        scope: targeted
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts tests/design-declarations.test.ts tests/visualization-view-model.test.ts tests/visualization-treeview.test.ts tests/vscode-extension-adapter.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-08T07:57:06+09:00"
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts tests/design-declarations.test.ts tests/visualization-read-model.test.ts tests/visualization-view-model.test.ts tests/visualization-treeview.test.ts tests/vscode-extension-adapter.test.ts tests/cli-surface.test.ts tests/db-projection-ingestion.test.ts tests/projection-writer.test.ts tests/state-db.test.ts tests/slow/doctor.test.ts"
        runner: node
        scope: full
        exit_code: 0
        completed_at: "2026-07-08T07:57:06+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: doctor
        command: "npx --no-install vitest run tests/slow/doctor.test.ts -t \"surfaces Project current-location|vmodel fit\""
        runner: node
        scope: targeted
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: unit_test
        ...
        output_digest: "sha256:c8f1cca259c4991c6788355ee5e4323f92f95cd2996af04c73211543bcc0872a"
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-read-model.test.ts tests/visualization-treeview.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T10:29:11+09:00"
  ...
  - reviewer: codex-tl
    ...
    worker_model: codex
    reviewer_model: codex
    scope: "safe_resolution_available の probe が `npm test:fast` を実行できることを確認し、probe が検出した impl-plan-trace orphan と V-model fit 表示期待値のズレを是正した。materialize は read-only のまま `ready_for_approval` まで進み、closure 適用は人間承認待ちとして保持した。"
    green_commands:
      - kind: unit_test
        command: "npx --no-install vitest run tests/impl-plan-trace.test.ts tests/visualization-view-model.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts closure evidence-probe --action repair_failed_evidence --limit 1 --execute --out .helix/tmp/closure/repair_failed_evidence-probe-record-20260709-safe-resolution-green.json --summary-json"
        runner: node
        scope: gate
        exit_code: 0
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts closure evidence-materialize --action repair_failed_evidence --limit 1 --probe-record .helix/tmp/closure/repair_failed_evidence-probe-record-20260709-safe-resolution-green.json --summary-json"
        runner: node
        scope: gate
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts tests/visualization-view-model.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T11:28:50+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts recovery plan --summary-json"
        runner: node
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T11:39:29+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-read-model.test.ts tests/visualization-view-model.test.ts tests/visualization-treeview.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T11:50:44+09:00"
      ...
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts tests/cli-surface.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-treeview.test.ts tests/visualization-view-model.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-read-model.test.ts tests/visualization-view-model.test.ts tests/visualization-treeview.test.ts tests/current-location.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-read-model.test.ts tests/visualization-view-model.test.ts tests/visualization-treeview.test.ts tests/current-location.test.ts tests/cli-surface.test.ts tests/vscode-extension-adapter.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts progress view-model --json"
        runner: node
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T12:42:43+09:00"
  ...
  - reviewer: codex-tl
    ...
    worker_model: codex
    reviewer_model: codex
    scope: "Recovery machine lane の `closure evidence-probe --execute --out` が既存 probe record を検出した場合、DB rebuild や `npm test:fast` 実行前に fail-fast するようにした。既存 record 上書きは引き続き拒否し、承認前の evidence handoff artifact を壊さない。"
    green_commands:
      - kind: typecheck
        command: "npm run typecheck"
        runner: node
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/cli-surface.test.ts -t \"writes executed evidence probe records\""
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T13:34:28+09:00"
      ...
      - kind: smoke
        command: "bash -lc 'npx --no-install tsx src/cli.ts closure evidence-probe --action repair_failed_evidence --limit 3 --execute --out .helix/tmp/closure/repair_failed_evidence-probe-record.json --summary-json; test $? -eq 2'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T13:34:28+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: smoke
        command: "bash -lc 'npx --no-install tsx src/cli.ts current-location --summary-json | rg -n \"local_handoff|approval_pending|approval_record_path\" -C 1 && npx --no-install tsx src/cli.ts recovery plan --summary-json | rg -n \"recovery_handoff_gate|approval_pending|approval_record_path\" -C 1'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T13:41:36+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/visualization-read-model.test.ts tests/visualization-view-model.test.ts tests/visualization-treeview.test.ts tests/vscode-extension-adapter.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T13:50:08+09:00"
      ...
      - kind: smoke
        command: "bash -lc 'npx --no-install tsx src/cli.ts progress tree-view --json | rg -n \"automation-runway/1-repair_failed_evidence/approval-draft|work-bucket/approval-draft-artifact|repair_failed_evidence-approval-draft-refresh-0735\" -C 1'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T13:50:08+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: smoke
        command: "bash -lc '{ npx --no-install tsx src/cli.ts current-location --summary-json | rg -n \"reentry_status|effective_reentry_status|local_handoff|approval_pending|machine_phase_pending\" -C 1; npx --no-install tsx src/cli.ts recovery plan --summary-json | rg -n \"reentry_forecast|effective_status|recovery_handoff_gate|approval_pending|machine_phase_pending\" -C 1; npx --no-install tsx src/cli.ts vmodel fit --summary-json | rg -n \"current_reentry_status|effective_reentry_status|effective_status|recovery_handoff_gate|approval_pending|machine_phase_pending\" -C 1; }'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T13:59:21+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: smoke
        command: "bash -lc '{ npx --no-install tsx src/cli.ts current-location | rg -n \"recovery-reentry: status=machine_phase_pending effective=approval_pending\"; npx --no-install tsx src/cli.ts recovery plan --limit 3 | rg -n \"reentry-forecast: status=machine_phase_pending effective=approval_pending\"; npx --no-install tsx src/cli.ts vmodel fit | rg -n \"synthesis: .*reentry=machine_phase_pending effective=approval_pending|recovery-reentry: status=machine_phase_pending effective=approval_pending\"; npx --no-install tsx src/cli.ts progress tree-view --json | rg -n \"approval_pending raw=machine_phase_pending|reentry=approval_pending|effective=approval_pending\" -C 1; }'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T14:18:58+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts -t \"operation\""
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T14:29:49+09:00"
      ...
      - kind: smoke
        command: "bash -lc 'set -o pipefail; { npx --no-install tsx src/cli.ts vmodel fit | rg \"regression-guard: operation-scope watch count=5|operation-scope: designed=5 observed=1 observed_gap=5\"; npx --no-install tsx src/cli.ts doctor | rg \"operation-scope:watch:5|vmodel-fit - operation-scope: designed=5 observed=1 observed_gap=5\"; }'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T14:29:49+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: smoke
        command: "bash -lc 'set -o pipefail; npx --no-install tsx src/cli.ts vmodel fit --summary-json | rg \"attention_guards|operation-scope|current-location-reentry|sample_guards\" -C 2'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T14:38:06+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts tests/db-projection-ingestion.test.ts tests/visualization-treeview.test.ts tests/visualization-view-model.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T14:47:09+09:00"
      ...
      - kind: smoke
        command: "bash -lc 'set -o pipefail; { npx --no-install tsx src/cli.ts current-location --summary-json | rg \"\\\"operation_scope\\\"|\\\"observed\\\": 2|\\\"observed_gap\\\": 4\" -A 8; npx --no-install tsx src/cli.ts vmodel fit | rg \"regression-guard: operation-scope watch count=4|operation-scope: designed=4 observed=2 observed_gap=4\"; }'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T14:47:09+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      ...
      - kind: smoke
        command: "bash -lc 'set -o pipefail; { npx --no-install tsx src/cli.ts current-location --summary-json | rg \"\\\"operation_scope\\\"|\\\"observed\\\": 3|\\\"observed_gap\\\": 3\" -A 8; npx --no-install tsx src/cli.ts vmodel fit | rg \"regression-guard: operation-scope watch count=3|operation-scope: designed=3 observed=3 observed_gap=3\"; }'"
        runner: bash
        scope: gate
        exit_code: 0
        completed_at: "2026-07-09T14:55:32+09:00"
  ...
  - reviewer: codex-tl
    ...
    green_commands:
      - kind: typecheck
        ...
        output_digest: "sha256:8366207267355d3e3d5bf3bf6e8c94c5f93f6078c34f08973fa2b38cdda6cc92"
      - kind: unit_test
        command: "npx --no-install vitest run tests/current-location.test.ts tests/visualization-treeview.test.ts tests/visualization-view-model.test.ts"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-07-09T19:16:56+09:00"
      ...
      - kind: smoke
        command: "npx --no-install tsx src/cli.ts closure batch --action close_ready --limit 5 --summary-json"
        runner: node
        scope: gate
        exit_code: 0
