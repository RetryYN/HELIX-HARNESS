...
review_evidence:
  - reviewer: codex-tl
    ...
    reviewed_at: "2026-07-03T21:09:02+09:00"
    tests_green_at: "2026-07-03T21:09:02+09:00"
    verdict: approve
...
- [x] `checkHandoverNextActionAnchor` が `確認観点=review ...` の旧 handover を fail-close する。
