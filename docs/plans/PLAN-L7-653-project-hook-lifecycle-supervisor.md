...
verification_bindings:
  ...
  - { parent_design: docs/design/helix/L6-function-design/project-hook-lifecycle-supervisor.md, oracle_id: U-CNWHOOKLIFE-009, test_path: tests/project-hook-lifecycle.test.ts }
agent_slots:
