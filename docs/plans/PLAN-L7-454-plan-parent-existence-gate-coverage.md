...
review_evidence:
  - reviewer: codex-intra-runtime-review
    ...
    reviewed_at: "2026-07-20T09:44:42+09:00"
    tests_green_at: "2026-07-20T09:40:26+09:00"
    verdict: pass
    scope: "parent existence ratchet、legacy grandfather、非 add-* の drive 非適用、全686 PLAN lintを独立レビュー。"
    green_commands:
      - { kind: lint, command: "npm run helix -- plan lint", runner: node, scope: full, exit_code: 0, completed_at: "2026-07-20T09:40:26+09:00", evidence_path: docs/plans/PLAN-L7-454-plan-parent-existence-gate-coverage.md, output_digest: "sha256:ea6b3f4f982b1501f213c0ee31cf5b7b46103aace993233daf87b065791c12e1" }
