...
review_evidence:
  - reviewer: codex-quality433-final-reviewer
    review_kind: intra_runtime_subagent
    worker_model: codex-primary
    reviewer_model: codex-independent-review-lane
    tests_green_at: "2026-07-12T16:40:29Z"
    reviewed_at: "2026-07-12T16:41:25Z"
    verdict: pass
    scope: "PLAN-L7-433 全体を独立 review lane で severity-first 監査し、deep freeze と successor governance の是正後に Blocker 0 / High 0 を確認した。同一 runtime 内の review substitute であり cross-provider review とは主張しない。C1/C2 の cross-runtime review 正本は PLAN-L7-441 に記録済み。"
    green_commands:
      - { kind: unit_test, command: "npx --no-install vitest run tests/frontmatter-shared.test.ts tests/sqlite-error.test.ts tests/repo-info.test.ts tests/shell-quote.test.ts tests/value-guards.test.ts tests/string-utils.test.ts tests/collection-utils.test.ts tests/time-utils.test.ts tests/file-walk.test.ts tests/outstanding.test.ts tests/hook-contract.test.ts tests/coding-rules.test.ts tests/ddd-tdd-rules.test.ts tests/dependency-drift.test.ts tests/module-drift.test.ts tests/design-language.test.ts tests/project-hook.test.ts tests/digest.test.ts tests/gate-confirm.test.ts", runner: node, scope: targeted, exit_code: 0, completed_at: "2026-07-12T16:40:29Z", evidence_path: tests/outstanding.test.ts, output_digest: "sha256:5c0a031f294049882f28a4141fe82645fbd6885b907dbc947f0307cdd5ea4313" }
      - { kind: typecheck, command: "npx --no-install tsc --noEmit", runner: node, scope: full, exit_code: 0, completed_at: "2026-07-12T16:40:29Z", evidence_path: src/lint/outstanding.ts, output_digest: "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" }
generates:
