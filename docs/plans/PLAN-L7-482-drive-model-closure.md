...
contract_postconditions: "既存drive-route-catalog doctorがexact分類とprojection driftをfail-closeする"
...
mutation_oracle_evidence: "U-DRCAT-011〜014がconstruct削除・重複・孤児parent・分類置換、right_arm surface削除、identity重複、route別branch prefix置換をseedし、旧validatorでredになる"
