...
mutation_oracle_evidence: "U-LLPG-AUTH-001..003が旧pair identity混入、L0 pair化、legacy相殺文言欠落、case/receipt digest改変を判別する"
...
verification_bindings:
  - { parent_design: docs/design/helix/L6-function-design/layer-ledger-pair-gate.md, oracle_id: U-LLPG-AUTH-001, test_path: tests/layer-ledger-canonical-authority.test.ts }
  - { parent_design: docs/design/helix/L6-function-design/layer-ledger-pair-gate.md, oracle_id: U-LLPG-AUTH-002, test_path: tests/layer-ledger-canonical-authority.test.ts }
  - { parent_design: docs/design/helix/L6-function-design/layer-ledger-pair-gate.md, oracle_id: U-LLPG-AUTH-003, test_path: tests/layer-ledger-canonical-authority.test.ts }
generates:
