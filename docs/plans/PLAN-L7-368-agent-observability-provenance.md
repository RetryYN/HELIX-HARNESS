...
- `npm test tests/token-tracker.test.ts tests/run-debug.test.ts tests/cli-surface.test.ts --timeout 180000`
- `npm run typecheck`
- `npx --no-install tsx src/cli.ts plan lint docs/plans/PLAN-L7-368-agent-observability-provenance.md`
