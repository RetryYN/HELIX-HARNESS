...
review_evidence:
  ...
  - reviewer: codex-tl
    ...
    verdict: approve
    scope: "PLAN-L7-31 の execution evidence 欠落を、現行 ddd-tdd-rules / relation-graph / doctor targeted green と typecheck で補い、integration GWT lint の passed evidence を harness.db に投影できる状態へ回復した。"
    worker_model: codex
