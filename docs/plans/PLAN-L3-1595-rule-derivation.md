...
title: "PLAN-L3-1595: ルールの機械導出と診断・Help"
kind: add-design
layer: L3
drive: agent
status: draft
...
l3_human_approval:
  ...
  decision: approve
  approver: RetryYN
  approved_at: "2026-09-06T20:35:10Z"
  plan_id: PLAN-L3-1595-rule-derivation
  approval_record_id: L3-PO-1595-001
...
workflow_identity:
  ...
  target_id: REDESIGN
entry_signals:
  - "po_directive:新要求文書を整理して取り込む rule-derivation"
created: 2026-09-06
updated: 2026-09-07
owner: Codex / TL
...
parent_design: docs/governance/candidates/rule-derivation-requests.md
pair_artifact: docs/governance/candidates/rule-derivation-acceptance.md
dependencies:
  parent: docs/governance/candidates/rule-derivation-requests.md
  requires: []
  references:
    - issue:825
    - issue:397
  blocks: []
generates:
  - { artifact_path: docs/plans/PLAN-L3-1595-rule-derivation.md, artifact_type: markdown_doc }
  - { artifact_path: docs/governance/candidates/rule-derivation-requests.md, artifact_type: markdown_doc }
  - { artifact_path: docs/governance/candidates/rule-derivation-requirements.md, artifact_type: markdown_doc }
