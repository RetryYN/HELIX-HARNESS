...
- `npm test tests/doctor.test.ts tests/readiness-guardrail.test.ts tests/cli-surface.test.ts --timeout 180000`
- `npm run typecheck`
- `npx --no-install tsx src/cli.ts plan lint docs/plans/PLAN-L7-370-security-credential-egress-guard.md`
