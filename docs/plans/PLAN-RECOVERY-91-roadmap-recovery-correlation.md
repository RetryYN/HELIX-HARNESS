...
mutation_oracle_evidence: "2026-09-02T21:26+09:00にRecovery相関条件を旧aligned恒真式へ戻すmutationを適用し、U-CURRENT-LOCATION-001が1 failed／21 passed、exit 1となった。exact PLAN相関へ復元後は22 tests green／exit 0。"
