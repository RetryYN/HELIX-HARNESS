...
mutation_oracle_evidence: "tests/github-cross-review-admission.test.ts U-GCRA-012で、2026-09-03T10:58:48ZにDB provenance failureをschema failureへ取り違えるmutationを入れるとRed／failed／exit 1となり、正しいtyped reason復元後にgreenへ戻した"
