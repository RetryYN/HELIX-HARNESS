...
review_evidence:
  - reviewer: codex-intra-runtime
    ...
    verdict: approve
    scope: "src/web dashboard, helix web CLI bootstrap, screen implemented projection, and targeted Vitest evidence"
    worker_model: codex
