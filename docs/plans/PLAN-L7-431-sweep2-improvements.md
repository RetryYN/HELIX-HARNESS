...
review_evidence:
  - reviewer: codex-independent-reviewer
    ...
    green_commands:
      - { kind: unit_test, command: "npx --no-install vitest run tests/git-command-guard.test.ts tests/work-guard.test.ts tests/autonomous-loop-run-receipts.test.ts tests/secret-scan.test.ts tests/token-tracker.test.ts tests/review-evidence.test.ts tests/continuation-event-first.test.ts tests/sweep3-state-lane-hygiene.test.ts tests/digest.test.ts tests/digest-consumer-compatibility.test.ts tests/cli-surface.test.ts", runner: node, scope: targeted, exit_code: 0, completed_at: "2026-07-12T08:40:00Z", evidence_path: tests/git-command-guard.test.ts, output_digest: "sha256:4d257a10927bbc8225f0826165059e1beaa43ed6b1515a17962d05c442c83ba9" }
      - { kind: unit_test, command: "npx --no-install vitest run tests/slow/projection-writer.test.ts", runner: node, scope: targeted, exit_code: 0, completed_at: "2026-07-12T08:40:00Z", evidence_path: tests/slow/projection-writer.test.ts, output_digest: "sha256:5ac9621676d668aac84b10d43859955bc956761b4085b4ef26d763b145876e3a" }
...
generates:
  ...
  - { artifact_path: src/schema/loop-plan-id.ts, artifact_type: source_module }
