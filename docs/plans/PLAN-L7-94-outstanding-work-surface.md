  ...
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      ...
      - kind: typecheck
        ...
        output_digest: "sha256:e18968aaf80ea2f60354ff6767ef1203e21f8bf36ac2a40fd13783d52b5103f8"
      - kind: lint
...
- [x] test 15 ケース (analyze 5 / completion readiness 2 / decision packet 3 / summaryLine 2 / loader+compute 3)、
  completion-decision-packet 6 ケース、S4 readiness 7 ケース、cutover readiness 6 ケース。typecheck / Biome /
  Vitest / doctor green。
