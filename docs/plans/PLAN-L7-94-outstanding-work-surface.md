  ...
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      - kind: unit_test
        ...
        scope: targeted
        exit_code: 0
        completed_at: "2026-06-30T10:39:15+09:00"
        evidence_path: tests/outstanding.test.ts
        output_digest: "sha256:8812cafbb3301bc304f43ead742749235602efc42d496b989a3681afc7274909"
      - kind: typecheck
        ...
        output_digest: "sha256:0f7544e157319e1236c38a93bc79da344cd971a2b71bb045e28ca9ad86873c58"
      - kind: lint
      ...
      - kind: doctor
        ...
        scope: gate
        exit_code: 0
        completed_at: "2026-06-30T10:40:00+09:00"
        evidence_path: src/lint/outstanding.ts
        output_digest: "sha256:0f7544e157319e1236c38a93bc79da344cd971a2b71bb045e28ca9ad86873c58"
agent_slots:
  - role: tl
...
- status `--json` に `outstanding` を additive (既存 6 field + nextAction 不変、A-138/PLAN-L7-84 前例)。
  status text に `outstandingSummaryLine` と `completionReadinessLine` を出す。
