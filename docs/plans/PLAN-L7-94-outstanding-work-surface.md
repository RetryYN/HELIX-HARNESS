  ...
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      ...
      - kind: typecheck
        ...
        output_digest: "sha256:150f9fde883f080e5dce9fa0234fb9b7877286e6282c2903d711c9096b5c3b44"
      - kind: lint
        command: "bun run lint"
        runner: bun
        scope: full
  ...
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      - kind: unit_test
        ...
        output_digest: "sha256:9444994d2501ba233bd01389162f08bfcb2e65d7bcd70f5e33d9ee6f112371a5"
      - kind: unit_test
        command: "bun test tests/outstanding.test.ts tests/cli-surface.test.ts"
        runner: bun
        scope: targeted
  ...
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      - kind: unit_test
        ...
        output_digest: "sha256:7e3cf41de0fe2404431564e7b400d89bdae88e387b7db53143e80525dd337bd8"
      - kind: typecheck
        command: "bun run typecheck"
        runner: bun
        scope: full
  ...
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      - kind: unit_test
        ...
        output_digest: "sha256:4faca820191fca3fe7bd71f22fecf67de0a47dc6c2da7f16869325954e862928"
      - kind: typecheck
        command: "bun run typecheck"
        runner: bun
        scope: full
...
- handover `runHandover` が CURRENT.json pointer に `outstanding` と同じ生成時点の
  ...
  から再開時にも recordTemplates と専用 packet commands を含む PO/S4・version-up・cutover・action-binding
  判断 packet を読める。
...
- [x] status --json / status text / handover CURRENT.json に additive surface (既存契約不変)。blocked status から
  ...
  `workflowNextActions[]` で全 blocker queue と補助 packet commands も出す。
