  ...
  - reviewer: codex-intra-runtime
    ...
    green_commands:
      - kind: unit_test
        ...
        output_digest: "sha256:8383b1ed26378b2dc41edfaa6b8c71e505f7add55197a323502d6a93aee44315"
      - kind: unit_test
      ...
      - kind: typecheck
        ...
        output_digest: "sha256:6b2d98b01597d69f2df566536d146e86677b3e87f63a8d53e6ad088b9bce1166"
      - kind: lint
...
- [x] test 15 ケース (analyze 5 / completion readiness 2 / decision packet 3 / summaryLine 2 / loader+compute 3)、
  completion-decision-packet 8 ケース、S4 readiness 7 ケース、cutover readiness 6 ケース。typecheck / Biome /
  Vitest / doctor green。
