...
- cutover_snapshot_id: Current `cutoverSnapshot.snapshotId` from `ut-tdd rename plan --json` is `sha256:cff042bcb6fa05e746d0b2a0eade1a223433cab0b1efb7d8d5092607ab6f1245`; cutover/action-binding approval evidence becomes stale if this snapshot changes.
