...
- cutover_snapshot_id: Current `cutoverSnapshot.snapshotId` from `ut-tdd rename plan --json` is `sha256:3a677d4bfcc99121247c350b4c833931c8f3e4d1de319cf7058caa164483a0a2`; cutover/action-binding approval evidence becomes stale if this snapshot changes.
