...
spec:
  defines:
    ...
    - id: SCRUM-OPS-A-01
      kind: acceptance criteria
      title: story mapping typed projection
      layer: L12
      owner: QA
      status: confirmed
    - id: SCRUM-OPS-A-02
      kind: acceptance criteria
      title: estimation velocity typed projection
      layer: L12
      owner: QA
      status: confirmed
    - id: SCRUM-OPS-A-03
      kind: acceptance criteria
      title: DoR DoD typed projection
      layer: L12
      owner: QA
      status: confirmed
    - id: SCRUM-OPS-A-04
      kind: acceptance criteria
      title: daily record typed projection
      layer: L12
      owner: QA
      status: confirmed
    - id: SCRUM-OPS-A-05
      kind: acceptance criteria
      title: sprint review typed projection
      layer: L12
      owner: QA
      status: confirmed
    - id: SCRUM-OPS-A-06
      kind: acceptance criteria
      title: retrospective reverse projection
      layer: L12
      owner: QA
      status: confirmed
    - id: SCRUM-OPS-A-07
      kind: acceptance criteria
      title: burndown velocity metric projection
      layer: L12
      owner: QA
      status: confirmed
  refs:
