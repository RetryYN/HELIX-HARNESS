...
| `U-CPRCONV-040` | `buildClaudePrReviewReceipt` / `validateClaudePrReviewReceipt` | producerがcanonical fieldだけを射影し、任意の非空`summary`を保持する | inputのunknown field spread、provider-neutral `schema_version`混入、空summaryの受理 |
