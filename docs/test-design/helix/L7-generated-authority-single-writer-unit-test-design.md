...
| U-GASW-006 | writer注入拒否 | admit済みdelta exact set外のrecordをwriterが追加・削除・置換する変異をREDにし、canonical bytesの増分を0にする。 | `tests/generated-authority-single-writer.test.ts` |
