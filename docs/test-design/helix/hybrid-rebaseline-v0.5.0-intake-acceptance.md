...
| AC-V050-L1-02 | HBR-V050-02 | development styleは`FULL_L1_L12_V`、`PRODUCTION_SCRUM`、`V_DESIGN_SCRUM_IMPLEMENTATION`のexact 3件からexactly oneを選ぶ。Discovery／PoCはScrum非内包のcase-driven別軸であり、曖昧なstyleは`FULL_L1_L12_V`へfail-closeする |
