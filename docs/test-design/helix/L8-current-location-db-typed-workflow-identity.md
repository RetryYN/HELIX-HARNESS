...
| U-CLDB-004 | authority root | consumer cwdをclassification authorityとして読むとRed。installed HELIX package authorityで変換する | `tests/current-location-db-workflow-identity.test.ts` |
