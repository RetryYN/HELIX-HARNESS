...
| `HST-CASE-005-01` | `IT-GPAP-008` | `U-GPAP-009` | `commitFindingPromotionAtomically` | `finding_open` | `queue_ready` | `なし（正常系）` | `current_pr_fix`はwriter return各1・promotion 0、`successor_issue`はpromotion/Issue/Reverse/memory-summary/queue各1、cause一致 |
