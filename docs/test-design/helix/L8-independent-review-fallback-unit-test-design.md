...
| U-IRF-004B | 正負 | 5 benchmark case／4 negative mutation exact setから生成したClaude-verified S4、またはauthority digest付き期限内PO bootstrap receiptだけを受理し、digest欠落／Kimi自己検証／期限切れを拒否 |
