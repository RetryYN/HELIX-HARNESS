...
| TER-AC-005 | TER-R-03 / TER-R-04 | eventと周期の双方でepisodeを起動する | changelog未取得を無変化扱いしない |
| TER-AC-006 | TER-R-06 | semantic diffからimpact graphとstale対象を導出する | 名称一致、単一logで確定しない |
| TER-AC-007 | TER-R-05 / TER-R-06 | unknown/high-riskをfail-closeまたはdeferする | silent fallbackしない |
...
| TER-AC-015 | TER-R-07 / TER-R-08 | rollback targetとrecovery手順が再現可能 | rollback不能なpromotionを拒否 |
