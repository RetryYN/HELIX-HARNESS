...
U-EPR-089..100 を次のとおり割り付ける。実行ファイルは
...
| `evaluateLifecycleTransition` | U-EPR-039..046, U-EPR-098 | state machine、seal、correlation 分離 |
| `evaluateProjectionDrift` | U-EPR-047..056 | identity / state の分離判定、orphan lane、片方一致の否定 |
