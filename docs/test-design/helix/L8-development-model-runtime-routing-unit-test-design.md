...
|---|---|---|
| U-RUNTIMEAXIS-001 | development style exact 3、case exact 3、change route exact 10 | Hybrid欠落、PoCをstyleへ追加、unknown routeを拒否 |
...
| U-RUNTIMEAXIS-006 | plan_registryへ4 current fieldを再現可能に投影 | plan ID／kind／route_modeからの暗黙補完を拒否 |
