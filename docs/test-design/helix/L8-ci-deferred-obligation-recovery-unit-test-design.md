...
| U-CIDEFER-013 | failed run oracle identity | first detecting oracleの欠落／不正を`recovery_oracle_missing`でfail-closeしbackprop候補を生成しない | `tests/ci-deferred-obligation-recovery.test.ts` |
