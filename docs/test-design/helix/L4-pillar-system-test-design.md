...
| HST-P7-01 | HR-FR-P7-01 | HB-P7 | Claude/Codex が同じ共有 memory から bounded recall し、provider delegation evidence は監査専用として continuation から分離される |
...
| HST-N5-02 | HR-NFR-P5-02 | HB-P1 | checkpointのatomic/idempotent replay、crash restart、旧session prose/CURRENT/CLI不存在とresurrection block、provider evidence保持を確認する |
