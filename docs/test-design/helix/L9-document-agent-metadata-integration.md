...
| IT-AGMETA-004 | Phase B の明示 selection と write-port fixture | apply を実行 | scope内だけを更新し、before/after digest と rollback receipt を残す。scope外・digest drift・port拒否は書込み 0 | `tests/document-agent-metadata-integration.test.ts` |
