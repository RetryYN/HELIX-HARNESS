...
|---|---|---|---|
| U-RDJ-000 | shadow JSON schema、executable enum、L3正本の8 surface／authority境界が一致 | event/payload/lifecycle/convergence/surfaceの片側drift | `tests/requirement-discovery.test.ts` |
