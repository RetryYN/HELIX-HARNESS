...
| HAT-P6-03 | HR-FR-P6-03 | HAC-P6-03a/b | fresh/brownfield setup が `.ut-tdd` / `.helix` state、consumer doctor baseline、baseline plan、import report、`skip_sub_doc` を非破壊に出し、導入先では `ut-tdd doctor --profile consumer` が dogfood design/plans 無しで通る | setup/distribution tests |
