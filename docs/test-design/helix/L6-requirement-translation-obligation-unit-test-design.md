...
`executeRequirementTranslationNormalPipeline`、
...
| `HST-CASE-028-01` | `rto-hst-case-028-01` | 1 | `executeRequirementTranslationNormalPipeline` | `after_projection_append:reconcile` | `event+projection+receipt` | `sha256:688be410964b7801a6a927941731a2f12fbb595dffeecc57ddb5fc27f5838fbc` | `docs/test-design/helix/fixtures/requirement-translation-obligation-case.manifest` |
