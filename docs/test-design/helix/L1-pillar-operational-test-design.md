...
- partial（HOT-P2/P7）は既存 oracle（U-ORCH-001..006 + BRIDGE-01/02 / U-MEM-001..003 / U-TOOLCONTRACT-001..006 / HU-PILLAR-P2-02）が L7 単体側の被覆。本 OT は L14 運用観測側の対。残 GAP（hosted/API preflight / Glossary SSoT）は PLAN-L3-06 / PLAN-L4-51 で降下済みで、実装・下位詳細は後続 L5+ / L7+ の対象。
