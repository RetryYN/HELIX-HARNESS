...
| U-GWID-009 | identity分類 | `catalog_route_id`／`route_class`をlegacy reasonで拒否せず、別contractのcurrent語彙としてschema境界を示す | `tests/github-workflow-identity-contract.test.ts` |
