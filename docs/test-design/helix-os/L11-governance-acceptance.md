...
HELIXOS-L2-002／004／005／006／008ではFRS-BR-001..009由来条件も個別に確認する。

| 出典 | 利用者による確認と反例 |
|---|---|
| FRS-BR-001／002／003 | 選択したSliceの証拠とBundleの収載・除外を確認する。preview混入・未指定Slice・別階層への自動昇格を拒否し、未完Module内の適格Sliceを隠さない |
...
| FRS-BR-008 | CI改善前後の待ち時間・再実行・検証範囲を確認する。限定委譲の期限・予算・branch・独立review欠落を投入可能と表示しない |
