...
pair_group:
  ...
  group_id: harness-l3-acceptance
  authority: docs/design/harness/L3-functional/
  members:
    - docs/design/harness/L12-acceptance/acceptance-evidence-boundary.md
...
| **AT-FR-11-01** | AC-FR-11-01 (interrupt 正常) | `helix interrupt` → PLAN-040 interrupted / PLAN-041 起票 / continuation event と DB projection 保存 | vitest interrupt test |
