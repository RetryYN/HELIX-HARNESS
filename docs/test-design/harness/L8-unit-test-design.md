...
| CI hard-gate integrity self-heal | PLAN-L7-423 / `function-spec.md` | `U-CISELF-001..007`。dependency boundary、compat shim、secret SSoT、human/technical review分離、L6逆traceを固有test caseへ束縛する |
