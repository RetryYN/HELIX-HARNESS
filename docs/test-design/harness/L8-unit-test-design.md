...
| U-CPRCONV-011 | canonical comment decoder | current v3とbyte-compatible historical v2をcanonical envelopeから読み、改変v2とv2 current loadを拒否する | `tests/claude-pr-convergence.test.ts` |
