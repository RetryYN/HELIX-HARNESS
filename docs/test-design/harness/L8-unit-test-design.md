...
| U-ID | 対象 | 反例と期待結果 | test citation |
|---|---|---|---|
| U-OUTSTANDING-1432-001 | 不可逆impact宣言 | `irreversible_impact: cutOver`のschema不適合を不可逆性なしへ落とさず、`irreversible_migration_pending`でfail-closeする | `tests/outstanding.test.ts` |
