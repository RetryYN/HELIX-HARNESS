...
| IT-DUR-003 | payload/manifest publish各境界でprocess SIGKILL       | manifest durable前は旧epoch、後は新epoch、half-state 0 | deterministic restart           |
| IT-DUR-004 | 同一planへbarrier付き2 process commit                 | winner 1以下、lost receipt 0、chain分岐はblock         | conflict packet                 |
