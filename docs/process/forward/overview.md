...
L0 企画
L1 要求定義                        L14 運用検証
L2 画面設計                        L10 システム検証＋Real UX evidence
L3 要件定義                        L12 運用・価値検証
L4 基本設計                        L9 結合検証
L5 詳細設計                        L8 単体・詳細検証
L6 機能設計
...
| L2 画面設計 | ワイヤーモック自体がペア | L10 システム検証＋Real UX evidence | **実データ検証**: 本番実データで画面が成立 |
| L3 要件定義 | 受入テスト設計 | L12 運用・価値検証 | **本番受入**: 本番で要件が満たせるか |
| L4 基本設計 | 総合テスト設計 | L9 結合検証 | **総合**: テスト環境・全体 |
| L5 詳細設計 | 結合テスト設計 | L8 単体・詳細検証 | **結合**: テスト環境・モジュール |
