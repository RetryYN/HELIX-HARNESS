...
出典: concept v3.1 §2.5 / §2.6.1 signal binding (`production_incident`/`hotfix_required`/`regression_prod`) / §2.6.5 env=prod 分岐 / requirements v1.3.12 §9.2、§10 / workflow classification registry v1.1.4。
...
出典再掲: concept v3.1 §2.5/§2.6.3/§2.6.5 / requirements v1.3.12 §9.2/§10 / workflow classification registry v1.1.4
