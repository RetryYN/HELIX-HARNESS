...
出典: concept v3.1 §2.5 / §2.6.1 signal binding (`agent_runaway`/`context_exhaustion`/`regression_dev`) / requirements v1.3.11 §9.2、§10 / workflow classification registry v1.1.4。
...
> HELIX-HARNESS の存在意義 = AI が指示どおり動かない/逸脱するのを検出・是正すること。
...
出典再掲: docs/process/modes/README.md / concept v3.1 §2.5/§2.6.3 / requirements v1.3.11 §9.2/§10 / workflow classification registry v1.1.4
