...
`activation_provenance_requirements` も出力する。これは Cloudflare Pages/Workers/D1/KV の free-tier
budget、GitHub webhook `X-Hub-Signature-256` HMAC 検証、Cloudflare Access policy、secret/PII 非投影、
