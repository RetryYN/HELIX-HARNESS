...
出典: concept v3.1 §2.5 (Add-feature workflow) / requirements v1.3.11 §4、§9.2、§10 / workflow classification registry v1.1.4。`add-design`／`add-impl`はPLAN kindであり、workflow model identityとは別axisである。
...
## CODING-RULE-WORKFLOW（coding-rule ワークフロー）

coding-rule 文書化は CI だけでなく Add-feature の一部である。
