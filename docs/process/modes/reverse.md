...
出典: concept v3.1 §2.5 / §2.6.1 signal binding (`drift`) / requirements v1.3.11 §9.2、§10 / workflow classification registry v1.1.4。
...
出典再掲: docs/process/modes/README.md / concept v3.1 §2.5-§2.6 / requirements v1.3.11 §9.2/§10 / workflow classification registry v1.1.4
