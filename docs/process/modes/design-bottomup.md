...
> **current authority**: `docs/governance/helix-harness-requirements_v1.3.md` (requirements v1.3.11) → registry v1.1.4 → generated projection。`design-bottomup`はcompatibility-only inputであり、workflow modelへ昇格しない。
