...
2. **入口は分かれても出口は1本**: 駆動モデル（mode）は入口の状況が違うだけ。**全modeが最終的に`docs/governance/helix-harness-requirements_v1.3.md`のForward L1〜L12へ合流**する。旧L0〜L14 artifactはcompatibility mappingを通す。
