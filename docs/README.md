...
機構の要求候補は、担当する機構のフォルダの`candidates/`に置く（2026-09-25のPO判断）。L1がまだない機構（[HELIX-BRAIN](helix-brain/README.md)、[HELIX-LABO](helix-labo/README.md)、[HELIX-Intelligence](helix-intelligence/README.md)）は、候補だけを持つ。
