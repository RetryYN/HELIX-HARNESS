...
HELIXはprevious frameworkからbehavior／design conceptsを取り込む。ADR-009のtargetはTypeScript/Node control planeと
closed capability classのproposal-only Python workerである。Nodeが全出力を再検証して唯一のtransaction writerとなり、
