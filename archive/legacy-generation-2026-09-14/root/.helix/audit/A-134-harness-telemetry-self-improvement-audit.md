...
|---|---|---|
| Dynamic L-unit / drive-model skill injection | `helix skill suggest --plan <id>` と、`skill_recommendations` / `skill_invocations` への projection | minimal closed。skill catalog と drive-specific rules を拡張する。 |
