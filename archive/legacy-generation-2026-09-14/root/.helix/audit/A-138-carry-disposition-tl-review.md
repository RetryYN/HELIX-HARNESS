...
- reviewer/TL: Codex (gpt-5.5) via `helix codex --role tl --task-file .helix/codex-tasks/carry-disposition-tl-review-v2.md --execute`
...
- 今実装可能な最小スライス:
  - `helix skill suggest --plan <id>` は現行互換維持
  - `helix skill suggest --text "<task>"` を追加
