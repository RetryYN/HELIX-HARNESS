...
mutation_oracle_evidence: "tests/drive-route-catalog.test.ts と tests/branch-kind.test.ts がconstruct削除・重複・孤児parent・分類置換、right_arm surface削除、identity重複、route別branch prefix置換、Production Scrum/Hybridへのpoc kind混入・必要kind欠落、allowed kindが全宣言branchで拒否されるmutation、未統制prefixでfailし、U-DRCAT-011〜018が欠陥をkillする"
...
verification_bindings:
  ...
  - { parent_design: docs/design/harness/L6-function-design/drive-route-catalog.md, oracle_id: U-DRCAT-018, test_path: tests/branch-kind.test.ts }
generates:
