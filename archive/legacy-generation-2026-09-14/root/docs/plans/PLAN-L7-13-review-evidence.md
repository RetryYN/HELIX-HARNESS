...
review_evidence:
  ...
  - reviewer: codex-tl
    ...
    verdict: approve
    scope: "PLAN-L7-13 の execution evidence 欠落を、現行 vmodel-pair / review-evidence / doctor targeted green と typecheck で補い、review evidence gate の passed evidence を harness.db に投影できる状態へ回復した。"
    worker_model: codex
