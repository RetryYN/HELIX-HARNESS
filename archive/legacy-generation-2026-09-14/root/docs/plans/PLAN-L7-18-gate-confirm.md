...
review_evidence:
  ...
  - reviewer: codex-tl
    ...
    verdict: approve
    scope: "PLAN-L7-18 の execution evidence 欠落を、現行 plan-lint / improvement-backlog / gate-confirm / merged-plan-status targeted green と typecheck で補い、gate-confirm coupling lint の passed evidence を harness.db に投影できる状態へ回復した。"
    worker_model: codex
    ...
    green_commands:
      - kind: unit_test
        ...
        evidence_path: tests/gate-confirm.test.ts
      ...
      - kind: typecheck
        ...
        exit_code: 0
        completed_at: "2026-07-09T15:16:23+09:00"
        evidence_path: src/lint/gate-confirm.ts
