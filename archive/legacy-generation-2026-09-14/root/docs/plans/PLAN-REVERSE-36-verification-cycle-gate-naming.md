...
- [x] typecheck 0 / vitest green / biome CLEAN / doctor exit 0 / plan-id-naming test green を確認。
...
## §8 レビュー証跡（review evidence）

- reviewer は `code-reviewer`（intra_runtime_subagent, sonnet）、2026-06-10、verdict は **APPROVE**。
