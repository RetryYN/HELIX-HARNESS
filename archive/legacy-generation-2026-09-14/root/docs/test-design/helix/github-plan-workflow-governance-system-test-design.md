...
| GH-T-033 | GH-AC-033 | 計画済み検証を別Issue化し、予定外findingをV-pairへ埋没させ、必須ACの想定外failureで元PLANを継続し、closure/review/DB/mergeを個別欠落させる | planned/unplannedを分離し、想定外failureをRecoveryへrouteして必須ACなら元PLANをblockし、完全なclosureとIncident→Recovery traceだけを受理する |
