...
export const HARNESS_DB_CORE_TABLES: TableDef[] = [
  ...
  {
    name: "github_execution_episode_events",
    columns: [
      pk("event_id"),
      col("episode_id"),
  ...
  {
    name: "github_execution_episode_outbox",
    columns: [
      pk("outbox_id"),
      col("episode_id"),
      col("event_id"),
  ...
  },
  {
    ...
    columns: [
      ...
      col("workflow_target_id"),
      col("source_event_id"),
      col("source_event_digest"),
      col("issue_number", "INTEGER"),
      col("plan_id"),
      col("branch_name"),
  ...
  {
    name: "closure_process_receipt_migration_conflicts",
    columns: [
      pk("archive_key"),
      col("process_receipt_key"),
      col("canonical_process_receipt_key"),
      col("schema_version"),
      col("materialization_id"),
      col("kind"),
      col("repository_head"),
  ...
  {
    name: "team_member_run_receipts",
    columns: [
      pk("receipt_id"),
      col("team_run_id"),
      col("plan_id"),
      col("team"),
      col("member_index", "INTEGER"),
      col("role"),
      col("engine"),
      col("provider"),
      col("model"),
      ...
      col("verdict_status"),
      col("output_digest"),
      col("output_bytes", "INTEGER"),
      col("output_truncated", "INTEGER"),
      col("completed_at"),
    ],
  },
  {
