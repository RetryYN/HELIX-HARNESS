/**
 * Plan frontmatter schema for HELIX (current requirements v1.3 + L1-L12 authority。
 * v1.2 §1.1 / §1.9 / §1.10 Aはcompatibility入力の由来)。
  ...
  review_evidence: z
    .array(
      z.object({
        ...
        /** reviewer session の構造化識別子 (Issue #923)。同一 model の収束レーンが複数同時稼働するため
    ...
    .optional(),
  /** PLAN-L7-89 / PLAN-RECOVERY-89: 本 PLAN が訂正・無効化する先行 PLAN のexact plan_id群。 */
  supersedes: z.array(z.string()).optional(),
  /** PLAN-RECOVERY-89: 自己を訂正する後継 PLAN のexact plan_id群。本文言及は逆edgeを代用しない。 */
