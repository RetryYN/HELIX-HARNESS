...
export const BUILTIN_GITHUB_TEMPLATES: TemplateSet = {
  ...
  "project/.vscode/tasks.json": [
    ...
    '      "type": "shell",',
    '      "command": "bun run ut-tdd version-up dry-run --current v0.1.0 --target v0.1.4 --release-remote https://github.com/unison-ai-product/UT-TDD_AGENT-HARNESS-Pack.git --json",',
    '      "problemMatcher": []',
    "    },",
    "    {",
