...
export const BUILTIN_GITHUB_TEMPLATES: TemplateSet = {
  ...
  "adapter/.claude/settings.json": [
    ...
    HELIX_HOOK_TIMEOUT_30_LINE,
    '            "blockOnFailure": true,',
    '            "statusMessage": "work/secret-egress guard: foreign edit and credential protection"',
    "          }",
    "        ]",
    "      },",
    "      {",
    ...
    HELIX_HOOK_TIMEOUT_30_LINE,
    '            "blockOnFailure": true,',
    '            "statusMessage": "shell safety guard: secret egress and destructive Git/host operation protection"',
    "          }",
    "        ]",
    "      }",
    "    ],",
  ...
  "project/.vscode/tasks.json": [
    ...
    '      "type": "shell",',
    '      "command": "npm run helix -- version-up dry-run --current v0.1.0 --target v0.1.4 --release-remote https://github.com/RetryYN/HELIX-HARNESS-OS.git --json",',
    '      "problemMatcher": []',
    "    },",
    "    {",
    ...
    '      "type": "shell",',
    '      "command": "npm run helix -- team run --definition .helix/teams/default-hybrid.yaml --mode hybrid --json",',
    '      "problemMatcher": []',
    "    }",
    "  ]",
    "}",
