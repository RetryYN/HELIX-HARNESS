...
/** PLAN-L7-454: 全 kind の PLAN parent 実在性を新規・更新 PLAN から ratchet する。 */
const PARENT_EXISTENCE_ENFORCEMENT_DATE = "2026-07-14";
/** 起票完全性 (S3/S4 poc の s4_decision_record、reverse の pair_artifact) の enforcement 境界 (PLAN-L7-332)。 */
const FILING_COMPLETENESS_ENFORCEMENT_DATE = "2026-07-06";
