export const REQUIREMENTS_BINDING_REFACTOR_SCAN_ROOTS = ["src"] as const;

export const REQUIREMENTS_BINDING_REFACTOR_THRESHOLDS = {
...
export const REQUIREMENTS_BINDING_POLICY_TERMS = [
  "stage",
  "phase",
  "route",
  "approval",
...
export const REQUIREMENTS_BINDING_L1_L2_MAX_ROUNDS = 3;

export const REQUIREMENTS_BINDING_L1_L2_VIEWPOINTS = [
  {
    id: "input",
    label: "入力",
