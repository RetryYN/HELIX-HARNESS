...
const EXPECTED_EXTERNAL_SOURCE_LEDGER_ROWS = [
  ...
  },
  {
    ...
    command: "git ls-remote https://github.com/RetryYN/HELIX-HARNESS-DevOS.git refs/heads/main",
    ref: "refs/heads/main",
  ...
  },
  {
    ...
    command: "git ls-remote --tags https://github.com/RetryYN/HELIX-HARNESS-DevOS.git",
