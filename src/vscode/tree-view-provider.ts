...
function projectCurrentLocation(vm: VisualizationViewModel): TreeViewNode {
  ...
  const children = [
    node({
      ...
      children: [
        ...
        node({
          ...
          label: "recovery plan",
          description: `${current.recovery_exit.status} remaining=${current.recovery_exit.remaining_queue_items}`,
          tooltip: tooltipLines([
    ...
    node({
      ...
      commandPointer: "helix current-location --json",
        ...
        node({
          ...
          children: [
            node({
              ...
              description: "helix closure evidence-plan --action collect_evidence --json",
            ...
            node({
              ...
              description: "helix closure evidence-plan --action reverse_design --json",
              contextValue: "closure-evidence-plan.reverse",
              commandPointer: "helix closure evidence-plan --action reverse_design --json",
              children:
                current.closure.evidence_templates
